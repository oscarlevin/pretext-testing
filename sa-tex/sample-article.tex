...
%% Environment for a PTX "glossary" at the level of a LaTeX "subsubsection"
\NewDocumentEnvironment{glossary-subsubsection}{mmmmmmm}
{%
\renewcommand{\divisionnameptx}{#1}%
\renewcommand{\titleptx}{#2}%
\renewcommand{\subtitleptx}{#3}%
...
%% Environment for a PTX "glossary" at the level of a LaTeX "subsubsection"
\NewDocumentEnvironment{glossary-subsubsection-numberless}{mmmmmmm}
{%
\renewcommand{\divisionnameptx}{#1}%
\renewcommand{\titleptx}{#2}%
\renewcommand{\subtitleptx}{#3}%
...
\NewDocumentEnvironment{solutions-subsubsection}{mmmmmmm}
{%
\renewcommand{\divisionnameptx}{#1}%
\renewcommand{\titleptx}{#2}%
\renewcommand{\subtitleptx}{#3}%
...
%% Environment for a PTX "solutions" at the level of a LaTeX "subsubsection"
\NewDocumentEnvironment{solutions-subsubsection-numberless}{mmmmmmm}
{%
\renewcommand{\divisionnameptx}{#1}%
\renewcommand{\titleptx}{#2}%
\renewcommand{\subtitleptx}{#3}%
...
%% Environment for a PTX "reading-questions" at the level of a LaTeX "paragraph"
\NewDocumentEnvironment{reading-questions-paragraph}{mmmmmmm}
{%
\renewcommand{\divisionnameptx}{#1}%
\renewcommand{\titleptx}{#2}%
\renewcommand{\subtitleptx}{#3}%
...
%% Environment for a PTX "reading-questions" at the level of a LaTeX "paragraph"
\NewDocumentEnvironment{reading-questions-paragraph-numberless}{mmmmmmm}
{%
\renewcommand{\divisionnameptx}{#1}%
\renewcommand{\titleptx}{#2}%
\renewcommand{\subtitleptx}{#3}%
...
\NewDocumentEnvironment{exercises-paragraph}{mmmmmmm}
{%
\renewcommand{\divisionnameptx}{#1}%
\renewcommand{\titleptx}{#2}%
\renewcommand{\subtitleptx}{#3}%
...
%% Environment for a PTX "exercises" at the level of a LaTeX "paragraph"
\NewDocumentEnvironment{exercises-paragraph-numberless}{mmmmmmm}
{%
\renewcommand{\divisionnameptx}{#1}%
\renewcommand{\titleptx}{#2}%
\renewcommand{\subtitleptx}{#3}%
...
%% Environment for a PTX "glossary" at the level of a LaTeX "section"
\NewDocumentEnvironment{glossary-section}{mmmmmmm}
{%
\renewcommand{\divisionnameptx}{#1}%
\renewcommand{\titleptx}{#2}%
\renewcommand{\subtitleptx}{#3}%
...
%% Environment for a PTX "glossary" at the level of a LaTeX "section"
\NewDocumentEnvironment{glossary-section-numberless}{mmmmmmm}
{%
\renewcommand{\divisionnameptx}{#1}%
\renewcommand{\titleptx}{#2}%
\renewcommand{\subtitleptx}{#3}%
...
%% Environment for a PTX "index" at the level of a LaTeX "section"
\NewDocumentEnvironment{index-section}{mmmmmmm}
{%
\renewcommand{\divisionnameptx}{#1}%
\renewcommand{\titleptx}{#2}%
\renewcommand{\subtitleptx}{#3}%
...
\tcbset{ claimstyle/.style={bwminimalstyle, runintitlestyle, blockspacingstyle, after title={\space}, before upper app={\setparstyle}, } }
\newtcolorbox[use counter from=block]{claim}[4]{title={{#1~\thetcbcounter\notblank{#2#3}{\space}{}\notblank{#2}{\space#2}{}\notblank{#3}{\space(#3)}{}}}, phantomlabel={#4}, breakable, after={\par}, fontupper=\itshape, claimstyle, }
...
%% proof: title is a replacement
\tcbset{ justificationstyle/.style={bwminimalstyle, fonttitle=\blocktitlefont\itshape, attach title to upper, after title={\space}, after upper={\space\space\hspace*{\stretch{1}}\(\blacksquare\)},
} }
\newtcolorbox{justification}[3]{title={\notblank{#2}{#2}{#1.}}, phantom={\hypertarget{#3}{}}, breakable, after={\par}, justificationstyle, before upper app={\setparstyle} }
...
\tcbset{ heuristicstyle/.style={bwminimalstyle, runintitlestyle, blockspacingstyle, after title={\space}, before upper app={\setparstyle}, } }
\newtcolorbox[use counter from=block]{heuristic}[4]{title={{#1~\thetcbcounter\notblank{#2#3}{\space}{}\notblank{#2}{\space#2}{}\notblank{#3}{\space(#3)}{}}}, phantomlabel={#4}, breakable, after={\par}, fontupper=\itshape, heuristicstyle, }
%% hypothesis: fairly simple numbered block/structure
\tcbset{ hypothesisstyle/.style={bwminimalstyle, runintitlestyle, blockspacingstyle, after title={\space}, before upper app={\setparstyle}, } }
\newtcolorbox[use counter from=block]{hypothesis}[4]{title={{#1~\thetcbcounter\notblank{#2#3}{\space}{}\notblank{#2}{\space#2}{}\notblank{#3}{\space(#3)}{}}}, phantomlabel={#4}, breakable, after={\par}, fontupper=\itshape, hypothesisstyle, }
%% assumption: fairly simple numbered block/structure
\tcbset{ assumptionstyle/.style={bwminimalstyle, runintitlestyle, blockspacingstyle, after title={\space}, before upper app={\setparstyle}, } }
\newtcolorbox[use counter from=block]{assumption}[4]{title={{#1~\thetcbcounter\notblank{#2#3}{\space}{}\notblank{#2}{\space#2}{}\notblank{#3}{\space(#3)}{}}}, phantomlabel={#4}, breakable, after={\par}, fontupper=\itshape, assumptionstyle, }
%%
...
\tcbset{ conventionstyle/.style={bwminimalstyle, runintitlestyle, blockspacingstyle, after title={\space}, before upper app={\setparstyle}, } }
\newtcolorbox[use counter from=block]{convention}[3]{title={{#1~\thetcbcounter\notblank{#2}{\space\space#2}{}}}, phantomlabel={#3}, breakable, after={\par}, conventionstyle, }
%% observation: fairly simple numbered block/structure
\tcbset{ observationstyle/.style={bwminimalstyle, runintitlestyle, blockspacingstyle, after title={\space}, before upper app={\setparstyle}, } }
\newtcolorbox[use counter from=block]{observation}[3]{title={{#1~\thetcbcounter\notblank{#2}{\space\space#2}{}}}, phantomlabel={#3}, breakable, after={\par}, observationstyle, }
...
%%
%% tcolorbox, with styles, for OPENPROBLEM-LIKE
%%
%% openproblem: fairly simple numbered block/structure
\tcbset{ openproblemstyle/.style={bwminimalstyle, runintitlestyle, blockspacingstyle, after title={\space}, before upper app={\setparstyle}, } }
\newtcolorbox[use counter from=block]{openproblem}[3]{title={{#1~\thetcbcounter\notblank{#2}{\space\space#2}{}}}, phantomlabel={#3}, breakable, after={\par}, openproblemstyle, }
%%
...
\tcbset{ questionstyle/.style={bwminimalstyle, runintitlestyle, blockspacingstyle, after title={\space}, after upper={\space\space\hspace*{\stretch{1}}\(\square\)}, before upper app={\setparstyle}, } }
\newtcolorbox[use counter from=block]{question}[3]{title={{#1~\thetcbcounter\notblank{#2}{\space\space#2}{}}}, phantomlabel={#3}, breakable, after={\par}, questionstyle, }
...
\newtcolorbox{biographical}[3]{title={\notblank{#2}{#2}{}}, phantomlabel={#3}, breakable, biographicalstyle, before upper app={\setparstyle}}
...
\newtcolorbox{historical}[3]{title={\notblank{#2}{#2}{}}, phantomlabel={#3}, breakable, historicalstyle, before upper app={\setparstyle}}
%%
...
\tcbset{ panellistingptxstyle/.style={bwminimalstyle, blockspacingstyle, bottomtitle=2ex, fonttitle=\blocktitlefont} }
...
\tcbset{ sublistingptxstyle/.style={bwminimalstyle, blockspacingstyle, bottomtitle=2ex, fonttitle=\blocktitlefont} }
\makeatletter
...
{\large An Annotated Discourse}\support{This is an example of a statement describing funding support for the current document.%
}
}
...
\typeout{************************************************}
%
\begin{sectionptx}{Section}{Introduction}{}{Introduction}{}{}{section-introduction}
We consider definite integrals of functions \(f(x)\).  For example,%
\begin{equation*}
\definiteintegral{0}{2}{\sin^2(x)}{x}\text{.}
\end{equation*}
This is also a demonstration of the capabilities of \href{https://pretextbook.org}{PreTeXt}.\label{section-introduction-2-4}%
\par
Generated: August 14, 2025, 14:36:06 (-06:00)%
\end{sectionptx}
%
%
\typeout{************************************************}
...
Left to the reader.%
\end{proof}
You will find almost nothing about all this in the article \hyperlink{biblio-lay-article}{[{\xreffont 2}]}, nor in the book \hyperlink{biblio-judson-AATA}{[{\xreffont J.3.1}]}, since they belong in some other article, but we can cite them out-of-order for practice anyway.%
\par
...
\typeout{************************************************}
%
\begin{sectionptx}{Section}{Computing Integrals with Sage (\(\int\))}{}{Computing Integrals with Sage (\(\int\))}{}{}{section-sage-cells}
...
\index{verbatim@\mono{verbatim text}, use sortby}%
...
\begin{paragraphs}{Titled Sage Cells.}{section-sage-cells-69}%
...
\typeout{************************************************}
%
\begin{sectionptx}{Section}{An Interesting Corollary}{}{An Interesting Corollary}{}{}{section-interesting-corollary}
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{Second Version of \acronymintitle{FTC}}{}{Second Version of \acronymintitle{FTC}}{}{}{subsection-second-FTC}
\begin{corollary}{Corollary}{}{Leibniz, Newton}{corollary-FTC-derivative}%
...
%
\end{proof}
\begin{justification}{Justification}{}{corollary-FTC-derivative-5}
A justification, which is one of the variants of a proof.%
\end{justification}
\begin{proof}{Proof}{Alternate Proof.}{corollary-FTC-derivative-6}
...
c
\end{sageinput}
\begin{example}{Example}{A Mysterious Derivative!}{example-mysterious}%
...
\begin{claim}{Claim}{An Equivalent Claim.}{}{claim-with-cases}%
This claim is an equivalence: it is true if and only if it is correct.%
\end{claim}
\begin{proof}{Proof}{}{claim-with-cases-3}
...
\end{case}
\begin{case}{Case}{}{Case 3b: The inductive step.}{inductive-step}
...
\end{case}
\begin{case}{Case}{}{Why Not Try This?}{questioning-case}
...
\end{proof}
\begin{claim}{Claim}{A List of Equivalent Statements.}{}{claim-with-tfae-cases}%
...
%
\end{claim}
\begin{proof}{Proof}{}{claim-with-tfae-cases-3}
...
\begin{case}{Case}{((i) $\Rightarrow$ (ii)) }{}{claim-with-tfae-cases-3-2}
Here we would prove that the first statement implies the second.%
\end{case}
\begin{case}{Case}{((ii) $\Rightarrow$ (iii)) }{}{claim-with-tfae-cases-3-3}
Here we would prove that the second statement implies the third.%
\end{case}
\begin{case}{Case}{((iii) $\Rightarrow$ (iv)) }{The trickiest case.}{cycle}
...
\end{case}
\begin{case}{Case}{((iv) $\Rightarrow$ (i)) }{Wrap-around.}{claim-with-tfae-cases-3-5}
...
\begin{proof}{Proof}{}{subsection-second-FTC-15}\space(\hyperref[claim-with-tfae-cases]{{\xreffont\ref{claim-with-tfae-cases}}})\space
...
\begin{case}{Case}{((i) $\Rightarrow$ (ii)) }{}{subsection-second-FTC-15-2}
Another argument that the first statement implies the second.%
\end{case}
\begin{case}{Case}{((ii) $\Rightarrow$ (iii)) }{}{subsection-second-FTC-15-3}
And another argument that the second statement implies the third.%
\end{case}
\begin{case}{Case}{((iii) $\Rightarrow$ (iv)) }{Not so tricky this time.}{subsection-second-FTC-15-4}
Why did we find it so difficult before to prove that the third statement implies the last?%
\end{case}
\begin{case}{Case}{((iv) $\Rightarrow$ (i)) }{Wrap-around.}{subsection-second-FTC-15-5}
...
\begin{claim}{Claim}{Another List of Equivalent Statements.}{}{another-claim-with-tfae-cases}%
...
%
\end{claim}
\begin{proof}{Proof}{}{another-claim-with-tfae-cases-3}
You know the drill by now.%
\begin{case}{Case}{(1 $\Rightarrow$ 2) }{}{another-claim-with-tfae-cases-3-2}
Does the first statement imply the second?%
\end{case}
\begin{case}{Case}{(2 $\Rightarrow$ 3) }{The ``middle'' case.}{another-claim-with-tfae-cases-3-3}
Does the second statement imply the third?%
\end{case}
\begin{case}{Case}{(3 $\Rightarrow$ 1) }{}{another-claim-with-tfae-cases-3-4}
And finally, does the third imply the first?%
\end{case}
\end{proof}
This proof includes a \mono{@ref} to the preceding claim.%
\begin{proof}{Proof}{}{subsection-second-FTC-19}\space(\hyperref[another-claim-with-tfae-cases]{{\xreffont\ref{another-claim-with-tfae-cases}}})\space
\begin{case}{Case}{(1 $\Rightarrow$ 2) }{}{subsection-second-FTC-19-1}
Does the first statement imply the second?%
\end{case}
\begin{case}{Case}{(2 $\Rightarrow$ 3) }{The ``middle'' case.}{subsection-second-FTC-19-2}
Does the second statement imply the third?%
\end{case}
\begin{case}{Case}{(3 $\Rightarrow$ 1) }{}{subsection-second-FTC-19-3}
And finally, does the third imply the first?%
\end{case}
\end{proof}
This proof does not include a \mono{@ref}, and so the direction indicators get default markers.%
\begin{proof}{Proof}{}{subsection-second-FTC-21}
\begin{case}{Case}{(1 $\Rightarrow$ 2) }{}{subsection-second-FTC-21-1}
Does the first statement imply the second?%
\end{case}
\begin{case}{Case}{(2 $\Rightarrow$ 1) }{}{subsection-second-FTC-21-2}
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{A Pedagogical Note about Subsection~{\xreffont\ref*{subsection-second-FTC}}}{}{A Pedagogical Note about Subsection~{\xreffont\ref*{subsection-second-FTC}}}{}{}{section-interesting-corollary-5}
%
%
\typeout{************************************************}
...
\typeout{************************************************}
%
\begin{subsubsectionptx}{Subsubsection}{Symbolic and Numerical Integrals}{}{Symbolic and Numerical Integrals}{}{}{subsubsection-different-integrals}
...
\begin{inlineexercise}{Checkpoint}{Essay Question: Compare and Contrast.}{exercise-essay}%
...
\typeout{************************************************}
%
\begin{subsubsectionptx}{Subsubsection}{Advice}{}{Advice}{}{}{section-interesting-corollary-5-3}
...
\begin{example}{Example}{An Example of Structure.}{example-structured}%
...
\end{example}
\begin{question}{Question}{An Example of a Question.}{sample-question}%
...
\end{question}
\begin{inlineexercise}{Checkpoint}{An Inline Exercise.}{inline-exercise}%
...
\end{solutionproof}
\end{inlineexercise}%
\begin{example}{Example}{An Example of with \(\frac12\) math formula \(\displaystyle{\int e^x \, dx}\) in the title.}{example-math-title}%
...
\begin{project}{Project}{Start Exploring PreTeXt.}{section-interesting-corollary-5-3-8}%
...
\end{project}%
\begin{exploration}{Exploration}{Exploring Explorations.}{section-interesting-corollary-5-3-9}%
...
\begin{activity}{Activity}{Hints, Answers, Solutions.}{activity-with-hint-answer-solution}%
...
\begin{note}{Note}{A Note on Remarks.}{note-remark}%
...
\begin{aside}{Aside}{An Aside with a \emph{Formatted} Title.}{an-aside}%
\index{aside}%
...
\begin{inlineexercise}{Checkpoint}{A very structured exercise.}{exercise-structured}%
...
\par
In interdum suscipit ullamcorper. Morbi sit amet malesuada augue, id vestibulum magna. Nulla blandit dui metus, malesuada mollis sapien ullamcorper sit amet. Nulla at neque nisi. Integer vel porta felis.%
\begin{project}{Project}{A very structured project.}{project-structured}%
...
\begin{example}{Example}{Notation mathématique 2.}{example-structured-with-task}%
...
\begin{technology}{Technology}{Sample Use of Sage.}{section-interesting-corollary-5-3-19}%
...
\end{technology}
\begin{paragraphs}{A \mono{<paragraphs>} with a \mono{<project>} with an \mono{<answer>}.}{section-interesting-corollary-5-3-20}%
The solutions to a project (and similar) once did not migrate to the automatically-generated solutions.%
\begin{project}{Project}{}{section-interesting-corollary-5-3-20-3}%
...
\typeout{************************************************}
%
\begin{exercises-subsubsection}{Exercises}{Exercises}{}{Exercises}{}{}{exercises-subsection-solo}
\begin{divisionexercise}{1}{}{}{exercise-test-number}%
This is an exercise in an ``Exercises'' subdivision at the level of a subsubsection.  There is no question other than if the numbering is appropriate.  Here is a self-referential link: Exercise~\hyperlink{exercise-test-number}{{\xreffont 4.2.3.1}}.%
\par
...
\par\smallskip%
\noindent\textbf{\blocktitlefont Solution}.\hypertarget{exercise-test-number-2}{}\quad{}This solution will migrate to a list of solutions in the backmatter.  We include a \mono{sidebyside} as a test.%
...
\begin{divisionexercise}{2}{}{}{exercise-with-tasks}%
An \mono{<exercise>} can be structured with parts, called \mono{<task>}.  This is the \mono{<introduction>}.%
\begin{enumerate}[font=\bfseries,label=(\alph*),ref=\alph*]%
\item{}Do this.%
...
%
\typeout{************************************************}
\typeout{Reading Questions 4.2.4 Reading Questions}
\typeout{************************************************}
%
\begin{reading-questions-subsubsection}{Reading Questions}{Reading Questions}{}{Reading Questions}{}{}{section-interesting-corollary-5-5}
\begin{introduction}{}%
\index{reading questions}%
A set of reading questions may have an \mono{<introduction>}, perhaps for preparatory explanation.%
\par
If a student has logged in to the HTML version, then they can answer the reading questions directly in the book. Inline math LaTeX can be entered using \mono{\$}...\mono{\$} or \mono{\textbackslash{}(}...\mono{\textbackslash{})} delimiters, and inline AsciiMath using backticks \mono{\textasciigrave{}}...\mono{\textasciigrave{}} as delimiters. Here are some \textasciigrave{}gratuitous backticks\textasciigrave{} to check that AsciiMath is only active in the answers to reading questions.%
\end{introduction}%
\begin{divisionexercise}{1}{}{}{first-reading}%
This is a \terminology{reading question} that you might have a student answer prior to a class session, based on reading part of the book. A quick glance before class can help you tailor class time to the specific needs of your students. The perfect reading question will reveal whether the student has read and understood the material, and will be difficult to answer if they have not. What do you think of that?%
\end{divisionexercise}%
\begin{divisionexercise}{2}{}{}{section-interesting-corollary-5-5-3}%
And a second one, with a cross-reference to the first, as a check on numbering: \hyperlink{first-reading}{Reading Question~{\xreffont 4.2.4.1}}. Reading questions are allowed to have answers, but providing answers misses the point of a reading question, and the answer knowl interacts poorly with the mechanism used to allow students to answer directly in the book. Do you think the schema should ban answers to reading questions?%
\end{divisionexercise}%
\begin{conclusion}{}%
And for symmetry, a \mono{<conclusion>}.%
\end{conclusion}%
\end{reading-questions-subsubsection}
%
%
\typeout{************************************************}
\typeout{Glossary 4.2.5 Glossary}
\typeout{************************************************}
%
\begin{glossary-subsubsection}{Glossary}{Glossary}{}{Glossary}{}{}{glossary-specialized}
\index{glossary}%
%% this should be a new (isomorphic) "headnote" environment
\begin{introduction}{}%
A glossary may have a \mono{<headnote>}, perhaps with some explanation.  This glossary is a specialized division within a section.  Placement in the back matter is another option, see the \hyperlink{glossary-backmatter}{Glossary}.%
\end{introduction}%
\begin{glossaryitem}{bar.}{glossary-specialized-3}
A part of \terminology{foobar}.  See \hyperref[foobar-defined]{foobar}.%
\end{glossaryitem}
\begin{glossaryitem}{foobar.}{foobar-defined}
A synonym for the acronym \acronym{FUBAR}.%
\end{glossaryitem}
\end{glossary-subsubsection}
%
%
\typeout{************************************************}
\typeout{Solutions 4.2.6 Solutions for This Subsection}
\typeout{************************************************}
%
\begin{solutions-subsubsection}{Solutions}{Solutions for This Subsection}{}{Solutions for This Subsection}{}{}{solutions-subsection}
\index{solutions!for a division}%
\begin{introduction}{}%
This is an introduction, where you might explain that this division of this subsection contains various hints, answers, solutions of inline exercises, divisional exercises, and\slash{}or project-like blocks.  See the source to see just how this solutions division was built.%
\end{introduction}%
\par\medskip
\noindent\textbf{\normalsize{}4.2.1\space\textperiodcentered\space{}Symbolic and Numerical Integrals}
\begin{inlinesolution}{Checkpoint}{4.6}{Essay Question: Compare and Contrast.}{exercise-essay}%
\par\smallskip%
\noindent\textbf{\blocktitlefont Hint}.\hypertarget{exercise-essay-3-main}{}\quad{}Start writing!%
\end{inlinesolution}%
\par\medskip
\noindent\textbf{\normalsize{}4.2.2\space\textperiodcentered\space{}Advice}
\begin{inlinesolution}{Checkpoint}{4.9}{An Inline Exercise.}{inline-exercise}%
\par\smallskip%
\noindent\textbf{\blocktitlefont Hint}.\hypertarget{inline-exercise-3-main}{}\quad{}A good hint.%
\par\smallskip%
\noindent\textbf{\blocktitlefont Answer}.\hypertarget{inline-exercise-4-main}{}\quad{}42.%
\par\smallskip%
\noindent\textbf{\blocktitlefont Solution}.\hypertarget{inline-exercise-5-main}{}\quad{}If your exercise feels like proving a theorem, then you might want to make some comments, but also clearly delineate which part of the solution is a the complete proof.%
\begin{solutionproof}{Proof}
Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin lorem diam, convallis in nulla sed, accumsan fermentum urna. Pellentesque aliquet leo elit, ut consequat nunc dapibus ac. Sed lobortis leo tincidunt, vulputate nunc at, ultricies leo. Vivamus purus diam, tristique laoreet purus eget, mollis gravida sapien. Nunc vulputate nisl ac mauris hendrerit cursus. Sed vel molestie velit. Suspendisse sem sem, elementum at vehicula id, volutpat ac mi. Nullam ullamcorper fringilla purus in accumsan. Mauris at nunc accumsan orci dictum vulputate id id augue. Suspendisse at dignissim elit, non euismod nunc. Aliquam faucibus magna ac molestie semper. Aliquam hendrerit sem sit amet metus congue tempor. Donec laoreet laoreet metus, id interdum purus mattis vulputate. Proin condimentum vitae erat varius mollis. Donec venenatis libero sed turpis pretium tempor.%
\par
Praesent rutrum scelerisque felis sit amet adipiscing. Phasellus in mollis velit. Nunc malesuada felis sit amet massa cursus, eget elementum neque viverra. Integer sagittis dictum turpis vel aliquet. Fusce ut suscipit dolor, nec tristique nisl. Aenean luctus, leo et ornare fermentum, nibh dui vulputate leo, nec tincidunt augue ipsum sed odio. Nunc non erat sollicitudin, iaculis eros consequat, dapibus eros.%
\end{solutionproof}
\end{inlinesolution}%
\begin{explorationsolution}{Exploration}{4.2}{Exploring Explorations.}{section-interesting-corollary-5-3-9}%
\par\smallskip%
\noindent\textbf{\blocktitlefont Solution}.\hypertarget{section-interesting-corollary-5-3-9-3-main}{}\quad{}This is a ``solution'' to the exploration.  In practice, you might choose to not make this visible for students, but instead include it as part of some guidance you might provide to instructors (e.g.\@ an \pubtitle{Instructor's Manual}).%
\end{explorationsolution}%
\begin{activitysolution}{Activity}{4.3}{Hints, Answers, Solutions.}{activity-with-hint-answer-solution}%
\par\smallskip%
\noindent\textbf{\blocktitlefont Hint}.\hypertarget{activity-with-hint-answer-solution-4-main}{}\quad{}Just a little help.%
\par\smallskip%
\noindent\textbf{\blocktitlefont Answer}.\hypertarget{activity-with-hint-answer-solution-5-main}{}\quad{}The result, but no help in getting there.%
\par\smallskip%
\noindent\textbf{\blocktitlefont Solution}.\hypertarget{activity-with-hint-answer-solution-6-main}{}\quad{}Everything to get it all done, in detail.%
\end{activitysolution}%
\begin{inlinesolution}{Checkpoint}{4.12}{A very structured exercise.}{exercise-structured}%
\begin{enumerate}[font=\bfseries,label=(\alph*),ref=\alph*]%
\item[(c)]\lititle{A title of a task that has a subtask with an \mono{<answer>} for the Solutions.}\par%
\begin{enumerate}[font=\bfseries,label=(\roman*),ref=\theenumi.\roman*]%
\item[(i)]\lititle{A task with a title and an \mono{<answer>} for the Solutions.}\par%
\par\smallskip%
\noindent\textbf{\blocktitlefont Answer}.\hypertarget{exercise-structured-5-3-3-main}{}\quad{}With a proof.%
\begin{solutionproof}{Proof}
In interdum suscipit ullamcorper. Morbi sit amet malesuada augue, id vestibulum magna. Nulla blandit dui metus, malesuada mollis sapien ullamcorper sit amet. Nulla at neque nisi. Integer vel porta felis.%
\end{solutionproof}
And a bit more to say.%
\item[(ii)]\noindent\textbf{\blocktitlefont Answer}.\hypertarget{exercise-structured-5-4-2-main}{}\quad{}Right!  In interdum suscipit ullamcorper. Morbi sit amet malesuada augue, id vestibulum magna. Nulla blandit dui metus, malesuada mollis sapien ullamcorper sit amet. Nulla at neque nisi. Integer vel porta felis.%
\end{enumerate}%
\item[(d)]\noindent\textbf{\blocktitlefont Hint}.\hypertarget{exercise-structured-6-2-main}{}\quad{}One hint.  In interdum suscipit ullamcorper. Morbi sit amet malesuada augue, id vestibulum magna. Nulla blandit dui metus, malesuada mollis sapien ullamcorper sit amet. Nulla at neque nisi. Integer vel porta felis.%
\par
In interdum suscipit ullamcorper. Morbi sit amet malesuada augue, id vestibulum magna. Nulla blandit dui metus, malesuada mollis sapien ullamcorper sit amet. Nulla at neque nisi. Integer vel porta felis.%
\par\smallskip%
\noindent\textbf{\blocktitlefont Answer 1}.\hypertarget{exercise-structured-6-3-main}{}\quad{}First answer.  In interdum suscipit ullamcorper.%
\par\smallskip%
\noindent\textbf{\blocktitlefont Answer 2}.\hypertarget{exercise-structured-6-4-main}{}\quad{}Second answer.  In interdum suscipit ullamcorper. Morbi sit amet malesuada augue, id vestibulum magna. Nulla blandit dui metus, malesuada mollis sapien ullamcorper sit amet. Nulla at neque nisi. Integer vel porta felis.%
\par
In interdum suscipit ullamcorper. Morbi sit amet malesuada augue, id vestibulum magna. Nulla blandit dui metus, malesuada mollis sapien ullamcorper sit amet. Nulla at neque nisi. Integer vel porta felis.%
\par
In interdum suscipit ullamcorper. Morbi sit amet malesuada augue, id vestibulum magna. Nulla blandit dui metus, malesuada mollis sapien ullamcorper sit amet. Nulla at neque nisi. Integer vel porta felis.%
\par\smallskip%
\noindent\textbf{\blocktitlefont Solution}.\hypertarget{exercise-structured-6-5-main}{}\quad{}At last, the solution.  In interdum suscipit ullamcorper. Morbi sit amet malesuada augue, id vestibulum magna. Nulla blandit dui metus, malesuada mollis sapien ullamcorper sit amet. Nulla at neque nisi. Integer vel porta felis.%
\end{enumerate}%
\end{inlinesolution}%
\begin{projectsolution}{Project}{4.4}{A very structured project.}{project-structured}%
\begin{enumerate}[font=\bfseries,label=(\alph*),ref=\alph*]%
\item[(c)]\begin{enumerate}[font=\bfseries,label=(\roman*),ref=\theenumi.\roman*]%
\item[(i)]\noindent\textbf{\blocktitlefont Answer}.\hypertarget{project-structured-6-2-2-main}{}\quad{}With a proof.%
\begin{solutionproof}{Proof}
In interdum suscipit ullamcorper. Morbi sit amet malesuada augue, id vestibulum magna. Nulla blandit dui metus, malesuada mollis sapien ullamcorper sit amet. Nulla at neque nisi. Integer vel porta felis.%
\end{solutionproof}
And a bit more to say.%
\item[(ii)]\noindent\textbf{\blocktitlefont Answer}.\hypertarget{project-structured-6-3-2-main}{}\quad{}Right!  In interdum suscipit ullamcorper. Morbi sit amet malesuada augue, id vestibulum magna. Nulla blandit dui metus, malesuada mollis sapien ullamcorper sit amet. Nulla at neque nisi. Integer vel porta felis.%
\end{enumerate}%
\item[(d)]\noindent\textbf{\blocktitlefont Hint}.\hypertarget{project-structured-7-2-main}{}\quad{}One hint.  In interdum suscipit ullamcorper. Morbi sit amet malesuada augue, id vestibulum magna. Nulla blandit dui metus, malesuada mollis sapien ullamcorper sit amet. Nulla at neque nisi. Integer vel porta felis.%
\par
In interdum suscipit ullamcorper. Morbi sit amet malesuada augue, id vestibulum magna. Nulla blandit dui metus, malesuada mollis sapien ullamcorper sit amet. Nulla at neque nisi. Integer vel porta felis.%
\par\smallskip%
\noindent\textbf{\blocktitlefont Answer 1}.\hypertarget{project-structured-7-3-main}{}\quad{}First answer.  In interdum suscipit ullamcorper.%
\par\smallskip%
\noindent\textbf{\blocktitlefont Answer 2}.\hypertarget{project-structured-7-4-main}{}\quad{}Second answer.  In interdum suscipit ullamcorper. Morbi sit amet malesuada augue, id vestibulum magna. Nulla blandit dui metus, malesuada mollis sapien ullamcorper sit amet. Nulla at neque nisi. Integer vel porta felis.%
\par
In interdum suscipit ullamcorper. Morbi sit amet malesuada augue, id vestibulum magna. Nulla blandit dui metus, malesuada mollis sapien ullamcorper sit amet. Nulla at neque nisi. Integer vel porta felis.%
\par
In interdum suscipit ullamcorper. Morbi sit amet malesuada augue, id vestibulum magna. Nulla blandit dui metus, malesuada mollis sapien ullamcorper sit amet. Nulla at neque nisi. Integer vel porta felis.%
\par\smallskip%
\noindent\textbf{\blocktitlefont Solution}.\hypertarget{project-structured-7-5-main}{}\quad{}At last, the solution.  In interdum suscipit ullamcorper. Morbi sit amet malesuada augue, id vestibulum magna. Nulla blandit dui metus, malesuada mollis sapien ullamcorper sit amet. Nulla at neque nisi. Integer vel porta felis.%
\end{enumerate}%
\end{projectsolution}%
\begin{projectsolution}{Project}{4.5}{}{section-interesting-corollary-5-3-20-3}%
\noindent\textbf{\blocktitlefont Answer}.\hypertarget{section-interesting-corollary-5-3-20-3-2-main}{}\quad{}Here's the answer we are looking for.%
\end{projectsolution}%
\par\medskip
\noindent\textbf{\normalsize{}4.2.3\space\textperiodcentered\space{}Exercises}
\begin{divisionsolution}{Exercise}{4.2.3.1}{}{exercise-test-number}%
\noindent\textbf{\blocktitlefont Solution}.\hypertarget{exercise-test-number-2-main}{}\quad{}This solution will migrate to a list of solutions in the backmatter.  We include a \mono{sidebyside} as a test.%
\begin{sidebyside}{2}{0.1}{0.1}{0.2}%
\begin{sbspanel}{0.3}%
This is a skinny paragraph which should be just 30\% of the width.%
\end{sbspanel}%
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{Theorem-Like Environments}{}{Theorem-Like Environments}{}{}{section-interesting-corollary-6}
...
\begin{principle}{Principle}{The Title Principle.}{}{principle-principle}%
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{Linking Sage Cells}{}{Linking Sage Cells}{}{}{section-interesting-corollary-7}
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{Hierarchy}{}{Hierarchy}{}{}{section-interesting-corollary-8}
\begin{paragraphs}{Structure.}{hierarchy-structure}%
...
\end{paragraphs}%
\begin{paragraphs}{A Second Paragraphs.}{section-interesting-corollary-8-3}%
...
\end{paragraphs}%
\begin{assemblage}{Assemblage}{Assemblages: Collections and Summaries.}{assemblage-basics}%
...
\end{center}%
\end{assemblage}
\begin{assemblage}{Assemblage}{}{section-interesting-corollary-8-5}%
...
\end{assemblage}
\begin{assemblage}{Assemblage}{Assemblages containing \(\mu \forall \tau \mathbb{H} = \emptyset \kappa\).}{section-interesting-corollary-8-6}%
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{Introductions and Conclusions}{}{Introductions and Conclusions}{}{}{subsection-intro-conclude}
\begin{introduction}{An Introductory Introduction.}%
...
\typeout{************************************************}
%
\begin{subsubsectionptx}{Subsubsection}{Test One}{}{Test One}{}{}{subsection-intro-conclude-3}
...
\typeout{************************************************}
%
\begin{subsubsectionptx}{Subsubsection}{Test Two}{}{Test Two}{}{}{subsection-intro-conclude-4}
...
\begin{inlineexercise}{Checkpoint}{}{subsection-intro-conclude-4-3}%
...
%
\typeout{************************************************}
\typeout{Reading Questions 4.6.2 What Did You Learn?}
\typeout{************************************************}
%
\begin{reading-questions-paragraph-numberless}{Reading Questions}{What Did You Learn?}{}{What Did You Learn?}{}{}{subsection-intro-conclude-4-4}
\begin{divisionexercise}{1}{}{}{subsection-intro-conclude-4-4-2}%
A mock exercise to appease validation.%
\par\smallskip%
\noindent\textbf{\blocktitlefont Answer}.\hypertarget{subsection-intro-conclude-4-4-2-2}{}\quad{}An answer so there is something to appear in a \mono{<solutions>}.%
\end{divisionexercise}%
\begin{divisionexercise}{2}{}{}{subsection-intro-conclude-4-4-3}%
And a second to help with formatting the division heading.%
\end{divisionexercise}%
\end{reading-questions-paragraph-numberless}
%
%
\typeout{************************************************}
...
\typeout{************************************************}
%
\begin{exercises-paragraph-numberless}{Exercises}{Exercises}{}{Exercises}{}{}{subsection-intro-conclude-4-5}
\begin{divisionexercise}{1}{}{}{subsection-intro-conclude-4-5-1}%
A mock exercise to appease validation.%
\par\smallskip%
\noindent\textbf{\blocktitlefont Answer}.\hypertarget{subsection-intro-conclude-4-5-1-2}{}\quad{}An answer so there is something to appear in a \mono{<solutions>}.%
\end{divisionexercise}%
\begin{divisionexercise}{2}{}{}{subsection-intro-conclude-4-5-2}%
And a second to help with formatting the division heading.%
\end{divisionexercise}%
\end{exercises-paragraph-numberless}
\end{subsubsectionptx}
%
%
\typeout{************************************************}
...
\typeout{************************************************}
%
\begin{subsubsectionptx}{Subsubsection}{Test Three}{}{Test Three}{}{}{subsection-intro-conclude-5}
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{Some Paragraph-Level Markup}{}{Some Paragraph-Level Markup}{}{}{subsection-paragraph-markup}
...
\typeout{************************************************}
%
\begin{sectionptx}{Section}{Some Facts and Figures}{}{Some Facts and Figures}{}{}{section-facts-figures}
\index{footnotes}%
...
\end{multicols}
%
\begin{remark}{Remark}{}{section-facts-figures-4}%
...
\typeout{************************************************}
%
\begin{sectionptx}{Section}{Some Advanced Ideas}{}{Some Advanced Ideas}{}{}{derivatives-9}
...
\end{alignat*}
Beautiful.%
\begin{aside}{Aside}{Overlap Test.}{section-mathematics-4-8}%
This is simply to test what happens when an aside bumps into something like the content below that may extend past the normal right content boundary. It likely only is of interest with the theme \mono{default-modern}.%
\end{aside}
...
- \frac{d}{2\pi}\hat S_-(0)\log \pi\text{.}\label{section-mathematics-4-9-3}
\end{equation}
%
\begin{example}{Example}{Excessive Display Mathematics.}{section-mathematics-4-10}%
...
\begin{gather}
x^2+y^2=z^2\label{section-mathematics-4-10-3-2-1}\\*
a^2+b^2=c^2\label{section-mathematics-4-10-3-2-2}\\*
\alpha^2+\beta^2=\gamma^2\label{section-mathematics-4-10-3-2-3}\\*
m^2+n^2=p^2\label{section-mathematics-4-10-3-2-4}\\
x^2+y^2=z^2\label{section-mathematics-4-10-3-2-5}\\*
a^2+b^2=c^2\label{section-mathematics-4-10-3-2-6}\\*
\alpha^2+\beta^2=\gamma^2\label{section-mathematics-4-10-3-2-7}\\*
m^2+n^2=p^2\label{section-mathematics-4-10-3-2-8}\\
x^2+y^2=z^2\label{section-mathematics-4-10-3-2-9}\\*
a^2+b^2=c^2\label{section-mathematics-4-10-3-2-10}\\*
\alpha^2+\beta^2=\gamma^2\label{section-mathematics-4-10-3-2-11}\\*
m^2+n^2=p^2\label{section-mathematics-4-10-3-2-12}\\
x^2+y^2=z^2\label{section-mathematics-4-10-3-2-13}\\*
a^2+b^2=c^2\label{section-mathematics-4-10-3-2-14}\\*
\alpha^2+\beta^2=\gamma^2\label{section-mathematics-4-10-3-2-15}\\*
m^2+n^2=p^2\label{section-mathematics-4-10-3-2-16}\\
x^2+y^2=z^2\label{section-mathematics-4-10-3-2-17}\\*
a^2+b^2=c^2\label{section-mathematics-4-10-3-2-18}\\*
\alpha^2+\beta^2=\gamma^2\label{section-mathematics-4-10-3-2-19}\\*
m^2+n^2=p^2\label{section-mathematics-4-10-3-2-20}\\
x^2+y^2=z^2\label{section-mathematics-4-10-3-2-21}\\*
a^2+b^2=c^2\label{section-mathematics-4-10-3-2-22}\\*
\alpha^2+\beta^2=\gamma^2\label{section-mathematics-4-10-3-2-23}\\*
m^2+n^2=p^2\label{section-mathematics-4-10-3-2-24}\\
x^2+y^2=z^2\label{section-mathematics-4-10-3-2-25}\\*
a^2+b^2=c^2\label{section-mathematics-4-10-3-2-26}\\*
\alpha^2+\beta^2=\gamma^2\label{section-mathematics-4-10-3-2-27}\\*
m^2+n^2=p^2\label{section-mathematics-4-10-3-2-28}\\
x^2+y^2=z^2\label{section-mathematics-4-10-3-2-29}\\*
a^2+b^2=c^2\label{section-mathematics-4-10-3-2-30}\\*
\alpha^2+\beta^2=\gamma^2\label{section-mathematics-4-10-3-2-31}\\*
m^2+n^2=p^2\label{section-mathematics-4-10-3-2-32}\\
x^2+y^2=z^2\label{section-mathematics-4-10-3-2-33}\\*
a^2+b^2=c^2\label{section-mathematics-4-10-3-2-34}\\*
\alpha^2+\beta^2=\gamma^2\label{section-mathematics-4-10-3-2-35}\\*
m^2+n^2=p^2\label{section-mathematics-4-10-3-2-36}\\
x^2+y^2=z^2\label{section-mathematics-4-10-3-2-37}\\*
a^2+b^2=c^2\label{section-mathematics-4-10-3-2-38}\\*
\alpha^2+\beta^2=\gamma^2\label{section-mathematics-4-10-3-2-39}\\*
m^2+n^2=p^2\label{section-mathematics-4-10-3-2-40}\\
x^2+y^2=z^2\label{section-mathematics-4-10-3-2-41}\\*
a^2+b^2=c^2\label{section-mathematics-4-10-3-2-42}\\*
\alpha^2+\beta^2=\gamma^2\label{section-mathematics-4-10-3-2-43}\\*
m^2+n^2=p^2\label{section-mathematics-4-10-3-2-44}\\
x^2+y^2=z^2\label{section-mathematics-4-10-3-2-45}\\*
a^2+b^2=c^2\label{section-mathematics-4-10-3-2-46}\\*
\alpha^2+\beta^2=\gamma^2\label{section-mathematics-4-10-3-2-47}\\*
m^2+n^2=p^2\text{.}\label{section-mathematics-4-10-3-2-48}
\end{gather}
%
\par
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{Local Tags on Equations}{}{Local Tags on Equations}{}{}{section-mathematics-7}
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{Commutative Diagrams}{}{Commutative Diagrams}{}{}{commutative-diagrams}
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{Line-Breaking after Mathematics}{}{Line-Breaking after Mathematics}{}{}{line-breaking-math}
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{Fonts and Mathematics}{}{Fonts and Mathematics}{}{}{font-math}
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{Miscellaneous}{}{Miscellaneous}{}{}{miscellaneous-math}
In \initialism{HTML} output, a MathJax workaround for a Safari rendering bug was inserting extra spaces after textual subscripts and superscripts (\href{https://groups.google.com/g/mathjax-users/c/ANjLK9KtcWA/m/vlHaPja-AwAJ}{MathJax thread}).  PreTeXt CSS now applies a correction.  The following tests if the CSS fix is sufficient, and could be used to test the necessity of our fix in the future.  Following is the original report, though \mono{NOT} has been moved to a superscript:%
\begin{gather*}
...
\typeout{************************************************}
%
\begin{sectionptx}{Section}{Grouping Samples}{}{Grouping Samples}{}{}{block-samples}
\begin{introduction}{}%
...
\begin{aside}{Aside}{A title.}{block-samples-2-4}%
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{Remark-like Blocks}{}{Remark-like Blocks}{}{}{block-samples-remark-like}
\begin{remark}{Remark}{A title.}{block-samples-remark-like-2}%
A minimal \mono{<remark>}.%
\end{remark}
\begin{convention}{Convention}{A title.}{block-samples-remark-like-3}%
A minimal \mono{<convention>}.%
\end{convention}
\begin{note}{Note}{A title.}{block-samples-remark-like-4}%
A minimal \mono{<note>}.%
\end{note}
\begin{observation}{Observation}{A title.}{block-samples-remark-like-5}%
A minimal \mono{<observation>}.%
\end{observation}
\begin{warning}{Warning}{A title.}{block-samples-remark-like-6}%
A minimal \mono{<warning>}.%
\end{warning}
\begin{insight}{Insight}{A title.}{block-samples-remark-like-7}%
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{Example-like Blocks}{}{Example-like Blocks}{}{}{block-samples-example-like}
\begin{example}{Example}{A title.}{block-samples-example-like-2}%
A minimal \mono{<example>}.%
\end{example}
\begin{example}{Example}{A title.}{block-samples-example-like-3}%
...
The \mono{<conclusion>}.%
\end{example}
\begin{question}{Question}{A title.}{block-samples-example-like-4}%
A minimal \mono{<question>}.%
\end{question}
\begin{problem}{Problem}{A title.}{block-samples-example-like-5}%
A minimal \mono{<problem>}.%
\end{problem}
\begin{observation}{Observation}{A title.}{block-samples-example-like-6}%
A minimal \mono{<observation>}.%
\end{observation}
\begin{warning}{Warning}{A title.}{block-samples-example-like-7}%
A minimal \mono{<warning>}.%
\end{warning}
\begin{insight}{Insight}{A title.}{block-samples-example-like-8}%
A minimal \mono{<insight>}.%
\end{insight}
\end{subsectionptx}
%
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{Theorem-like Blocks}{}{Theorem-like Blocks}{}{}{block-samples-theorem-like}
\begin{theorem}{Theorem}{A title.}{}{block-samples-theorem-like-2}%
A minimal \mono{<theorem>}.%
\end{theorem}
\begin{theorem}{Theorem}{A title.}{}{block-samples-theorem-like-3}%
A theorem with a proof.%
\end{theorem}
\begin{proof}{Proof}{}{block-samples-theorem-like-3-3}
The proof of the theorem.%
\end{proof}
\begin{corollary}{Corollary}{A title.}{}{block-samples-theorem-like-4}%
A minimal \mono{<corollary>}.%
\end{corollary}
\begin{lemma}{Lemma}{A title.}{}{block-samples-theorem-like-5}%
A minimal \mono{<lemma>}.%
\end{lemma}
\begin{algorithm}{Algorithm}{A title.}{}{block-samples-theorem-like-6}%
A minimal \mono{<algorithm>}.%
\end{algorithm}
\begin{proposition}{Conundrum}{A title.}{}{block-samples-theorem-like-7}%
A minimal \mono{<proposition>}.%
\end{proposition}
\begin{claim}{Claim}{A title.}{}{block-samples-theorem-like-8}%
A minimal \mono{<claim>}.%
\end{claim}
\begin{fact}{Fact}{A title.}{}{block-samples-theorem-like-9}%
A minimal \mono{<fact>}.%
\end{fact}
\begin{identity}{Identity}{A title.}{}{block-samples-theorem-like-10}%
A minimal \mono{<identity>}.%
\end{identity}
\begin{proof}{Proof}{A title.}{block-samples-theorem-like-11}
A stand-alone proof.%
\end{proof}
\end{subsectionptx}
%
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{Axiom-like Blocks}{}{Axiom-like Blocks}{}{}{block-samples-axiom-like}
\begin{axiom}{Axiom}{A title.}{}{block-samples-axiom-like-2}%
A minimal \mono{<axiom>}.%
\end{axiom}
\begin{conjecture}{Conjecture}{A title.}{}{block-samples-axiom-like-3}%
A minimal \mono{<conjecture>}.%
\end{conjecture}
\begin{principle}{Principle}{A title.}{}{block-samples-axiom-like-4}%
A minimal \mono{<principle>}.%
\end{principle}
\begin{heuristic}{Heuristic}{A title.}{}{block-samples-axiom-like-5}%
A minimal \mono{<heuristic>}.%
\end{heuristic}
\begin{hypothesis}{Hypothesis}{A title.}{}{block-samples-axiom-like-6}%
A minimal \mono{<hypothesis>}.%
\end{hypothesis}
\begin{assumption}{Assumption}{A title.}{}{block-samples-axiom-like-7}%
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{Definition-like Blocks}{}{Definition-like Blocks}{}{}{block-samples-definition-like}
\begin{definition}{Definition}{A title.}{block-samples-definition-like-2}%
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{Aside-like Blocks}{}{Aside-like Blocks}{}{}{block-samples-aside-like}
Three \mono{<aside>}s are below.%
\begin{aside}{Aside}{A title.}{block-samples-aside-like-3}%
A minimal \mono{<aside>}.%
\end{aside}
\begin{biographical}{Biographical Aside}{A title.}{block-samples-aside-like-4}%
A minimal \mono{<biographical>}.%
\end{biographical}
\begin{biographical}{Biographical Aside}{A title.}{block-samples-aside-like-5}%
A minimal \mono{<biographical>}.%
\end{biographical}
\begin{historical}{Historical Aside}{A title.}{block-samples-aside-like-6}%
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{Computation-like Blocks}{}{Computation-like Blocks}{}{}{block-samples-computation-like}
\begin{computation}{Computation}{A title.}{block-samples-computation-like-2}%
A minimal \mono{<computation>}.%
\end{computation}
\begin{technology}{Technology}{A title.}{block-samples-computation-like-3}%
A minimal \mono{<technology>}.%
\end{technology}
\begin{data}{Data}{A title.}{block-samples-computation-like-4}%
A minimal \mono{<data>}.%
\end{data}
\end{subsectionptx}
%
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{Project-like Blocks}{}{Project-like Blocks}{}{}{block-samples-project-like}
\begin{project}{Project}{A title.}{block-samples-project-like-2}%
A minimal \mono{<project>}.%
\end{project}%
\begin{activity}{Activity}{A title.}{block-samples-project-like-3}%
A minimal \mono{<activity>}.%
\end{activity}%
\begin{exploration}{Exploration}{A title.}{block-samples-project-like-4}%
A minimal \mono{<exploration>}.%
\end{exploration}%
\begin{investigation}{Investigation}{A title.}{block-samples-project-like-5}%
A minimal \mono{<investigation>}.%
\end{investigation}%
\end{subsectionptx}
\begin{assemblage}{Assemblage}{}{block-samples-12}%
A minimal \mono{<assemblage>}.%
\end{assemblage}
\begin{conclusion}{Wrap-up.}%
A minimal \mono{<conclusion>}.%
\end{conclusion}%
\begin{aside}{Aside}{A title.}{block-samples-14}%
...
\typeout{************************************************}
%
\begin{sectionptx}{Section}{Entering Text in Paragraphs, Titles, Captions}{}{Text in Paragraphs}{}{}{section-text-paragraphs}
\begin{introduction}{}%
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{Special \initialismintitle{XML} characters}{}{Special \initialismintitle{XML} characters}{}{}{subsection-xml-escape}
...
\begin{inlineexercise}{Checkpoint}{}{subsection-xml-escape-7}%
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{Quotations}{}{Quotations}{}{}{section-text-paragraphs-6}
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{Groupings}{}{Groupings}{}{}{section-text-paragraphs-7}
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{Characters, Symbols, and Constructions}{}{Characters, Symbols, and Constructions}{}{}{section-text-paragraphs-8}
Verbatim, inline text, is accomplished with the \mono{<c>} element.  One special consideration: if your editor splits a line in the middle, we will fix it.  This sentence has \mono{two words} that we purposely split with a ``newline'' character in the middle.  In output you should see a space between the words.%
\par
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{Currency}{}{Currency}{}{}{section-text-paragraphs-9}
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{Icons in Text}{}{Icons in Text}{}{}{subsection-icons-in-text}
...
\begin{warning}{Warning}{Icons, \mono{xelatex}, and Fonts.}{subsection-icons-in-text-7}%
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{Keyboard Keys}{}{Keyboard Keys}{}{}{subsection-keyboard}
\index{keyboard keys}%
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{URLs, such as \mono{http://example.com}}{}{URLs, such as \mono{http://example.com}}{}{}{section-urls}
...
\begin{itemize}[label=\textbullet]
\item{}\href{http://example.com/}{With a useful \mono{@visual} attribute}%
\item{}\href{http://example.com/}{With a duplicate \mono{@visual} attribute}%
\item{}\href{http://example.com/}{With no \mono{@visual} attribute}, so an edited one is formulated (no protocol)%
\end{itemize}
%
\par
...
\par
\href{http://example.com/ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789\%58-._\~:/?\#[]@!$\&'()*+,;=}{Characters to a footnote}%
\end{quote}
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{Biological Names}{}{Biological Names}{}{}{section-text-paragraphs-13}
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{Verbatim in titles, \mono{\textbackslash{}a\&b\#c\%d\textasciitilde{}e\{f\}g\$h\_i\textasciicircum{}j}, OK}{}{Verbatim in titles, \mono{\textbackslash{}a\&b\#c\%d\textasciitilde{}e\{f\}g\$h\_i\textasciicircum{}j}, OK}{}{}{section-text-paragraphs-14}
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{Special Situations}{}{Special Situations}{}{}{subsection-special-situations}
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{Jupyter Notebook, Markdown, MathJax, Delimiters}{}{Jupyter Notebook, Markdown, MathJax, Delimiters}{}{}{subsection-jupyter-dollars}
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{\LaTeX{} Characters, Ligatures, and More}{}{\LaTeX{} Characters, Ligatures, and More}{}{}{section-text-paragraphs-17}
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{\initialismintitle{HTML} and accidental mathematics}{}{\initialismintitle{HTML} and accidental mathematics}{}{}{section-text-paragraphs-18}
...
\typeout{************************************************}
%
\begin{sectionptx}{Section}{Graphics}{}{Graphics}{}{}{section-graphics}
\begin{introduction}{}%
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{Images from External Sources}{}{Images from External Sources}{}{}{section-graphics-3}
...
\begin{figureptx}{Figure}{New Zealand Landscape, \href{https://commons.wikimedia.org/wiki/File:NZ_Landscape_from_the_van.jpg}{\mono{commons.wikimedia.org}}, CC-BY-SA-2.0}{section-graphics-3-3}{}%
...
\tcblower
\end{figureptx}%
\begin{remark}{Remark}{Footnote Buried.}{section-graphics-3-7}%
...
\end{remark}
\footnotetext[1]{Interior footnote.\label{section-graphics-3-7-3-1-2}}%
\end{subsectionptx}
%
%
\typeout{************************************************}
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{PreFigure}{}{PreFigure}{}{}{prefigure-diagrams}
...
\noindent\includegraphics[width=\linewidth]{generated/prefigure/prefigure-fibonacci-a.pdf}%
\end{sbspanel}%
\begin{sbspanel}{0.5}[bottom]%
\noindent\includegraphics[width=\linewidth]{generated/prefigure/prefigure-fibonacci-b.pdf}%
\end{sbspanel}%
\end{sidebyside}%
\tcblower
\end{figureptx}%
...
\tcblower
\end{figureptx}%
A plot might use a graphics language to draw the axes and grid, but the data might be from an experiment and live in an external file that you do not wish to place in your source.  Place such a file in a subdirectory directly below the directory where your master source file resides.  Then indicate this directory in a \mono{docinfo/directories/@data} attribute of your source.  But you \emph{must} prefix the path with \mono{data/} as in the source below.%
...
\tcblower
\end{figureptx}%
The TikZ image in the next figure is made up from two \initialism{PNG} images (the shark and the swimmer), in addition to various TikZ commands.  The images reside in a source directory, \mono{numerical/attack}, so the image files (\mono{shark.png}, \mono{swimmer.png}) are prefixed in the TikZ code with \mono{data/attack} so the creation of the image will be successful.  This example is courtesy of Stephen Brown.%
\begin{figureptx}{Figure}{An illustration of the shark trying to catch you as you swim to shore.}{figure-shark-attack}{}%
\begin{image}{0}{1}{0}{}%
\resizebox{\linewidth}{!}{%
\begin{tikzpicture}
...
\begin{figureptx}{Figure}{A matrix with colored entries}{section-graphics-5-17}{}%
\begin{image}{0.25}{0.5}{0.25}{}%
\resizebox{\linewidth}{!}{%
    \begin{tikzpicture}
    \node{
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{Asymptote, 2D}{}{Asymptote, 2D}{}{}{section-graphics-6}
...
\begin{image}{0}{1}{0}{}%
\href{https://pretextbook.org/examples/sample-article/html/generated/asymptote/asymptote-lever.html}{\includegraphics[width=\linewidth]{generated/asymptote/asymptote-lever.pdf}}
\end{image}%
\tcblower
\end{figureptx}%
...
\begin{image}{0}{1}{0}{}%
\href{https://pretextbook.org/examples/sample-article/html/generated/asymptote/asymptote-contour.html}{\includegraphics[width=\linewidth]{generated/asymptote/asymptote-contour.pdf}}
\end{image}%
\tcblower
\end{figureptx}%
...
\begin{image}{0.1}{0.8}{0.1}{}%
\href{https://pretextbook.org/examples/sample-article/html/generated/asymptote/asymptote-lever-integral.html}{\includegraphics[width=\linewidth]{generated/asymptote/asymptote-lever-integral.pdf}}
\end{image}%
\tcblower
\end{figureptx}%
\end{subsectionptx}
...
\href{https://pretextbook.org/examples/sample-article/html/generated/asymptote/asymptote-surface.html}{\includegraphics[width=\linewidth]{generated/asymptote/asymptote-surface.pdf}}
\end{image}%
\tcblower
\end{figureptx}%
\end{subsectionptx}
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{Mermaid Diagrams}{}{Mermaid Diagrams}{}{}{graphics-mermaid}
\index{Mermaid diagrams}%
\href{https://mermaid.js.org/}{Mermaid} is a Markdown-inspired tool for authoring various kinds of diagrams. Below, three of the available diagram types are demonstrated. For a full listing of diagram types, see the \href{https://mermaid.js.org/intro/\#diagram-types}{Mermaid Documentation}. The \href{https://mermaid.live/}{Mermaid live editor}is a great tool for testing the syntax of your mermaid diagrams.%
\par
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{Sage Plots}{}{Sage Plots}{}{}{section-graphics-9}
\index{Sage plots}%
...
\tcblower
\end{figureptx}%
The following examples are from the \href{http://www.sagemath.org/tour-graphics.html}{Sage Tour}.  We package them into a \mono{sidebyside} layout element, see \hyperref[section-side-by-side]{Section~{\xreffont\ref{section-side-by-side}}}.%
\begin{sidebyside}{2}{0.05}{0.05}{0.1}%
\begin{sbspanel}{0.4}%
\begin{panelfigureptx}{Figure}{A Sage multigraph of a sentence}{figure-sage-multigraph}{}%
\noindent\includegraphics[width=\linewidth]{generated/sageplot/sageplot-sentence-multigraph.pdf}%
\tcblower
\end{panelfigureptx}%
\end{sbspanel}%
\begin{sbspanel}{0.4}%
\begin{panelfigureptx}{Figure}{Sage polynomial approximations of \(f(x)=1/(1+25x^2)\)}{figure-sage-polynomial-approximation}{}%
\noindent\includegraphics[width=\linewidth]{generated/sageplot/sageplot-polynomial-approximation.pdf}%
\tcblower
\end{panelfigureptx}%
\end{sbspanel}%
\end{sidebyside}%
...
\begin{sbspanel}{0.25}%
\noindent\includegraphics[width=\linewidth]{external/images/inkscape-stars-plain.pdf}
\end{sbspanel}%
\begin{sbspanel}{0.25}%
\noindent\includegraphics[width=\linewidth]{external/images/inkscape-stars-native.pdf}
\end{sbspanel}%
\end{sidebyside}%
\tcblower
\end{figureptx}%
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{Copies of Images}{}{Copies of Images}{}{}{section-graphics-11}
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{Caption Testing}{}{Caption Testing}{}{}{section-graphics-12}
A caption could be as substantial as a paragraph, here we test out one such example.%
\begin{figureptx}{Figure}{A caption can be a whole paragraph with lots of technical details, and maybe a hyperlink to something external, such as \href{https://pretextbook.org}{\nolinkurl{pretextbook.org}} or \href{https://pretextbook.org}{PreTeXt}.  There could be some inline mathematics, such as \(x^2 + y^2 = c^2\).  Would a knowl open here?  Recursively?  Let's see: \hyperref[figure-long-caption]{{\xreffont\ref{figure-long-caption}}}.  Display mathematics, side-by-sides, theorems, and lots of other things should be banned.  Footnotes sound like a bad idea.  Strange characters should be fine: \textsection{}.}{figure-long-caption}{}%
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{Captionless Images}{}{Captionless Images}{}{}{captionless-images}
...
\includegraphics[width=\linewidth]{external/images/cross-square.png}
\end{image}%
\begin{paragraphs}{Testing (2019-06-02).}{captionless-images-14}%
...
\begin{image}{0}{1}{0}{}%
\href{https://pretextbook.org/examples/sample-article/html/generated/asymptote/asymptote-lever-solo.html}{\includegraphics[width=\linewidth]{generated/asymptote/asymptote-lever-solo.pdf}}
\end{image}%
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{Technical Details}{}{Technical Details}{}{}{section-graphics-14}
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{Accessibility}{}{Accessibility}{}{}{section-graphics-15}
...
\typeout{************************************************}
%
\begin{sectionptx}{Section}{Further Reading}{}{Further Reading}{}{}{section-further-reading}
%
%
\typeout{************************************************}
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{Specialized Subdivisions}{}{Specialized Subdivisions}{}{}{section-further-reading-2}
In a longer work you might wish to have some references on a per-chapter basis, or similar.  You can make a ``references'' subdivision anywhere to hold bibliographic items, and you can reference the items like any other item.  For example, we can cite the article below \hyperlink{biblio-beezer-fcla}{[{\xreffont 11.4.3},~Chapter R]}, included an indication that a specific chapter may be relevant.%
\end{subsectionptx}
%
%
\typeout{************************************************}
...
\typeout{************************************************}
%
\begin{exercises-subsection}{Exercises}{Exercises}{}{Exercises}{}{}{section-further-reading-3}
\begin{divisionexercise}{1}{}{}{exercises-null-problem}%
...
\par
N.B. An \mono{<exercisegroup>} is meant to hold a collection of (short) exercises with common, shared, instructions.  Do not use this structure to subdivide an \mono{<exercises>} division, as you will eventually be disappointed.  Instead, use the available, but under development as of 2019-11-02, \mono{<subexercises>}, which \emph{requires} a \mono{<title>}.%
\end{divisionexercise}%
\par\medskip\noindent%
\textbf{Two Derivative Problems.}\space\space\hypertarget{exercisegroup-two-problems}{}%
In the next two problems compute the indicated derivative.%
\begin{image}{0.35}{0.3}{0.35}{}%
\includegraphics[width=\linewidth]{external/images/cubic-function.png}
\end{image}%
You could ``connect'' the image above with the exercises following as part of this \mono{introduction} for the \mono{exercisegroup}.%
\begin{exercisegroup}
\index{exercise group!two derivatives}%
\begin{divisionexerciseeg}{2}{}{}{exercisegroup-two-problems-4}%
...
\par
We cross-reference the next problem in this exercise group.  For the \mono{phrase-global} form, the common element of the cross-reference and the target should be the \mono{exercises} division, and not the enclosing \mono{exercisegroup}:  \hyperlink{exercises-cosine-derivative}{Exercise~3 of Exercises~{\xreffont\ref{section-further-reading-3}}}.%
\end{divisionexerciseeg}%
\begin{divisionexerciseeg}{3}{}{}{exercises-cosine-derivative}%
\index{derivative!cosine}%
\(y = \cos(x)\), \(y^\prime\).%
\end{divisionexerciseeg}%
\end{exercisegroup}
\par\noindent%
...
\par\medskip\noindent
\begin{divisionexercise}{4}{}{}{section-further-reading-3-4}%
This isn't really an exercise, but an explanation that the next \mono{<exercisegroup>} has a title and no \mono{<introduction>}, which once resulted in some aberrant formatting in \LaTeX{} output.%
\end{divisionexercise}%
\par\medskip\noindent%
\textbf{Two More Derivative Problems.}\space\space\hypertarget{exercisegroup-two-more-problems}{}%
Some common instructions would go here in the \mono{<introduction>}%
\begin{exercisegroup}
\begin{divisionexerciseeg}{5}{}{}{exercisegroup-two-more-problems-3}%
\(f(x)=x^3\), \(\frac{df}{dx}\).  This sentence is just a bunch of gibberish to check where the second line of the problem begins relative to the first line.%
\par
We cross-reference the next problem in this exercise group.  For the \mono{phrase-global} form, the common element of the cross-reference and the target should be the \mono{exercises} division, and not the enclosing \mono{exercisegroup}:  \hyperlink{exercises-cosine-derivative}{Exercise~3 of Exercises~{\xreffont\ref{section-further-reading-3}}}.%
\end{divisionexerciseeg}%
\begin{divisionexerciseeg}{6}{}{}{exercisegroup-two-more-problems-4}%
\(y = \cos(x)\), \(y^\prime\).%
\end{divisionexerciseeg}%
\end{exercisegroup}
\par\medskip\noindent
\begin{divisionexercise}{7}{}{}{section-further-reading-3-6}%
Compute \(\int 3x^2\,dx\).%
\end{divisionexercise}%
\begin{divisionexercise}{8}{}{}{section-further-reading-3-7}%
One of the few things you can place inside of mathematics is a ``fill-in'' blank.\index{fill-in blank}  We demonstrate a few scenarios here.  See details on syntax in \hyperref[subsection-paragraph-markup]{Subsection~{\xreffont\ref{subsection-paragraph-markup}}}\textendash{}the use is identical within mathematics.%
\begin{itemize}[label=\textbullet]
\item{}Inside inline math (short, space for \(x\)): \(\sin(\fillinmath{x})\)%
\item{}Inside inline math (default, space for \(XXX\)): \(\sin(\fillinmath{XXX})\)%
\item{}Inside exponents and subscripts (each is space for the string ``12'').  In this case, be sure to wrap your exponents and subscripts in braces, as would be good \LaTeX{} practice anyway: \(x^{5+\fillinmath{12}}\,y_{\fillinmath{12}}\)%
\item{}Inside inline math (too long for this line probably, 40 characters long): \(\tan(\fillinmath{Mxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx})\)%
\item{}So use inside a displayed equation%
\begin{equation*}
16\log\space\fillinmath{1-x^2}
\end{equation*}
like this one.%
\item{}Inside the second line of a multi-line display:%
\begin{align*}
y &= x^7\,x^8\\
&= x^{\fillinmath{15}}
\end{align*}
%
\item{}This fillin has the historical \mono{@characters} attribute for a fillin inside math: \(1+\fillinmath{XXXXX}+4=10\), which may be more convenient, but may not side properly in places like subscripts, superscripts, fractions, limits of integrals, and so on.%
\end{itemize}
%
\end{divisionexercise}%
...
%
\typeout{************************************************}
\typeout{Exercises 11.3 More Exercises}
\typeout{************************************************}
%
\begin{exercises-subsection}{Exercises}{More Exercises}{}{More Exercises}{}{}{exercises-section-multiple}
\begin{divisionexercise}{1}{}{}{exercises-section-multiple-2}%
...
\begin{exercisegroup}
\begin{divisionexerciseeg}{2}{}{}{exercises-section-multiple-3-2}%
...
\begin{exercisegroup}
\begin{divisionexerciseeg}{3}{}{}{exercises-section-multiple-4-2}%
First exercise of second group.%
\end{divisionexerciseeg}%
\begin{divisionexerciseeg}{4}{}{}{exercises-section-multiple-4-3}%
...
\par\medskip\noindent%
\textbf{Exercise Group.}\space\space%
An \mono{<exercisegroup>} can have a \mono{cols} attribute taking a value from 2\textendash{}6. Exercises will progress by row, in so many columns. On a small screen, the HTML exercises may reorganize into fewer columns.%
\begin{exercisegroupcol}{4}
\begin{divisionexerciseegcol}{5}{}{}{exercises-section-multiple-5-2}%
\(1+2\)%
\end{divisionexerciseegcol}%
\begin{divisionexerciseegcol}{6}{}{}{exercises-section-multiple-5-3}%
\(3+4+5\)%
\par\smallskip%
\noindent\textbf{\blocktitlefont Hint}.\hypertarget{exercises-section-multiple-5-3-2}{}\quad{}Addition is associative.%
\par\smallskip%
\noindent\textbf{\blocktitlefont Answer}.\hypertarget{exercises-section-multiple-5-3-3}{}\quad{}\(12\)%
\par\smallskip%
\noindent\textbf{\blocktitlefont Solution}.\hypertarget{exercises-section-multiple-5-3-4}{}\quad{}First, add \(3\) and \(4\) to get \(7\), then add \(5\) to arrive at \(12\).%
\end{divisionexerciseegcol}%
\begin{divisionexerciseegcol}{7}{}{}{exercises-section-multiple-5-4}%
\(5+6\)%
\end{divisionexerciseegcol}%
\begin{divisionexerciseegcol}{8}{}{}{exercises-section-multiple-5-5}%
Add seven to eight.%
\par\smallskip%
\noindent\textbf{\blocktitlefont Answer}.\hypertarget{exercises-section-multiple-5-5-2}{}\quad{}\(15\)%
\end{divisionexerciseegcol}%
\begin{divisionexerciseegcol}{9}{}{}{exercises-section-multiple-5-6}%
\(9+10\)%
\end{divisionexerciseegcol}%
\begin{divisionexerciseegcol}{10}{}{}{exercises-section-multiple-5-7}%
\(1+2\)%
\end{divisionexerciseegcol}%
\begin{divisionexerciseegcol}{11}{}{}{exercises-section-multiple-5-8}%
\(3+4+5\)%
\par\smallskip%
\noindent\textbf{\blocktitlefont Hint}.\hypertarget{exercises-section-multiple-5-8-2}{}\quad{}Addition is associative.%
\par\smallskip%
\noindent\textbf{\blocktitlefont Answer}.\hypertarget{exercises-section-multiple-5-8-3}{}\quad{}\(12\)%
\par\smallskip%
\noindent\textbf{\blocktitlefont Solution}.\hypertarget{exercises-section-multiple-5-8-4}{}\quad{}First, add \(3\) and \(4\) to get \(7\), then add \(5\) to arrive at \(12\).%
\begin{solutionproof}{Proof}
A simple argument.%
\end{solutionproof}
And a bit more.%
\end{divisionexerciseegcol}%
\begin{divisionexerciseegcol}{12}{}{}{exercises-section-multiple-5-9}%
\(5+6\)%
\end{divisionexerciseegcol}%
\begin{divisionexerciseegcol}{13}{}{}{exercises-section-multiple-5-10}%
Add seven to eight.%
\par\smallskip%
\noindent\textbf{\blocktitlefont Answer}.\hypertarget{exercises-section-multiple-5-10-2}{}\quad{}\(15\)%
\end{divisionexerciseegcol}%
\begin{divisionexerciseegcol}{14}{}{}{exercises-section-multiple-5-11}%
\(9+10\)%
\end{divisionexerciseegcol}%
\begin{divisionexerciseegcol}{15}{}{}{exercises-section-multiple-5-12}%
\(1+2\)%
\end{divisionexerciseegcol}%
\begin{divisionexerciseegcol}{16}{}{}{exercises-section-multiple-5-13}%
\(3+4+5\)%
\par\smallskip%
\noindent\textbf{\blocktitlefont Hint}.\hypertarget{exercises-section-multiple-5-13-2}{}\quad{}Addition is associative.%
\par\smallskip%
\noindent\textbf{\blocktitlefont Answer}.\hypertarget{exercises-section-multiple-5-13-3}{}\quad{}\(12\)%
\par\smallskip%
\noindent\textbf{\blocktitlefont Solution}.\hypertarget{exercises-section-multiple-5-13-4}{}\quad{}First, add \(3\) and \(4\) to get \(7\), then add \(5\) to arrive at \(12\).%
\end{divisionexerciseegcol}%
\begin{divisionexerciseegcol}{17}{}{}{exercises-section-multiple-5-14}%
\(5+6\)%
\end{divisionexerciseegcol}%
\begin{divisionexerciseegcol}{18}{}{}{exercises-section-multiple-5-15}%
Add seven to eight.%
\par\smallskip%
\noindent\textbf{\blocktitlefont Answer}.\hypertarget{exercises-section-multiple-5-15-2}{}\quad{}\(15\)%
\end{divisionexerciseegcol}%
\begin{divisionexerciseegcol}{19}{}{}{exercises-section-multiple-5-16}%
\(9+10\)%
\end{divisionexerciseegcol}%
\begin{divisionexerciseegcol}{20}{}{}{exercises-section-multiple-5-17}%
\(1+2\)%
\end{divisionexerciseegcol}%
\begin{divisionexerciseegcol}{21}{}{}{exercises-section-multiple-5-18}%
\(3+4+5\)%
\par\smallskip%
\noindent\textbf{\blocktitlefont Hint}.\hypertarget{exercises-section-multiple-5-18-2}{}\quad{}Addition is associative.%
\par\smallskip%
\noindent\textbf{\blocktitlefont Answer}.\hypertarget{exercises-section-multiple-5-18-3}{}\quad{}\(12\)%
\par\smallskip%
\noindent\textbf{\blocktitlefont Solution}.\hypertarget{exercises-section-multiple-5-18-4}{}\quad{}First, add \(3\) and \(4\) to get \(7\), then add \(5\) to arrive at \(12\).%
\end{divisionexerciseegcol}%
\begin{divisionexerciseegcol}{22}{}{}{exercises-section-multiple-5-19}%
\(5+6\)%
\end{divisionexerciseegcol}%
\begin{divisionexerciseegcol}{23}{}{}{exercises-section-multiple-5-20}%
Add seven to eight.%
\par\smallskip%
\noindent\textbf{\blocktitlefont Answer}.\hypertarget{exercises-section-multiple-5-20-2}{}\quad{}\(15\)%
\end{divisionexerciseegcol}%
\begin{divisionexerciseegcol}{24}{}{}{exercises-section-multiple-5-21}%
\(9+10\)%
\end{divisionexerciseegcol}%
...
\par\medskip\noindent
\begin{divisionexercise}{25}{}{}{exercises-section-multiple-6}%
Make a table and a graph for the function \(f(x)=x^2\).%
\par\smallskip%
\noindent\textbf{\blocktitlefont Answer}.\hypertarget{exercises-section-multiple-6-2}{}\quad{}\begin{sidebyside}{2}{0}{0}{0}%
\begin{sbspanel}{0.5}%
\noindent\resizebox{\ifdim\width > \linewidth\linewidth\else\width\fi}{!}{%
{\centering%
{\tabularfont%
\begin{tabular}{cc}
{\bfseries{}\(x\)}&{\bfseries{}\(f(x)\)}\tabularnewline\hrulemedium
...
%
\typeout{************************************************}
\typeout{References 11.4 References}
\typeout{************************************************}
%
\begin{references-subsection}{References}{References}{}{References}{}{}{references-section}
\index{references!within a section}%
\begin{introduction}{}%
...
\bibitem[2]{CF}\hypertarget{CF}{}J. B. Conrey and D. W. Farmer, \textit{Mean values of \(L\)-functions and symmetry}, Internat. Math. Res. Notices no.\@\,17, (2000) pp.\@\,883-908.
\bibitem[3]{biblio-beezer-fcla}\hypertarget{biblio-beezer-fcla}{}Robert A. Beezer, \textit{A First Course in Linear Algebra}, 3rd Edition, Congruent Press, 2012. \par%
An online, open-source\footnote{A gratuitous footnote to test prior bug confusing this with a REMARK-LIKE \mono{<note>}.\label{biblio-beezer-fcla-2-1-1}} offering.%

\bibitem[4]{Dav}\hypertarget{Dav}{}H. Davenport, \textit{Multiplicative Number Theory}, GTM \textbf{74} Springer-Verlag New York, NY; (2000) xiv+177. [A note may accompany a bibliographic item, such as saying the manuscript is under review.  But it cannot contain any formatting.]
\bibitem[5]{biblio-rosswell-fictional}\hypertarget{biblio-rosswell-fictional}{}Alexander Rosswell, \textit{Diffeomorphisms of Penciled Fiber Bundles}, Mathematicians of America (2020), \textbf{2} no.\@\,6, 884\textendash{}888.
\bibitem[6]{biblio-rosswell-fictional-two}\hypertarget{biblio-rosswell-fictional-two}{}Ibid.\@, \textit{Diffeomorphisms of Penciled Fiber Bundles, Part 2}, Mathematicians of America (2021), \textbf{3} no.\@\,4, 102\textendash{}103.
\end{referencelist}
\begin{conclusion}{}%
This is a conclusion, which has not been used very much in this sample.  Did you see that the entry for \hyperlink{biblio-beezer-fcla}{[{\xreffont 11.4.3}]} has a short annotation?  So you can make annotated bibliographies easily.%
\end{conclusion}%
...
\typeout{************************************************}
%
\begin{sectionptx}{Section}{List Calisthenics}{}{List Calisthenics}{}{}{section-lists}
%
%
\typeout{************************************************}
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{Lists, Generally}{}{Lists, Generally}{}{}{section-lists-2}
\index{ordered list}%
\index{list!ordered}%
\index{unordered list}%
\index{list!unordered}%
Use \mono{ol} to make an ordered list,\index{ordered list} and \mono{ul} to make an unordered (bulleted) list. In both cases, use \mono{li} for each entry.  If an entry contains more than one paragraph, then each must be wrapped in \mono{p}. \index{unordered list}\index{list!ordered}\index{list!unordered}%
\par
This section contains nested lists, to demonstrate how they get assigned labels (numbering, symbols). But we begin with two simple lists, demonstrating an ordered list and an unordered list. See the end of section for an example of a description list. Note in the source the optional use of a paragraph (\mono{p}) for the list items of the list of colors.%
\par
%
\begin{enumerate}
\item{}First.%
\item{}Second\footnote{Footnote in an unstructured list item\label{section-lists-2-8-1-2-1}}.%
\item{}Third.%
\end{enumerate}
%
\begin{itemize}[label=\textbullet]
\item{}Red\footnote{One of our favorite colors\label{section-lists-2-8-2-1-1-1}}%
\item{}Green%
\item{}Yellow%
\item{}Purple%
\end{itemize}
%
\par
Next, we have a list with no customization and multiple levels to test the defaults.  \LaTeX{} allows a maximum of four levels of ordered\slash{}numbered lists, and a total of six levels if some unordered lists are mixed in.  Note that to have nested lists you \emph{must} structure your list items as paragraphs, since a list may only appear within a \mono{<p>} element.%
\begin{enumerate}
\item{}\lititle{A title on a top-level item.}\par%
Level 1, first.%
\item\hypertarget{list-two}{}Level 1, second.%
\begin{enumerate}
\item{}Level 2, first.%
\item{}Level 2, second.%
\begin{enumerate}
\item{}Level 3, first.%
\item\hypertarget{list-two-two-two}{}Level 3, second.%
\begin{enumerate}
\item{}Level 4, first.%
\item{}Level 4, second.%
\item\hypertarget{list-two-two-two-three}{}\lititle{Title on xref'ed list item.}\par%
Level 4, third.%
\end{enumerate}
%
\item{}Level 3, third.%
\end{enumerate}
%
\item{}\lititle{A title on a nested item.}\par%
Level 2, third.%
\end{enumerate}
%
\item{}Level 1, third.%
...
%
\par
Items in ordered lists (only) may be be give an \mono{xml:id} and then may be the target of an \mono{xref}.  We test three here, referencing down into the hierarchy above.  Level 1, second: \hyperlink{list-two}{{\xreffont 2}}.  Level 3, second: \hyperlink{list-two-two-two}{{\xreffont 2.b.ii}}.  Level 4, third: \hyperlink{list-two-two-two-three}{{\xreffont 2.b.ii.C}}.  Note that if a list item of an ordered list is contained within a list item of an unordered list, then its number will not be defined.%
\par
And now a four-level deep unordered list with the default labels supplied by PreTeXt (disc, circle, square, disc).  Again, the defalt order for Markdown\slash{}Jupyter (disc, square, circle, circle) is different than for \LaTeX{} and HTML (disc, circle, square, disc)%
\begin{itemize}[label=\textbullet]
\item{}\lititle{A title on a top-level item.}\par%
Level 1, first.%
\item{}Level 1, second.%
...
\begin{enumerate}
\item{}Level 1, first.%
\item\hypertarget{list-item-second}{}Level 1, second.%
\begin{itemize}[label=]
\item{}Level 2, first.%
\item{}Level 2, second.%
\end{itemize}
%
\item{}Level 1, third.  With a cross-reference to second list item, \hyperlink{list-item-second}{{\xreffont 2}}.%
\item{}Level 1, fourth.  Whose number should not change when the knowl just prior is opened.%
\end{enumerate}
%
\par
An ordered list may begin at zero by using a numeral zero in the \mono{@label} attribute, instead of numeral one.%
...
\begin{definition}{Definition}{Group.}{section-lists-2-18}%
\index{Group}%
\index{group!definition}\index{paragraph!initial list}%
\begin{enumerate}[label={\alph*)}]
\item{}There is a binary operation, denoted ``\(\cdot\)''.%
\item{}The operation is associative.%
\item{}There is an identity element, \(e\).%
\item{}For every element \(b\), there is an element \(c\) (the inverse), such that%
\begin{equation*}
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{List Spacing, I}{}{List Spacing, I}{}{}{section-lists-3}
...
\begin{enumerate}[label={(\alph*)}]
\item{}One item.%
\item{}\emph{Two} \alert{ducks}.%
\item{}Three items.  Plus a few more words to check that long entries in a two column list look good.%
\item{}Four items.%
\item{}Another long entry that simultaneously tests that long entries look good in a list, and also tests an odd number of entries in a two column list.%
\end{enumerate}
\end{multicols}
%
\end{subsectionptx}
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{List Spacing, II}{}{List Spacing, II}{}{}{section-lists-4}
...
%
\typeout{************************************************}
\typeout{Subsection 12.4 List items containing only inline math}
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{List items containing only inline math}{}{List items containing only inline math}{}{}{test-second}
\begin{assemblage}{Assemblage}{Testing list items containing only math.}{math-list-test}%
There are many places where it makes sense to have a list of mathematical terms, or possibly equations. For example, one might wish to provide a list of derivative formulas. With such lists, the author may wish to have display mathematics, but almost certainly they don't want it centered. One can work around this by using the \LaTeX{} \mono{\textbackslash{}displaystyle} command. However, it would be nice if a list item containing only math used display mode by default.%
\par
%
\begin{enumerate}
\item{}A list item containing some text in a paragraph, as well as some inline math: \(\int_a^b x^2\,dx = \frac{x^3}{3}\).%
\item{}A list item with text and math \(\int_a^b x^2\,dx\), not in a paragraph.%
\item{}\(\displaystyle \frac{d}{dx}\tan(x) = \sec^2(x) = \frac{1}{\cos^2(x)}\)%
\item{}\(\displaystyle \sum_{i=0}^n r^i = \frac{1-r^{n+1}}{1-r}\)%
\end{enumerate}
\index{\(\int f(x)\,dx\)}\index{math in lists \(\frac{d}{dx}(\sin(x))=\cos(x)\)}%
\par
Now, a \mono{p} that isn't in a list, followed by a list that's in a \mono{p}.%
\par
%
\begin{itemize}[label=\textbullet]
\item{}\(\sum_{n=1}^\infty\frac{1}{n^2}=\frac{\pi^2}{6}\) A list item starting with some math, followed by text, all in a \mono{p}%
\item{}\(\displaystyle \frac{a}{b}\div \frac{c}{d} = \frac{ad}{bc}\)%
\item{}\(\displaystyle \tan\theta = \frac{\sin\theta}{\cos\theta}\)%
\end{itemize}
%
\end{assemblage}
The above assemblage had some lists in it, just to see what will happen. While we're at it, we might try adding lists that are in a \mono{list}.%
\begin{listptx}{List}{\textbf{A list of items, some of which contain math}}{test-second-4}{}%
%
\begin{enumerate}
\item{}A first list item, containing some text. The next list item will contain only math, with the \mono{m} tag inline with the \mono{li} tag.%
\item{}A list item with text and math \(\int_a^b x^2\,dx\), not in a paragraph.%
\item{}\(\displaystyle \int_a^b f'(x)\, dx = f(b)-f(a)\)%
\item{}The next two list items will contain, respectively, a list item containing only math, where the math is on a new line, then the same again, but with two new lines, and a list item containing math within a \mono{p}, first inline, and then after a line break.%
...
%
\begin{itemize}[label=\textbullet]
\item{}A paragraph that begins with text, then some math: \(\sum_{n=1}^\infty\frac{1}{n^2}=\frac{\pi^2}{6}\) And now some more text. The next two list items contain:%
\begin{enumerate}
\item{}Math only, inline.%
\item{}Math only, with a newline.%
\item{}Math only, but in a paragraph. Also the next item on this list has math, just to see what happens in a nested list.%
\item{}\(\displaystyle \int_a^x \frac{d}{dt}f(t)\,dt = f(x)-f(a)\)%
\end{enumerate}
%
\item{}\(\displaystyle \frac{a}{b}\div \frac{c}{d} = \frac{ad}{bc}\)%
\item{}\(\displaystyle \tan\theta = \frac{\sin\theta}{\cos\theta}\)%
\item{}\(\displaystyle \frac{a}{b}\gt \sum_{i=3}^{76}\frac{x^2}{y^2}\)%
\end{itemize}
%
\par
...
%
\begin{itemize}[label=\textbullet]
\item{}\(\int_a^b \frac{\sin(x)}{x}\,dx\),%
\item{}\(\displaystyle \int_a^b \frac{\sin(x)}{x}\,dx\)%
\end{itemize}
%
\par
List items can have titles.  We try that here, along with testing list items structured with paragraphs.%
\begin{itemize}[label=\textbullet]
\item{}\lititle{With \mono{\textbackslash{}displaystyle} added automatically.}\par%
\(\displaystyle \sum_{n=1}^\infty ar^n\)%
\item{}\lititle{Two paragraphs.}\par%
\(\sum_{n=1}^\infty ar^n\)%
\par
\(\sum_{n=1}^\infty ar^n\)%
\item{}\lititle{One paragraph, extra text.}\par%
So, \(\sum_{n=1}^\infty ar^n\)%
\item{}\lititle{Two elements (only).}\par%
\LaTeX{}\(\sum_{n=1}^\infty ar^n\)%
\end{itemize}
%
\end{subsectionptx}
%
%
\typeout{************************************************}
\typeout{Subsection 12.5 Difficult List Items}
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{Difficult List Items}{}{Difficult List Items}{}{}{section-lists-6}
In \hyperref[test-second]{Subsection~{\xreffont\ref{test-second}}} we were careful about lone bits of math inside list items.  The \mono{<cd>} element is used with indentation, which is likely superfluous inside a list item that is already being indented.  Here we test lone \mono{<cd>} elements inside of list items in various configurations.%
\par
...
\end{codedisplayleft}
%
\item{}This list item is a long paragraph with a \mono{<cd>} in the middle which should be indented some to indicate its participation in the paragraph.%
\begin{codedisplay}
Foo Bar Foo
Bar
Bar Foo Bar
Foo
\end{codedisplay}
This list item is a long paragraph with a \mono{<cd>} in the middle which should be indented some to indicate its participation in the paragraph.%
\item{}%
\begin{codedisplayleft}
Foo Bar Foo
Bar
...
\begin{enumerate}
\item{}First item, outer level.%
\begin{enumerate}
\item{}%
\begin{codedisplayleft}
First inner item, cd only
Foo Bar Foo
Bar
Bar Foo Bar
Foo
\end{codedisplayleft}
%
\item{}Second inner item, a paragraph in a list item.%
\item{}%
\begin{codedisplayleft}
Third inner item, cd only
Foo Bar Foo
Foo Bar Foo
Bar Foo Bar
\end{codedisplayleft}
...
\item{}%
\begin{codedisplayleft}
cd inside second item, outer level
Bar
Bar Foo Bar
Foo
\end{codedisplayleft}
...
%
\typeout{************************************************}
\typeout{Subsection 12.6 Description Lists}
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{Description Lists}{}{Description Lists}{}{}{section-lists-7}
Use \mono{dl} to make a description list\index{description list}\index{list!description}. Inside of those tags, use \mono{li} for each entry. Then, use \mono{title} to specify the term being described and \mono{p} to specify the description.%
\par
A ``description'' list \index{description list}\index{list!description} has a short term or phrase that is prominent, followed by a short description.  It is modeled on the lists of similar structure in both \LaTeX{} and HTML.  It makes for a nice medium-weight way to define terms, somewhere in-between the \mono{term} tag which just makes a term prominent in a sentence, and a \mono{definition}, which is set off, has a heading, a number, and a title.  Do not try to manage the separation between the title and the description by employing punctuation (but you can include a question-mark or exclamation-point if necessary).  For example, do not include a colon to the end of the title.  This example is from Bob Plantz.%
\begin{descriptionlist}
\begin{dlimedium}{Central Processing Unit (CPU)}{cpu-definition}%
...
\end{dlimedium}%
\begin{dlimedium}{Memory}{section-lists-7-3-7-2}%
Provides storage for the instructions for the CPU and the data they manipulate.%
\end{dlimedium}%
\begin{dlimedium}{Input\slash{}Output (I\slash{}O)}{section-lists-7-3-7-3}%
Communicates with the outside world and with mass storage devices (e.g.\@, disks).%
\end{dlimedium}%
\begin{dlimedium}{Bus!}{bus-definition}%
A communication pathway with a protocol specifying exactly how the pathway is used. (The punctuation is just for testing.)%
\end{dlimedium}%
\begin{dlimedium}{\(\displaystyle \sum_{n=0}^\infty x^n = \frac{1}{1-x}\)}{section-lists-7-3-7-5}%
A geometric series.  The formula is valid if \(|x| < 1\).%
\end{dlimedium}%
\end{descriptionlist}
%
\par
Some presentations can be assisted by a hint from the author about the lengths of the titles.  You can choose to provide a \mono{width} attribute on a \mono{dl} element with possible values \mono{narrow} and \mono{medium}. The value refers (somewhat confusingly) to the distance between the left margin and the description.  The default is \mono{medium}, which is illustrated above. Conversion to \LaTeX{} ignores the attribute.  An example with \mono{narrow}:%
\begin{descriptionlist}
\begin{dlinarrow}{Red}{section-lists-7-4-8-1}%
The color of the sun at sunset.%
\end{dlinarrow}%
\begin{dlinarrow}{Blue}{section-lists-7-4-8-2}%
...
\end{dlinarrow}%
\begin{dlinarrow}{Aqua}{section-lists-7-4-8-3}%
The color of shallow tropical waters.\footnotemark{}%
\end{dlinarrow}%
\footnotetext[3]{On a sunny day! (Testing footnotes in description lists for \LaTeX{} output.)\label{section-lists-7-4-8-3-2-1}}%
\begin{dlinarrow}{Math \(x^2\)}{description-list-math-title}%
Sorry, not a color but testing titles with math in them.%
\end{dlinarrow}%
\begin{dlinarrow}{``i'' before ``e'' except after ``c,'' unless it sounds like ``a'' as in ``neighbor'' and ``weigh''}{section-lists-7-4-8-5}%
Get feisty about that weird counterfeit rule: seize the day and don't have a heifer, man.%
\end{dlinarrow}%
\begin{dlinarrow}{Avocado}{section-lists-7-4-8-6}%
Avocado is the the color with hex code \mono{\#568203}, and also the main ingredient in guacamole.%
\end{dlinarrow}%
\begin{dlinarrow}{Magenta}{section-lists-7-4-8-7}%
Magenta is a color, and a character in Rocky Horror.%
\end{dlinarrow}%
\begin{dlinarrow}{Zymurgist}{section-lists-7-4-8-8}%
...
\end{dlinarrow}%
\begin{dlinarrow}{Byzantium}{section-lists-7-4-8-9}%
Byzantium is the the color with hex code \mono{\#702963}, and also an ancient Greek city which later became known as Constantinople, and today is called Istanbul.%
\end{dlinarrow}%
\begin{dlinarrow}{Convection}{section-lists-7-4-8-10}%
Circulating motion in a fluid.%
\end{dlinarrow}%
\begin{dlinarrow}{Elementary}{section-lists-7-4-8-11}%
No literary detective ever said ``Elementary my dear Watson.''  In particular, Sherlock Holmes never said that.%
\end{dlinarrow}%
\begin{dlinarrow}{Understand}{section-lists-7-4-8-12}%
Perceive the intended meaning of.%
\end{dlinarrow}%
\begin{dlinarrow}{Washington}{section-lists-7-4-8-13}%
A state, a district, the man on the US \textdollar{}1 bill and on the US quarter. Did you ever notice that on the US dime, the value is stated as ``one dime''? But how is one to know that a dime is worth 10 cents?%
\end{dlinarrow}%
\begin{dlinarrow}{Aquamarine}{section-lists-7-4-8-14}%
Aquamarine is a color, and a mineral.%
\end{dlinarrow}%
\begin{dlinarrow}{Those who cannot remember the past are condemned to repeat it.}{section-lists-7-4-8-15}%
...
\end{dlinarrow}%
\begin{dlinarrow}{\(\displaystyle \zeta(s) = \sum_{n=1}^\infty n^{-s} \)}{section-lists-7-4-8-16}%
The Riemann \(\zeta\)-function is defined by a Dirichlet series, valid for \(\Re(s) > 1\).%
\end{dlinarrow}%
\begin{dlinarrow}{\mono{main()} is a void function}{section-lists-7-4-8-17}%
A \mono{dl} with \mono{width=\textquotedbl{}narrow\textquotedbl{}} might be a useful way to give commentary on a program listing.%
\end{dlinarrow}%
\end{descriptionlist}
%
\par
...
\begin{descriptionlist}
\begin{dlimedium}{Expanded CPU}{cpu-definition-expanded}%
Controls most of the activities of the computer, performs the arithmetic and logical operations, and contains a small amount of very fast memory.%
\begin{descriptionlist}
\begin{dlimedium}{Arithmetic}{cpu-definition-expanded-2-1-1}%
The kind of computations that give a computer the name ``computer.''%
\end{dlimedium}%
\begin{dlimedium}{Logic}{cpu-definition-expanded-2-1-2}%
Operations that make decisions, ``if this, then that'', plus: and, or, and not.%
\end{dlimedium}%
\begin{dlimedium}{Memory}{cpu-definition-expanded-2-1-3}%
...
This is a second paragraph that should appear indented in PDF output.%
\end{dlimedium}%
\begin{dlimedium}{Memory}{section-lists-7-5-1-2}%
Provides storage for the instructions for the CPU and the data they manipulate.%
\end{dlimedium}%
\begin{dlimedium}{Input\slash{}Output (I\slash{}O)}{section-lists-7-5-1-3}%
Communicates with the outside world and with mass storage devices (e.g.\@, disks).%
\end{dlimedium}%
\begin{dlimedium}{Bus!}{section-lists-7-5-1-4}%
A communication pathway with a protocol specifying exactly how the pathway is used. (The punctuation is just for testing.)%
\end{dlimedium}%
\begin{dlimedium}{\(\displaystyle \sum_{n=0}^\infty x^n = \frac{1}{1-x}\)}{section-lists-7-5-1-5}%
A geometric series.  The formula is valid if \(|x| < 1\).%
\end{dlimedium}%
\end{descriptionlist}
%
...
%
\typeout{************************************************}
\typeout{Subsection 12.7 Named Lists}
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{Named Lists}{}{Named Lists}{}{}{section-lists-8}
\index{named list}%
\index{list!named}%
A list can be wrapped with a \mono{<list>} element, so that it earns a number, can be given a title and have an introduction and conclusion.  Cross-references to individual list items get a bit involved as they are prefixed with the number of the list and then the number of the item, so conceivably you could get a number like \mono{4.5.3:2.a.ii}.  The colon is used to indicate the transition from the number of the list within divisions and the numbers coming from the list hierarchy, since it has two small dots.%
\begin{listptx}{List}{\textbf{Colors of the Rainbow}}{list-colors-rainbow}{}%
...
\begin{enumerate}
\item{}Red%
\item\hypertarget{rainbow-orange}{}Orange%
\item{}Yellow%
\item{}Green%
\item{}Blue%
\item{}Indigo%
...
\end{listptx}%
This next list is used for testing cross-references to it.  See \hyperref[section-cross-referencing]{Section~{\xreffont\ref{section-cross-referencing}}}.%
\begin{listptx}{List}{\textbf{A named list of targets}}{list-to-reference}{}%
This is the introduction to this named list, which references an item within, via the hybrid \mono{@text} attribute:  \hyperlink{target-item}{Item~B.c}.  At one time this paragraph was inadvertently centered\textemdash{}that bug has been fixed.%
%
\begin{enumerate}[label={\Alph*}]
\item{}%
\begin{enumerate}[label={\roman*}]
...
\item{}B and a%
\item{}B and b%
\item\hypertarget{target-item}{}B and c (target of some cross-references)%
\end{enumerate}
%
\item{}%
\begin{itemize}[label=\textbullet]
\item{}The next three cross-references point to a list item, just above.  It is interesting because the list is named, hence numbered.  The global reference uses the full number, while the local reference uses the number from within the list.  The hybrid reference recognizes that the target is within the same named list, so the number can be shorter.  An identical hybrid cross-reference appears within the \mono{<introduction>} to this list, an immediately following, but outside the \mono{<list>}.%
\item{}Cross-reference within named list (\mono{global}): \hyperlink{target-item}{Item~{\xreffont 12.4:B.c}}%
\item{}Cross-reference within named list (\mono{hybrid}): \hyperlink{target-item}{Item~B.c}%
\item{}Cross-reference within named list (\mono{local}): \hyperlink{target-item}{Item~B.c}%
\item{}%
\begin{enumerate}[label={\arabic*}]
\item{}C and bullet and 1%
\item\hypertarget{target-no-number}{}C and bullet and 2%
\item{}C and bullet and 3%
\end{enumerate}
%
\item{}C and bullet%
\item{}C and bullet%
...
\end{enumerate}
\end{listptx}%
This is a paragraph just outside the preceding named list, which references an item within, via the hybrid \mono{@text} attribute:  \hyperlink{target-item}{Item~{\xreffont 12.4:B.c}}.%
\par
\index{list}This is a paragraph with three lists contained within it.  For HTML output we have to ``inside-out'' the lists.%
\begin{enumerate}
\item{}A one item ordered list.%
\end{enumerate}
In other words, the text before, after, and between, needs to each be encapsulated as an HTML \mono{p} element of its own.%
\begin{itemize}[label=\textbullet]
\item{}A one item unordered list.%
\end{itemize}
Including definition lists.%
\begin{descriptionlist}
\begin{dlimedium}{Define Me}{section-lists-8-9-6-1}%
...
%
\typeout{************************************************}
\typeout{Subsection 12.8 Testing List Decompositions}
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{Testing List Decompositions}{}{Testing List Decompositions}{}{}{section-lists-9}
...
%
\begin{enumerate}
\item{}This paragraph opens with an ordered list.%
\item{}Testing the id, and other info that should be at the top of the paragraph.%
\end{enumerate}
...
%
\typeout{************************************************}
\typeout{Subsection 12.9 List Column Testing}
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{List Column Testing}{}{List Column Testing}{}{}{section-lists-10}
...
\item{}%
\begin{alignat*}{5}
3u \amp {}+{} 1v \amp {}+{} 3w \amp {}+{} 2x \amp {}+{} \amp  y \amp {}+{} \amp 3z \amp {}={} \amp 10\\
2u \amp {}+{} 2v \amp {}-{} 2w \amp {}+{} x  \amp       \amp    \amp {}+{} \amp  z \amp {}={} \amp 6\\
1u \amp {}-{} 3v \amp {}+{} 1w \amp {}+{} x  \amp {}+{} \amp 3y \amp {}+{} \amp 2z \amp {}={} \amp 13
\end{alignat*}
%
\item{}Short item.%
\item{}A long item that can be wrapped over multiple lines.%
\item{}Four items.%
\item{}%
\item{}Another long entry that simultaneously tests that long entries look good in a list, and also tests an odd number of entries in a two column list.%
\end{enumerate}
...
%
\typeout{************************************************}
\typeout{Exercises 12.10 Exercises (with lists)}
\typeout{************************************************}
%
\begin{exercises-subsection}{Exercises}{Exercises (with lists)}{}{Exercises (with lists)}{}{}{section-lists-11}
\begin{divisionexercise}{1}{}{}{section-lists-11-2}%
...
\begin{enumerate}[label={(\alph*)}]
\item{}Exercise 1, first part.%
\item{}Exercise 1, second part.%
\begin{enumerate}[label={\roman*.}]
\item\hypertarget{exercise-one-two-one}{}Exercise 1, second part, first refinement.%
\end{enumerate}
%
\item\hypertarget{exercise-one-three}{}Exercise 1, third part.%
\end{enumerate}
%
\end{divisionexercise}%
\begin{divisionexercise}{2}{}{}{section-lists-11-3}%
\begin{tableptx}{Table}{\textbf{Table Alignment Example}}{section-lists-11-3-1-1}{}%
\centering%
{\tabularfont%
...
\end{tableptx}%
This exercise (a list item really) has a \mono{table} first.  Default \LaTeX{} aligns it vertically above the exercise number.  Placement here tests correcting that alignment.%
\end{divisionexercise}%
\begin{conclusion}{}%
A small test of cross-references to subsidiary parts of exercises.  Exercise 1, third part: \hyperlink{exercise-one-three}{{\xreffont 12.10.1.c}}.  Exercise 1, second part, first refinement: \hyperlink{exercise-one-two-one}{{\xreffont 12.10.1.b.i}}.%
\end{conclusion}%
\end{exercises-subsection}
%
%
\typeout{************************************************}
\typeout{References 12.11 References (with lists in Annotations)}
\typeout{************************************************}
%
\begin{references-subsection}{References}{References (with lists in Annotations)}{}{References (with lists in Annotations)}{}{}{section-lists-12}
%% If this is a top-level references
%%   you can replace the "referencelist" environment
%%   with a standard "thebibliography" environment
\begin{referencelist}
\bibitem[1]{biblio-undetermined}\hypertarget{biblio-undetermined}{}Some book would be listed here. \par%
Here is the annotation and an ordered list as part of that annotation.%
\begin{enumerate}[label={(\alph*)}]
\item{}Book 1, first part.%
\item{}Book 1, second part.%
\item{}Book 1, third part.%
\end{enumerate}
%
...
\typeout{************************************************}
%
\begin{sectionptx}{Section}{Table Calisthenics}{}{Table Calisthenics}{}{}{section-table-calisthenics}
\begin{sageinput}
c = 832
c
\end{sageinput}
...
Note that tables may be constructed using the \href{http://www.latex-tables.com/}{\LaTeX{} Complex Table Editor} tool online at \mono{latex-tables.com}and then exported in PreTeXt syntax.%
\par
...
\end{enumerate}
%
\begin{example}{Example}{Example Environment with Leading Table.}{section-table-calisthenics-21}%
...
2&\multicolumn{1}{lB}{\href{http://example.com/09az\%58-._\~:/?\#[]@!$\&'()*+,;=}{e.com\slash{}09az\%58-.\textunderscore{}\textasciitilde{}:\slash{}?\#[]@!\textdollar{}\&'()\textasteriskcentered{}+,;=}}&\href{http://example.com/09az\%58-._\~:/?\#[]@!$\&'()*+,;=}{e.com\slash{}09az\%58-.\textunderscore{}\textasciitilde{}:\slash{}?\#[]@!\textdollar{}\&'()\textasteriskcentered{}+,;=}\tabularnewline\hrulemedium
...
\typeout{************************************************}
%
\begin{sectionptx}{Section}{Interactive Elements, Authored in Javascript}{}{Interactive Elements, Authored}{}{}{section-interactive-authored}
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{HTML5 Canvas}{}{HTML5 Canvas}{}{}{interactive-html5-canvas}
...
\par
The following examples are from David Austin's excellent \href{http://merganser.math.gvsu.edu/david/linear.algebra/ula/index.html}{\pubtitle{Understanding Linear Algebra}} textbook, which can be found at%
\begin{codedisplay}
...
\begin{sbspanel}{0.47}%
\noindent\includegraphics[width=\linewidth]{external/preview/simple-eigenvector-preview.jpg}
\end{sbspanel}%
\begin{sbspanel}{0.21}%
\noindent\includegraphics[width=\linewidth]{generated/qrcode/interactive-simple-eigenvector.png}
...
\tcblower
\end{figureptx}%
\begin{inlineexercise}{Checkpoint}{}{interactive-html5-canvas-5}%
...
\begin{sidebyside}{2}{0.075}{0.075}{0.17}%
\begin{sbspanel}{0.47}%
\noindent\includegraphics[width=\linewidth]{external/preview/eigenvectors-preview.jpg}
\end{sbspanel}%
\begin{sbspanel}{0.21}%
\noindent\includegraphics[width=\linewidth]{generated/qrcode/interactive-eigenvectors.png}
...
\begin{sidebyside}{2}{0.075}{0.075}{0.17}%
\begin{sbspanel}{0.47}%
\noindent\includegraphics[width=\linewidth]{external/preview/animation-preview.jpg}
\end{sbspanel}%
\begin{sbspanel}{0.21}%
\noindent\includegraphics[width=\linewidth]{generated/qrcode/interactive-animation.png}
...
\tcblower
\end{figureptx}%
\begin{warning}{Warning}{}{interactive-html5-canvas-9}%
...
\begin{sidebyside}{2}{0.075}{0.075}{0.17}%
\begin{sbspanel}{0.47}%
\noindent\includegraphics[width=\linewidth]{generated/preview/interactive-simple-js-script-preview.png}
\end{sbspanel}%
\begin{sbspanel}{0.21}%
\noindent\includegraphics[width=\linewidth]{generated/qrcode/interactive-simple-js-script.png}
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{D3.js}{}{D3.js}{}{}{section-interactive-authored-8}
\index{D3.js}%
...
\par
This is adapted from a \href{https://bl.ocks.org/mbostock/3231298}{block} by \href{https://bl.ocks.org/mbostock}{Mike Bostock} with a \initialism{GPL} license.  A similar demonstration, only using an \initialism{HTML5} canvas is at \href{https://bl.ocks.org/mbostock/3231307}{\nolinkurl{bl.ocks.org/mbostock/3231307}}.%
\begin{figureptx}{Figure}{Force layout and collision detection}{section-interactive-authored-8-6}{}%
\begin{sidebyside}{2}{0.075}{0.075}{0.17}%
\begin{sbspanel}{0.47}%
\noindent\includegraphics[width=\linewidth]{external/preview/collision-preview.png}
\end{sbspanel}%
\begin{sbspanel}{0.21}%
\noindent\includegraphics[width=\linewidth]{generated/qrcode/interactive-d3-collision.png}
...
%
\par
This is adapted from a \href{https://bl.ocks.org/shimizu/e6209de87cdddde38dadbb746feaf3a3}{block} by \href{https://bl.ocks.org/shimizu}{shimizu} with a \initialism{GPL} license.%
\begin{figureptx}{Figure}{Graph Layout}{section-interactive-authored-8-9}{}%
\begin{sidebyside}{2}{0.075}{0.075}{0.17}%
\begin{sbspanel}{0.47}%
\noindent\includegraphics[width=\linewidth]{external/preview/graph-layout-preview.png}
\end{sbspanel}%
\begin{sbspanel}{0.21}%
\noindent\includegraphics[width=\linewidth]{generated/qrcode/interactive-d3-graph-layout.png}
...
\tcblower
\end{figureptx}%
\begin{inlineexercise}{Checkpoint}{Graph Planarity.}{section-interactive-authored-8-10}%
Can you move the vertices to new locations such that the resulting graph is planar?  (In other words, no edges cross?)%
\end{inlineexercise}%
Finally an example that actually uses some data.  Here is the description from the \href{https://bl.ocks.org/martinjc/7aa53c7bf3e411238ac8aef280bd6581}{original block} by \href{https://bl.ocks.org/martinjc}{Martin Chorley} with an MIT License.%
\begin{quote}%
...
\begin{sidebyside}{2}{0.075}{0.075}{0.17}%
\begin{sbspanel}{0.47}%
\noindent\includegraphics[width=\linewidth]{external/preview/welsh-assembly-preview.png}
\end{sbspanel}%
\begin{sbspanel}{0.21}%
\noindent\includegraphics[width=\linewidth]{generated/qrcode/interactive-d3-welsh.png}
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{SVG}{}{SVG}{}{}{svg-interactives}
...
\begin{sidebyside}{2}{0.075}{0.075}{0.17}%
\begin{sbspanel}{0.47}%
\noindent\includegraphics[width=\linewidth]{generated/preview/interactive-slopes-preview.png}
\end{sbspanel}%
\begin{sbspanel}{0.21}%
\noindent\includegraphics[width=\linewidth]{generated/qrcode/interactive-slopes.png}
...
\tcblower
\end{figureptx}%
\begin{inlineexercise}{Checkpoint}{Changing Secant Lines.}{svg-interactives-5}%
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{JSXGraph}{}{JSXGraph}{}{}{section-interactive-authored-10}
\index{JSXGraph}%
...
\begin{sidebyside}{2}{0.075}{0.075}{0.17}%
\begin{sbspanel}{0.47}%
\noindent\includegraphics[width=\linewidth]{generated/preview/interactive-archimedian-spiral-preview.png}
\end{sbspanel}%
\begin{sbspanel}{0.21}%
\noindent\includegraphics[width=\linewidth]{generated/qrcode/interactive-archimedian-spiral.png}
...
\tcblower
\end{figureptx}%
Here is a more elaborate example, from the \href{http://jsxgraph.uni-bayreuth.de/showcase/}{JSXGraph Showcase}, titled \href{http://jsxgraph.uni-bayreuth.de/showcase/infinity.html}{Infinity}.%
\par
...
\begin{sidebyside}{2}{0.075}{0.075}{0.17}%
\begin{sbspanel}{0.47}%
\noindent\includegraphics[width=\linewidth]{generated/preview/interactive-infinity-preview.png}
\end{sbspanel}%
\begin{sbspanel}{0.21}%
\noindent\includegraphics[width=\linewidth]{generated/qrcode/interactive-infinity.png}
...
\begin{sidebyside}{2}{0.075}{0.075}{0.17}%
\begin{sbspanel}{0.47}%
\noindent\includegraphics[width=\linewidth]{generated/preview/interactive-piecewise-preview.png}
\end{sbspanel}%
\begin{sbspanel}{0.21}%
\noindent\includegraphics[width=\linewidth]{generated/qrcode/interactive-piecewise.png}
...
\begin{sidebyside}{2}{0.075}{0.075}{0.17}%
\begin{sbspanel}{0.47}%
\noindent\includegraphics[width=\linewidth]{generated/preview/interactive-quadratic-tangent-preview.png}
\end{sbspanel}%
\begin{sbspanel}{0.21}%
\noindent\includegraphics[width=\linewidth]{generated/qrcode/interactive-quadratic-tangent.png}
...
\begin{sidebyside}{2}{0.075}{0.075}{0.17}%
\begin{sbspanel}{0.47}%
\noindent\includegraphics[width=\linewidth]{generated/preview/interactive-oscillating-secant-preview.png}
\end{sbspanel}%
\begin{sbspanel}{0.21}%
\noindent\includegraphics[width=\linewidth]{generated/qrcode/interactive-oscillating-secant.png}
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{Sage Interacts}{}{Sage Interacts}{}{}{section-interactive-authored-12}
...
\par
This example is by Marshall Hampton, taken from the \href{https://wiki.sagemath.org/interact/calculus}{Sage interact wiki}, specifically \href{https://wiki.sagemath.org/interact/calculus\#Numerical_integrals_with_the_midpoint_rule}{Numerical integrals with the midpoint rule}.%
\par
...
\begin{sidebyside}{2}{0.075}{0.075}{0.17}%
\begin{sbspanel}{0.47}%
\noindent\includegraphics[width=\linewidth]{generated/preview/interactive-numerical-integral-preview.png}
\end{sbspanel}%
\begin{sbspanel}{0.21}%
\noindent\includegraphics[width=\linewidth]{generated/qrcode/interactive-numerical-integral.png}
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{Geogebra}{}{Geogebra}{}{}{section-interactive-authored-13}
...
\begin{sidebyside}{2}{0.075}{0.075}{0.17}%
\begin{sbspanel}{0.47}%
\noindent\includegraphics[width=\linewidth]{generated/preview/geogebra-astroid-original-preview.png}
\end{sbspanel}%
\begin{sbspanel}{0.21}%
\noindent\includegraphics[width=\linewidth]{generated/qrcode/geogebra-astroid-original.png}
...
\begin{sidebyside}{2}{0.075}{0.075}{0.17}%
\begin{sbspanel}{0.47}%
\noindent\includegraphics[width=\linewidth]{generated/preview/geogebra-astroid-preview.png}
\end{sbspanel}%
\begin{sbspanel}{0.21}%
\noindent\includegraphics[width=\linewidth]{generated/qrcode/geogebra-astroid.png}
...
\begin{sidebyside}{2}{0.075}{0.075}{0.17}%
\begin{sbspanel}{0.47}%
\noindent\includegraphics[width=\linewidth]{generated/preview/geogebra-cycloid-preview.png}
\end{sbspanel}%
\begin{sbspanel}{0.21}%
\noindent\includegraphics[width=\linewidth]{generated/qrcode/geogebra-cycloid.png}
...
\begin{sidebyside}{2}{0.075}{0.075}{0.17}%
\begin{sbspanel}{0.47}%
\noindent\includegraphics[width=\linewidth]{generated/preview/geogebra-SAS-preview.png}
\end{sbspanel}%
\begin{sbspanel}{0.21}%
\noindent\includegraphics[width=\linewidth]{generated/qrcode/geogebra-SAS.png}
...
\begin{sidebyside}{2}{0.075}{0.075}{0.17}%
\begin{sbspanel}{0.47}%
\noindent\includegraphics[width=\linewidth]{generated/preview/ggb_3d-direction-vector_interactive-preview.png}
\end{sbspanel}%
\begin{sbspanel}{0.21}%
\noindent\includegraphics[width=\linewidth]{generated/qrcode/ggb_3d-direction-vector_interactive.png}
...
\begin{sidebyside}{2}{0.075}{0.075}{0.17}%
\begin{sbspanel}{0.47}%
\noindent\includegraphics[width=\linewidth]{generated/preview/geogebra-seed-head-preview.png}
\end{sbspanel}%
\begin{sbspanel}{0.21}%
\noindent\includegraphics[width=\linewidth]{generated/qrcode/geogebra-seed-head.png}
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{CircuitJS}{}{CircuitJS}{}{}{section-interactive-authored-14}
\href{https://www.falstad.com/circuit/}{CircuitJS} is an electronic circuit simulator.  A circuit can be described by a language, which PreTeXt will interpret and submit for rendering.  The next two examples are identical, but provided in slightly different ways, see the PreTeXt source for more.  Preview images for PDF will be added later.%
\begin{figureptx}{Figure}{CircuitJS Example (source via an encoded attribute)}{figure-circuitjs-attribute}{}%
\begin{sidebyside}{2}{0.075}{0.075}{0.17}%
\begin{sbspanel}{0.47}%
\noindent\includegraphics[width=\linewidth]{generated/preview/interactive-circuitjs-attribute-preview.png}
\end{sbspanel}%
\begin{sbspanel}{0.21}%
\noindent\includegraphics[width=\linewidth]{generated/qrcode/interactive-circuitjs-attribute.png}
...
\begin{sidebyside}{2}{0.075}{0.075}{0.17}%
\begin{sbspanel}{0.47}%
\noindent\includegraphics[width=\linewidth]{generated/preview/interactive-circuitjs-preview.png}
\end{sbspanel}%
\begin{sbspanel}{0.21}%
\noindent\includegraphics[width=\linewidth]{generated/qrcode/interactive-circuitjs.png}
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{IFrames from Files}{}{IFrames from Files}{}{}{interactive-iframes-local}
...
\begin{sidebyside}{2}{0.075}{0.075}{0.17}%
\begin{sbspanel}{0.47}%
\noindent\includegraphics[width=\linewidth]{generated/preview/interactive-sage-jupyter-iframe-preview.png}
\end{sbspanel}%
\begin{sbspanel}{0.21}%
\noindent\includegraphics[width=\linewidth]{generated/qrcode/interactive-sage-jupyter-iframe.png}
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{threejs}{}{threejs}{}{}{interactive-threejs}
Once upon a time there was an example here using the \mono{threejs} 3D Javascript library.  It was \href{https://threejs.org/examples/\#webgl_geometry_extrude_splines}{one of the project's examples}, licensed with an MIT License, with minimal modifications.%
\par
...
\begin{sidebyside}{2}{0.075}{0.075}{0.17}%
\begin{sbspanel}{0.47}%
\noindent\includegraphics[width=\linewidth]{generated/preview/interactive-threejs-catenoid-surface-preview.png}
\end{sbspanel}%
\begin{sbspanel}{0.21}%
\noindent\includegraphics[width=\linewidth]{generated/qrcode/interactive-threejs-catenoid-surface.png}
...
\begin{sidebyside}{2}{0.075}{0.075}{0.17}%
\begin{sbspanel}{0.47}%
\noindent\includegraphics[width=\linewidth]{generated/preview/interactive-threejs-saddle-preview.png}
\end{sbspanel}%
\begin{sbspanel}{0.21}%
\noindent\includegraphics[width=\linewidth]{generated/qrcode/interactive-threejs-saddle.png}
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{DoenetML}{}{DoenetML}{}{}{interactive-doenetml}
\href{https://doenet.org}{DoenetML} is a markup language inspired by PreTeXt for semantically describing interactive mathematics applets for the web. Use \mono{interactive[@platform=\textquotedbl{}doenetml\textquotedbl{}]} with a \mono{slate[@surface=\textquotedbl{}doenetml\textquotedbl{}]} to include DoenetML content within your document.%
\par
Since DoenetML is similar to, but not completely compatible with, XML, it cannot be authored directly within a PreTeXt document without painstakingly escaping every \mono{<} as \mono{\&lt;} and every \mono{\&} as \mono{\&amp;}. However, a convenient workflow to avoid this is to author your DoenetML in a separate file like \mono{example.doenetml}, then include this file within your PreTeXt document using \mono{<xi:include parse=\textquotedbl{}text\textquotedbl{} href=\textquotedbl{}path/to/example.doenetml\textquotedbl{}/>}. Altenatively, you can enclose your DoenetML in a \mono{CDATA}, as we do below.%
\begin{figureptx}{Figure}{DoenetML example}{figure-doenetml}{}%
\begin{sidebyside}{2}{0.075}{0.075}{0.17}%
\begin{sbspanel}{0.47}%
\noindent\includegraphics[width=\linewidth]{generated/preview/interactive-doenetml-example-preview.png}
\end{sbspanel}%
\begin{sbspanel}{0.21}%
\noindent\includegraphics[width=\linewidth]{generated/qrcode/interactive-doenetml-example.png}
...
\typeout{************************************************}
%
\begin{sectionptx}{Section}{Interactive Elements, Server}{}{Interactive Elements, Server}{}{}{section-interactive-server}
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{GeoGebra}{}{GeoGebra}{}{}{subsection-geogebra-server}
...
\begin{sidebyside}{2}{0.075}{0.075}{0.17}%
\begin{sbspanel}{0.47}%
\noindent\includegraphics[width=\linewidth]{generated/preview/geogebra-right-triangle-preview.png}
\end{sbspanel}%
\begin{sbspanel}{0.21}%
\noindent\includegraphics[width=\linewidth]{generated/qrcode/geogebra-right-triangle.png}
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{Desmos Graphs}{}{Desmos Graphs}{}{}{section-interactive-server-6}
\index{Desmos graphs}%
...
\begin{sidebyside}{2}{0.075}{0.075}{0.17}%
\begin{sbspanel}{0.47}%
\noindent\includegraphics[width=\linewidth]{generated/preview/desmos-natural-log-preview.png}
\end{sbspanel}%
\begin{sbspanel}{0.21}%
\noindent\includegraphics[width=\linewidth]{generated/qrcode/desmos-natural-log.png}
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{CalcPlot3D}{}{CalcPlot3D}{}{}{section-interactive-server-7}
\index{CalcPlot3D}%
...
\par
To use it, start at the \href{https://c3d.libretexts.org/CalcPlot3D/index.html}{online app version}.  Create a plot and adjust the image to a viewpoint and scale if you like.  Then, click the menu\slash{}hamburger icon in the upper-left and choose \mono{File}.  From here you can save a \initialism{PNG} image for the static version, but you also want to select \mono{Encode View in URL}.  Now your browser address bar is filled with a query string (\emph{all} the stuff \emph{after} the question-mark) that has all the information necessary to reproduce your plot (and view).  Copy everything after the first question-mark to the \mono{interactive/code} element.  Be sure to replace any ampersands by \mono{\&amp;} (see the Author's Guide for more about certain characters in \initialism{URL}s).  Examine the source for the examples below to see how they are authored.  The \pubtitle{Help Manual} for CalcPlot3D is also available off the menu\slash{}hamburger icon in the upper-left.%
\par
...
\begin{sidebyside}{2}{0.075}{0.075}{0.17}%
\begin{sbspanel}{0.47}%
\noindent\includegraphics[width=\linewidth]{generated/preview/calcplot3d-intersection-planes-preview.png}
\end{sbspanel}%
\begin{sbspanel}{0.21}%
\noindent\includegraphics[width=\linewidth]{generated/qrcode/calcplot3d-intersection-planes.png}
...
\begin{sidebyside}{2}{0.075}{0.075}{0.17}%
\begin{sbspanel}{0.47}%
\noindent\includegraphics[width=\linewidth]{generated/preview/calcplot3d-probability-wavefunction-preview.png}
\end{sbspanel}%
\begin{sbspanel}{0.21}%
\noindent\includegraphics[width=\linewidth]{generated/qrcode/calcplot3d-probability-wavefunction.png}
...
\begin{sidebyside}{2}{0.075}{0.075}{0.17}%
\begin{sbspanel}{0.47}%
\noindent\includegraphics[width=\linewidth]{generated/preview/calcplot3d-full-application-preview.png}
\end{sbspanel}%
\begin{sbspanel}{0.21}%
\noindent\includegraphics[width=\linewidth]{generated/qrcode/calcplot3d-full-application.png}
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{IFrames from Servers}{}{IFrames from Servers}{}{}{interactive-iframes-server}
...
\par
This example is from \href{https://phet.colorado.edu/}{PhET Interactive Simulations}.%
\begin{figureptx}{Figure}{Fourier: Making Waves \mono{iframe}}{figure-phet-fourier}{}%
\begin{sidebyside}{2}{0.075}{0.075}{0.17}%
\begin{sbspanel}{0.47}%
\noindent\includegraphics[width=\linewidth]{external/preview/phet-fourier-preview.png}
\end{sbspanel}%
\begin{sbspanel}{0.21}%
\noindent\includegraphics[width=\linewidth]{generated/qrcode/interactive-phet-fourier.png}
...
\begin{sidebyside}{2}{0.075}{0.075}{0.17}%
\begin{sbspanel}{0.47}%
\noindent\includegraphics[width=\linewidth]{generated/preview/interactive-map-california-preview.png}
\end{sbspanel}%
\begin{sbspanel}{0.21}%
\noindent\includegraphics[width=\linewidth]{generated/qrcode/interactive-map-california.png}
...
\typeout{************************************************}
%
\begin{sectionptx}{Section}{Interactive Exercises}{}{Interactive Exercises}{}{}{section-interactive-exercises}
\begin{introduction}{}%
...
%
\typeout{************************************************}
\typeout{Exercises 16.1 True\slash{}False}
\typeout{************************************************}
%
\begin{exercises-subsection}{Exercises}{True\slash{}False}{}{True\slash{}False}{}{}{section-interactive-exercises-3}
\begin{introduction}{}%
A True\slash{}False question.%
\end{introduction}%
...
%
\typeout{************************************************}
\typeout{Exercises 16.2 Multiple-Choice}
\typeout{************************************************}
%
\begin{exercises-subsection}{Exercises}{Multiple-Choice}{}{Multiple-Choice}{}{}{section-interactive-exercises-4}
\begin{introduction}{}%
...
%
\typeout{************************************************}
\typeout{Exercises 16.3 Parsons Problem, Math Proof}
\typeout{************************************************}
%
\begin{exercises-subsection}{Exercises}{Parsons Problem, Math Proof}{}{Parsons Problem, Math Proof}{}{}{section-interactive-exercises-5}
\begin{introduction}{}%
With some MathJax.%
\end{introduction}%
...
\item{}So we have the displayed equation:%
\begin{equation*}
n = 2m + 0\text{.}
\end{equation*}
%
...
%
\typeout{************************************************}
\typeout{Exercises 16.4 Parsons Problem, Code}
\typeout{************************************************}
%
\begin{exercises-subsection}{Exercises}{Parsons Problem, Code}{}{Parsons Problem, Code}{}{}{section-interactive-exercises-6}
\begin{introduction}{}%
Programming Parsons problem, requiring indentation.%
\end{introduction}%
\begin{divisionexercise}{1}{Parsons Problem, Programming.}{}{prime-number-program-indent-yes}%
\index{prime numbers}%
...
%
\typeout{************************************************}
\typeout{Exercises 16.5 Matching}
\typeout{************************************************}
%
\begin{exercises-subsection}{Exercises}{Matching}{}{Matching}{}{}{section-interactive-exercises-7}
\begin{introduction}{}%
Events and dates.%
\end{introduction}%
\begin{divisionexercise}{1}{Matching Problem, Dates.}{}{matching-dates}%
...
%
\typeout{************************************************}
\typeout{Exercises 16.6 Clickable Area}
\typeout{************************************************}
%
\begin{exercises-subsection}{Exercises}{Clickable Area}{}{Clickable Area}{}{}{section-interactive-exercises-8}
\begin{introduction}{}%
Words, not code.%
\end{introduction}%
...
%
\typeout{************************************************}
\typeout{Exercises 16.7 Old-Style Fillin-In}
\typeout{************************************************}
%
\begin{exercises-subsection}{Exercises}{Old-Style Fillin-In}{}{Old-Style Fillin-In}{}{}{section-interactive-exercises-9}
\begin{introduction}{}%
Do not use this as a model for new exercises.  Just for backwards-compatibility.%
\end{introduction}%
\begin{divisionexercise}{1}{Fill-In, String and Number Answers.}{}{fillin-string-integer}%
Complete the following line of a Python program so that it will declare an integer variable \mono{age} with an initial value of \mono{5}.%
\par
\fillintext{5} \mono{age = } \fillintext{5}\mono{;}%
\par\smallskip%
\noindent\textbf{\blocktitlefont Solution}.\hypertarget{fillin-string-integer-3}{}\quad{}Complete the following line of a Python program so that it will declare an integer variable \mono{age} with an initial value of \mono{5}.%
\par
...
%
\typeout{************************************************}
\typeout{Reading Questions 16.8 A Reading Question}
\typeout{************************************************}
%
\begin{reading-questions-subsection}{Reading Questions}{A Reading Question}{}{A Reading Question}{}{}{section-interactive-exercises-10}
\begin{divisionexercise}{1}{Short Answer.}{}{short-answer-question}%
This should be built with a text-box, \emph{only} on a capable server (Runestone).  So it can be answered%
\end{divisionexercise}%
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{Faux Subsection}{}{Faux Subsection}{}{}{section-interactive-exercises-11}
...
\typeout{************************************************}
%
\begin{sectionptx}{Section}{Dynamic Exercises}{}{Dynamic Exercises}{}{}{section-dynamic-exercises}
\begin{introduction}{}%
...
%
\typeout{************************************************}
\typeout{Exercises 17 Dynamic Fill-In}
\typeout{************************************************}
%
\begin{exercises-subsection-numberless}{Exercises}{Dynamic Fill-In}{}{Dynamic Fill-In}{}{}{section-dynamic-exercises-3}
\begin{introduction}{}%
...
\end{introduction}%
\begin{divisionexercise}{1}{Fill-In, String and Number Answers.}{}{fillin-string-integer-new}%
Complete the following line of a Python program so that it will declare an integer variable \mono{age} with an initial value of \mono{5}.%
\par
\fillintext{5} \mono{age = } \fillintext{5}\mono{;}%
\par\smallskip%
\noindent\textbf{\blocktitlefont Solution}.\hypertarget{fillin-string-integer-new-3}{}\quad{}Complete the following line of a Python program so that it will declare an integer variable \mono{age} with an initial value of \mono{5}.%
\par
\fillintext{1}int\fillintext{1} \mono{age = } \fillintext{1}\(5\)\fillintext{1}\mono{;}%
\end{divisionexercise}%
\begin{divisionexercise}{2}{Fill-In, Multiple Strings, Custom Checker.}{}{fillin-multi-answer-jscmp}%
In order to apply the Integral Test to a sequence \(\{a_n\}\), the function \(a(n) = a_n\) must be \fillintext{5}, \fillintext{5}~and \fillintext{5}.%
\par\smallskip%
\noindent\textbf{\blocktitlefont Solution}.\hypertarget{fillin-multi-answer-jscmp-3}{}\quad{}In order to apply the Integral Test to a sequence \(\{a_n\}\), the function \(a(n) = a_n\) must be \fillintext{1}continuous\fillintext{1}, \fillintext{1}positive\fillintext{1}~and \fillintext{1}decreasing\fillintext{1}.%
\end{divisionexercise}%
\begin{divisionexercise}{3}{Fill-In Formula (Dynamic).}{}{dynamic-fitb-simple-formula}%
Find a formula for a cubic function \(f(x)\) that has roots at \(x=-5\),  \(x=-2\), and \(x=2\) and so that \(f(0)=5\).%
\par
\(f(x)=\) \fillintext{5}%
\par\smallskip%
\noindent\textbf{\blocktitlefont Solution 1}.\hypertarget{dynamic-fitb-simple-formula-3}{}\quad{}Find a formula for a cubic function \(f(x)\) that has roots at \(x=-5\),  \(x=-2\), and \(x=2\) and so that \(f(0)=5\).%
\par
\(f(x)=\) \fillintext{1}\(-\frac{1}{4} \left(x+5\right) \left(x+2\right) \left(x-2\right)\)\fillintext{1}%
\par\smallskip%
\noindent\textbf{\blocktitlefont Solution 2}.\hypertarget{dynamic-fitb-simple-formula-4}{}\quad{}Knowing the roots of a polynomial allows us to write down the formula of \(f(x)\) in factored form,%
\begin{equation*}
f(x) = A \left(x+5\right) \left(x+2\right) \left(x-2\right)
\end{equation*}
...
\begin{equation*}
A \left(x+5\right) \left(x+2\right) \left(x-2\right) = 5
\end{equation*}
and find that \(A=-\frac{1}{4}\).%
\par
Consequently, we can write our function in the form%
\begin{equation*}
f(x)=-\frac{1}{4} \left(x+5\right) \left(x+2\right) \left(x-2\right)\text{.}
\end{equation*}
%
\end{divisionexercise}%
\begin{divisionexercise}{4}{Decompose the Function.}{}{function-decomposition}%
...
\par\smallskip%
\noindent\textbf{\blocktitlefont Solution 1}.\hypertarget{function-decomposition-3}{}\quad{}Consider the function%
\begin{equation*}
h(x)=4 \left(-x-3\right)^{3}+5\text{.}
\end{equation*}
Find two nontrivial functions \(f(x)\) and \(g(x)\) so that \(h(x) = f(g(x))\).%
\par
\(f(x) = \) \fillintext{1}\(4 x^{3}+5\)\fillintext{1} and \(g(x)=\) \fillintext{1}\(-1 x-3\)\fillintext{1}%
\par\smallskip%
\noindent\textbf{\blocktitlefont Solution 2}.\hypertarget{function-decomposition-4}{}\quad{}Noticing that the expression \(-1 x-3\) appears inside parentheses with a power, it makes sense to think of that as the inner function, defining \(g(x) = -1 x-3\). The outer function describes what happens to that. If we imagined replacing the formula \(-1 x-3\) with a box and then call that box our variable \(x\), we find the outer function is given by \(f(x) = 4 x^{3}+5\).%
\par
...
\typeout{************************************************}
%
\begin{sectionptx}{Section}{Interactive Coding}{}{Interactive Coding}{}{}{section-interactive-code}
\begin{introduction}{}%
...
%
\typeout{************************************************}
\typeout{Exercises 18.1 ActiveCode}
\typeout{************************************************}
%
\begin{exercises-subsection}{Exercises}{ActiveCode}{}{ActiveCode}{}{}{section-interactive-code-3}
\begin{introduction}{}%
...
\end{program}
\end{listingptx}%
\begin{listingptx}{Listing}{\textbf{An interactive Python program without codelens.}}{program-activecode-python-no-codelens}{}%
\begin{program}{Python}{0}{1}{0}
print("Hello, World!")
\end{program}
\end{listingptx}%
...
%
\typeout{************************************************}
\typeout{Exercises 18.2 CodeLens}
\typeout{************************************************}
%
\begin{exercises-subsection}{Exercises}{CodeLens}{}{CodeLens}{}{}{section-interactive-code-4}
\begin{introduction}{}%
...
%
\typeout{************************************************}
\typeout{Exercises 18.3 Activity with An ActiveCode}
\typeout{************************************************}
%
\begin{exercises-subsection}{Exercises}{Activity with An ActiveCode}{}{Activity with An ActiveCode}{}{}{section-interactive-code-5}
\begin{introduction}{}%
Something to do with ActiveCode program.%
\end{introduction}%
\begin{activity}{Activity}{Activity Coding Exercise.}{coding-exercise-partial-two}%
Similar to above, but now as a complete Python program inside an \mono{<activity>}.  This demonstrates the possibility to use any ``project-like'' block (\mono{<project>}, \mono{<activity>}, \mono{<exploration>}, \mono{<investigation>}), but not in the case when structured with \mono{<task>}.%
\begin{program}{Python}{0}{1}{0}
for i in range(10):
    print(i)
\end{program}
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{YouTube}{}{YouTube}{}{}{section-interactive-code-6}
Video, observable on a Runestone server.%
\begin{sidebyside}{2}{0.075}{0.075}{0.17}%
\begin{sbspanel}{0.47}%
\noindent\includegraphics[width=\linewidth]{external/yt-list-variables.png}
\end{sbspanel}%
\begin{sbspanel}{0.21}%
\noindent\includegraphics[width=\linewidth]{generated/qrcode/yt-list-vars.png}
...
\typeout{************************************************}
%
\begin{sectionptx}{Section}{Audio}{}{Audio}{}{}{section-audio}
...
\end{sbspanel}%
\begin{sbspanel}{0.21}%
\noindent\includegraphics[width=\linewidth]{generated/qrcode/audio-piano-trill.png}
...
\end{sbspanel}%
\begin{sbspanel}{0.21}%
\noindent\includegraphics[width=\linewidth]{generated/qrcode/audio-piano-trill-two.png}
...
\typeout{************************************************}
%
\begin{sectionptx}{Section}{Video}{}{Video}{}{}{section-video}
\begin{introduction}{}%
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{Video Files}{}{Video Files}{}{}{section-video-3}
...
\end{sbspanel}%
\begin{sbspanel}{0.21}%
\noindent\includegraphics[width=\linewidth]{generated/qrcode/ups-promo-preview.png}
...
\begin{sidebyside}{2}{0.075}{0.075}{0.17}%
\begin{sbspanel}{0.47}%
\noindent\includegraphics[width=\linewidth]{generated/play-button/play-button.png}
\end{sbspanel}%
\begin{sbspanel}{0.21}%
\noindent\includegraphics[width=\linewidth]{generated/qrcode/ups-promo-generic.png}
...
\begin{figureptx}{Figure}{Big Buck Bunny from  \href{http://camendesign.com/code/video_for_everybody/test.htm}{``Video for Everybody'' Test Page}}{section-video-3-9}{}%
\begin{sidebyside}{2}{0.075}{0.075}{0.17}%
\begin{sbspanel}{0.47}%
\noindent\includegraphics[width=\linewidth]{external/preview/big-buck-bunny-frame-one.jpg}
\end{sbspanel}%
\begin{sbspanel}{0.21}%
\noindent\includegraphics[width=\linewidth]{generated/qrcode/big-buck-bunny-frame-one.png}
...
\end{sbspanel}%
\begin{sbspanel}{0.21}%
\noindent\includegraphics[width=\linewidth]{generated/qrcode/big-buck-bunny-margins.png}
...
\end{sbspanel}%
\begin{sbspanel}{0.21}%
\noindent\includegraphics[width=\linewidth]{generated/qrcode/big-buck-bunny-ogg.png}
...
\end{sbspanel}%
\begin{sbspanel}{0.21}%
\noindent\includegraphics[width=\linewidth]{generated/qrcode/big-buck-bunny-mp4.png}
...
\end{sbspanel}%
\begin{sbspanel}{0.21}%
\noindent\includegraphics[width=\linewidth]{generated/qrcode/big-buck-bunny-webm.png}
...
\end{sbspanel}%
\begin{sbspanel}{0.21}%
\noindent\includegraphics[width=\linewidth]{generated/qrcode/big-buck-bunny-best-format.png}
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{YouTube}{}{YouTube}{}{}{section-video-4}
...
\begin{sidebyside}{2}{0.075}{0.075}{0.17}%
\begin{sbspanel}{0.47}%
\noindent\includegraphics[width=\linewidth]{generated/youtube/drone-flight-full.jpg}
\end{sbspanel}%
\begin{sbspanel}{0.21}%
\noindent\includegraphics[width=\linewidth]{generated/qrcode/drone-flight-full.png}
...
\begin{sidebyside}{2}{0.075}{0.075}{0.17}%
\begin{sbspanel}{0.47}%
\noindent\includegraphics[width=\linewidth]{generated/youtube/drone-flight-clip.jpg}
\end{sbspanel}%
\begin{sbspanel}{0.21}%
\noindent\includegraphics[width=\linewidth]{generated/qrcode/drone-flight-clip.png}
...
\begin{sidebyside}{2}{0.075}{0.075}{0.17}%
\begin{sbspanel}{0.47}%
\noindent\includegraphics[width=\linewidth]{external/preview/jimmy-page.jpg}
\end{sbspanel}%
\begin{sbspanel}{0.21}%
\noindent\includegraphics[width=\linewidth]{generated/qrcode/led-zeppelin-kashmir.png}
...
\end{sbspanel}%
\begin{sbspanel}{0.21}%
\noindent\includegraphics[width=\linewidth]{generated/qrcode/led-zeppelin-kashmir-generic.png}
...
\end{sbspanel}%
\begin{sbspanel}{0.21}%
\noindent\includegraphics[width=\linewidth]{generated/qrcode/led-zeppelin-kashmir-solo.png}
...
\begin{sidebyside}{2}{0.075}{0.075}{0.17}%
\begin{sbspanel}{0.47}%
\noindent\includegraphics[width=\linewidth]{generated/youtube/drone-flight-sbs.jpg}
\end{sbspanel}%
\begin{sbspanel}{0.21}%
\noindent\includegraphics[width=\linewidth]{generated/qrcode/drone-flight-sbs.png}
...
\end{sbspanel}%
\begin{sbspanel}{0.21}%
\noindent\includegraphics[width=\linewidth]{generated/qrcode/ups-promo-sbs.png}
...
\begin{sidebyside}{2}{0.075}{0.075}{0.17}%
\begin{sbspanel}{0.47}%
\noindent\includegraphics[width=\linewidth]{generated/youtube/zeppelin-playlist.jpg}
\end{sbspanel}%
\begin{sbspanel}{0.21}%
\noindent\includegraphics[width=\linewidth]{generated/qrcode/zeppelin-playlist.png}
...
\end{sbspanel}%
\begin{sbspanel}{0.21}%
\noindent\includegraphics[width=\linewidth]{generated/qrcode/zeppelin-playlist-named.png}
...
\begin{sidebyside}{2}{0.075}{0.075}{0.17}%
\begin{sbspanel}{0.47}%
\noindent\includegraphics[width=\linewidth]{generated/youtube/pre-roll-countdown-1.jpg}
\end{sbspanel}%
\begin{sbspanel}{0.21}%
\noindent\includegraphics[width=\linewidth]{generated/qrcode/pre-roll-countdown-1.png}
...
\begin{sidebyside}{2}{0.075}{0.075}{0.17}%
\begin{sbspanel}{0.47}%
\noindent\includegraphics[width=\linewidth]{generated/youtube/pre-roll-countdown-2.jpg}
\end{sbspanel}%
\begin{sbspanel}{0.21}%
\noindent\includegraphics[width=\linewidth]{generated/qrcode/pre-roll-countdown-2.png}
...
\begin{sidebyside}{2}{0.075}{0.075}{0.17}%
\begin{sbspanel}{0.47}%
\noindent\includegraphics[width=\linewidth]{generated/youtube/pre-roll-countdown-3.jpg}
\end{sbspanel}%
\begin{sbspanel}{0.21}%
\noindent\includegraphics[width=\linewidth]{generated/qrcode/pre-roll-countdown-3.png}
...
\begin{sidebyside}{2}{0.075}{0.075}{0.17}%
\begin{sbspanel}{0.47}%
\noindent\includegraphics[width=\linewidth]{generated/youtube/pre-roll-countdown-4.jpg}
\end{sbspanel}%
\begin{sbspanel}{0.21}%
\noindent\includegraphics[width=\linewidth]{generated/qrcode/pre-roll-countdown-4.png}
...
\begin{sidebyside}{2}{0.075}{0.075}{0.17}%
\begin{sbspanel}{0.47}%
\noindent\includegraphics[width=\linewidth]{generated/youtube/pre-roll-countdown-5.jpg}
\end{sbspanel}%
\begin{sbspanel}{0.21}%
\noindent\includegraphics[width=\linewidth]{generated/qrcode/pre-roll-countdown-5.png}
...
\begin{sidebyside}{2}{0.075}{0.075}{0.17}%
\begin{sbspanel}{0.47}%
\noindent\includegraphics[width=\linewidth]{generated/youtube/pre-roll-countdown-6.jpg}
\end{sbspanel}%
\begin{sbspanel}{0.21}%
\noindent\includegraphics[width=\linewidth]{generated/qrcode/pre-roll-countdown-6.png}
...
\end{sbspanel}%
\begin{sbspanel}{0.21}%
\noindent\includegraphics[width=\linewidth]{generated/qrcode/ups-promo-1.png}
...
\end{sbspanel}%
\begin{sbspanel}{0.21}%
\noindent\includegraphics[width=\linewidth]{generated/qrcode/ups-promo-2.png}
...
\end{sbspanel}%
\begin{sbspanel}{0.21}%
\noindent\includegraphics[width=\linewidth]{generated/qrcode/ups-promo-3.png}
...
\end{sbspanel}%
\begin{sbspanel}{0.21}%
\noindent\includegraphics[width=\linewidth]{generated/qrcode/ups-promo-4.png}
...
\end{sbspanel}%
\begin{sbspanel}{0.21}%
\noindent\includegraphics[width=\linewidth]{generated/qrcode/ups-promo-5.png}
...
\end{sbspanel}%
\begin{sbspanel}{0.21}%
\noindent\includegraphics[width=\linewidth]{generated/qrcode/ups-promo-6.png}
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{Vimeo}{}{Vimeo}{}{}{section-video-5}
We support videos from \href{https://vimeo.com/}{Vimeo} in much the same way as YouTube videos.  Now the identifier is a long integer.  For example, the video up next would normally be found at \mono{https://vimeo.com/27246366}.  But instead, you can embed the video with as little as \mono{<video vimeo=\textquotedbl{}27246366\textquotedbl{}/>}.  As of 2019-05-18, we intend to support as many of the options described above as possible.  Widths and heights (via the aspect ratio) will perform as expected.  We have not investigated start and end times.%
\begin{figureptx}{Figure}{``MOVE'', by \href{https://vimeo.com/rickmereki}{Rick Mereki}, \mono{vimeo.com/rickmereki}}{section-video-5-3}{}%
\begin{sidebyside}{2}{0.075}{0.075}{0.17}%
\begin{sbspanel}{0.47}%
\noindent\includegraphics[width=\linewidth]{external/preview/vimeo-move.jpg}
\end{sbspanel}%
\begin{sbspanel}{0.21}%
\noindent\includegraphics[width=\linewidth]{generated/qrcode/vimeo-move.png}
...
\begin{figureptx}{Figure}{``MOVE'', by \href{https://vimeo.com/rickmereki}{Rick Mereki}, \mono{vimeo.com/rickmereki}}{section-video-5-5}{}%
\begin{sidebyside}{2}{0.075}{0.075}{0.17}%
\begin{sbspanel}{0.47}%
\noindent\includegraphics[width=\linewidth]{external/preview/move.png}
\end{sbspanel}%
\begin{sbspanel}{0.21}%
\noindent\includegraphics[width=\linewidth]{generated/qrcode/section-video-5-5-2.png}
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{Captions and Subtitles}{}{Captions and Subtitles}{}{}{section-video-6}
Experimental support for captions and subtitles first.  Look at the source, which mimics the actual HTML.  The words of the titles and\slash{}or subcaptions (there is a difference!) come from a file in \href{https://en.wikipedia.org/wiki/WebVTT}{Web Video Text Tracks} (\initialism{WEBVVT}) format.%
...
\end{sbspanel}%
\begin{sbspanel}{0.21}%
\noindent\includegraphics[width=\linewidth]{generated/qrcode/big-buck-bunny-subtitles.png}
...
\end{sbspanel}%
\begin{sbspanel}{0.21}%
\noindent\includegraphics[width=\linewidth]{generated/qrcode/big-buck-bunny-two-subtitles.png}
...
\typeout{************************************************}
%
\begin{sectionptx}{Section}{Cross-Referencing}{}{Cross-Referencing}{}{}{section-cross-referencing}
...
\par
Cross-references to exercises with hard-coded numbers should respect the supplied number.  Exercise~\hyperlink{exercise-with-hardcoded-number}{{\xreffont 40.42a}} should reference problem 42a.%
\par
...
\item{}Citations: Judson's AATA with annotation at \hyperlink{biblio-judson-AATA}{[{\xreffont J.3.1}]}%
\item{}Citations: Judson's AATA with autoname that should have zero effect \hyperlink{biblio-judson-AATA}{[{\xreffont J.3.1}]}%
\item{}Citations: In a \mono{<references>} division inside an appendix \hyperlink{biblio-strang-article-uno}{[{\xreffont J.2.1}]}%
\item{}Note: just the annotation of previous citation at \hyperlink{note-judson-AATA}{{\xreffont J.3.1.1}}%
...
\item{}Solution: An autonamed portion of an exercise: \hyperlink{solution-antiderivative}{Solution~{\xreffont 40.42a.1}}%
\item{}Parts of a complicated exercise: \hyperlink{exercise-complicated-second-hint}{Hint~{\xreffont 40.12.2}} \hyperlink{exercise-complicated-first-answer}{Answer~{\xreffont 40.12.1}}%
\item{}A subsidary part of an exercise: \hyperlink{exercise-one-two-one}{{\xreffont 12.10.1.b.i}}%
\item{}\index{knowl!nested} Three cross-references to individual exercises, but due to their location, they should have different ``type names'' in the cross-reference: in an \mono{<exercises>} division, \hyperlink{duplicate-divisional}{Exercise~{\xreffont 37.2}}; in the narrative, \hyperref[exercise-essay]{Checkpoint~{\xreffont\ref{exercise-essay}}}; and in a \mono{<worksheet>}, \hyperlink{exercise-vector-addition}{Worksheet Exercise~{\xreffont 35.1.2}}.%
...
\item{}Two bibliographic items, no autoname: [\hyperlink{biblio-judson-AATA}{{\xreffont J.3.1}}, \hyperlink{biblio-lay-article}{{\xreffont 2}}]%
\end{itemize}
%
\par
...
\item{}A range of bibliographic items: \hyperlink{biblio-judson-AATA}{[{\xreffont J.3.1}\textendash{}{\xreffont 2}]}%
\end{itemize}
%
\par
...
\par
Foo \href{http://go.microsoft.com/fwlink/?LinkID=521962}{Sample Excel Spreadsheet} Bar%
\par
Foo \href{https://pretextbook.org/examples/sample-article/html/external/data/spreadsheet/runningstatisticstemplate.ots}{Runners Template} Bar%
\par
Foo \href{http://go.microsoft.com/fwlink/?LinkID=521962}{Sample Excel Spreadsheet} Bar%
\par
Foo \href{https://pretextbook.org/examples/sample-article/html/external/data/spreadsheet/runningstatisticstemplate.ots}{Runners Template} Bar%
...
\typeout{************************************************}
%
\begin{sectionptx}{Section}{Internationalization}{}{Internationalization}{}{}{section-internationalization}
...
\begin{paragraphs}{Unicode Characters for HTML Output.}{section-internationalization-4}%
...
\item{}Alan Wood’s \href{http://www.alanwood.net/unicode/unicode_samples.html}{Unicode Resources} has a plethora of samples of various groups of Unicode characters.  If you, or your readers, are ``missing'' characters in a web browser, this is a good place to start testing the local setup.%
\end{itemize}
%
\end{paragraphs}%
\begin{paragraphs}{Characters in \LaTeX{}, PDF, print.}{section-internationalization-5}%
...
\end{paragraphs}%
\begin{paragraphs}{Basic Latin, \mono{U+0000}\textendash{}\mono{U+007F}.}{section-internationalization-6}%
...
\end{tableptx}%
\end{paragraphs}%
\begin{paragraphs}{Latin-1 Supplement, \mono{U+0080}\textendash{}\mono{U+00FF}.}{section-internationalization-7}%
...
\end{tableptx}%
\end{paragraphs}%
\begin{paragraphs}{Monospace, Basic Latin and Latin-1 Supplement, \mono{U+0000}\textendash{}\mono{U+00FF}.}{section-internationalization-8}%
...
\typeout{************************************************}
%
\begin{sectionptx}{Section}{Pre-Formatted Text}{}{Pre-Formatted Text}{}{}{section-pre-formatted}
...
\typeout{************************************************}
%
\begin{sectionptx}{Section}{Program Listings (with \mono{code} in the title)}{}{Program Listings (with \mono{code} in the title)}{}{}{section-programs}
...
\begin{listingptx}{Listing}{\textbf{A static Java program with line numbers}}{program-line-numbers}{}%
...
\begin{listingptx}{Listing}{\textbf{A static Java program with line numbers}}{program-highlight-lines}{}%
\begin{programnumbered}{Java}{0}{1}{0}
import javax.swing.JFrame;  //Importing class JFrame
import javax.swing.JLabel;  //Importing class JLabel
public class HelloWorld {
...
\end{program}
Sometimes it is nice to author an inline fragment of a program and have the styling of its text match that of a \mono{<program>}. To do this we can use the \mono{<pf>} tag (``program fragment'').  It is similar to a \mono{<c>} element, but will be syntax highlighted according to either a \mono{@language} or the default language for \mono{<programs>}. Here is an example in C: \programfragment{C}{`printf("The cost is \$\%f.2", money);`}. And another that is in Python and tests problematic characters: \programfragment{Python}{`print("\& \% \$ \# \_ \{ \} \~ \^ \\")`}.%
\par
...
%
\end{algorithm}
\begin{proof}{Proof}{}{algorithm-sieve-eratosthenes-3}
...
\begin{equation}
\texttt{6C2A}_{16} = \texttt{0110}\;\texttt{1100}\;\texttt{0010}\;\texttt{1010}_{2}\label{section-programs-24-4}
\end{equation}
...
\begin{theorem}{Theorem}{}{}{theorem-detached}%
...
\begin{proof}{Proof}{}{section-programs-27}\space(\hyperref[theorem-detached]{Theorem~{\xreffont\ref{theorem-detached}}})\space
...
\begin{listingptx}{Listing}{\textbf{Console Session: \mono{int} and \mono{float}}}{console-raspberry-pi}{}%
\begin{console}{0}{1}{0}
...
\begin{listingptx}{Listing}{\textbf{Console Session: \mono{int} and \mono{float} (multi-line input)}}{console-raspberry-pi-multi}{}%
\begin{console}{0}{1}{0}
...
\begin{listingptx}{Listing}{\textbf{Console Session: problematic \LaTeX{} characters}}{section-programs-38}{}%
\begin{console}{0}{1}{0}
...
\begin{listingptx}{Listing}{\textbf{A longer program listing}}{section-programs-40}{}%
\begin{program}{none}{0}{1}{0}
@ structPass2.s
...
\typeout{************************************************}
%
\begin{sectionptx}{Section}{Units of Measure}{}{Units of Measure}{}{}{section-units-measure}
...
\typeout{************************************************}
%
\begin{sectionptx}{Section}{Side-By-Side Panels}{}{Side-By-Side Panels}{}{}{section-side-by-side}
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{Figures with Numbers Side-By-Side}{}{Figures with Numbers Side-By-Side}{}{}{section-side-by-side-3}
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{Images}{}{Images}{}{}{section-side-by-side-4}
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{Common Side-By-Side Constructions}{}{Common Side-By-Side Constructions}{}{}{section-side-by-side-5}
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{Vertical Alignment}{}{Vertical Alignment}{}{}{section-side-by-side-6}
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{Text Next to Text and Images}{}{Text Next to Text and Images}{}{}{section-side-by-side-7}
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{Image Formats, Side-by-Sides}{}{Image Formats, Side-by-Sides}{}{}{section-side-by-side-8}
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{Tables Side-By-Side}{}{Tables Side-By-Side}{}{}{section-side-by-side-9}
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{Tables Next to Figures}{}{Tables Next to Figures}{}{}{section-side-by-side-10}
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{Tables Next to Text}{}{Tables Next to Text}{}{}{section-side-by-side-11}
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{Tabular Next to Each Other}{}{Tabular Next to Each Other}{}{}{section-side-by-side-12}
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{Lists in Side-by-Sides}{}{Lists in Side-by-Sides}{}{}{section-side-by-side-13}
...
\tcblower
\end{figureptx}%
\footnotetext[1]{Not fishes\label{section-side-by-side-13-3-2-1-3-2-1}}%
\footnotetext[2]{in many shades\label{color-list-as-panel-3-1-1-1}}%
...
\end{sbspanel}%
\end{sidebyside}%
\footnotetext[3]{No more fishes\label{section-side-by-side-13-5-1-3-1-1}}%
\footnotetext[4]{a really nice color\label{color-list-as-panel-in-sbs-3-2-1-1}}%
\par
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{Stacking: Back to Vertical Flow}{}{Stacking: Back to Vertical Flow}{}{}{stacking-side-by-side}
...
\tcblower
\end{figureptx}%
\begin{paragraphs}{Bully Pulpit.}{stacking-side-by-side-12}%
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{Other Panels}{}{Other Panels}{}{}{subsection-sbs-other-panels}
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{Poems as Side-By-Side Panels}{}{Poems as Side-By-Side Panels}{}{}{section-side-by-side-16}
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{Side-By-Side Groups}{}{Side-By-Side Groups}{}{}{subsection-sbsgroup}
...
\end{sbspanel}%
\end{sidebyside}%
The following is a \mono{<sbsgroup>} full of ``operation'' tables.  Once upon a time it was rather cramped vertically in HTML output, but Andrew Scholer improved the spacing at \href{https://github.com/PreTeXtBook/pretext/pull/2387}{GitHub \#2387}.  The example is from Valerio Monti.%
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{Testing a Side-By-Side First}{}{Testing a Side-By-Side First}{}{}{section-side-by-side-18}
...
\begin{activity}{Activity}{}{section-side-by-side-18-3}%
\begin{sidebyside}{2}{0}{0}{0.06}%
...
\end{sidebyside}%
\end{activity}%
\begin{example}{Example}{}{section-side-by-side-18-4}%
\begin{sidebyside}{2}{0}{0}{0}%
\begin{sbspanel}{0.5}%
Here is text block 1%
\end{sbspanel}%
...
\begin{example}{Example}{}{section-side-by-side-18-6}%
\begin{sidebyside}{2}{0}{0}{0}%
\begin{sbspanel}{0.5}%
Here is text block 1%
\end{sbspanel}%
...
\end{sidebyside}%
\end{example}
\begin{paragraphs}{First Child of a Paragraphs.}{section-side-by-side-18-7}%
\leavevmode\par\noindent%
\begin{sidebyside}{2}{0}{0}{0}%
\begin{sbspanel}{0.5}%
\noindent\resizebox{\ifdim\width > \linewidth\linewidth\else\width\fi}{!}{%
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{Testing Styling of Related Elements}{}{Testing Styling of Related Elements}{}{}{section-side-by-side-19}
...
\typeout{************************************************}
%
\begin{sectionptx}{Section}{Side-by-Side Gallery}{}{Side-by-Side Gallery}{}{}{section-side-by-side-gallery}
...
\begin{sidebyside}{2}{0.05}{0.05}{0.05}%
\begin{sbspanel}{0.4}%
\begin{sublistingptx}{Listing}{\textbf{A statistical computation}}{section-side-by-side-gallery-16-2-1}{}%
\begin{program}{R}{0}{1}{0}
n_loops <- 10
x.means <- numeric(n_loops)
for (i in 1:n_loops){
...
\typeout{************************************************}
%
\begin{sectionptx}{Section}{Open Problems}{}{Open Problems}{}{}{section-open-problems}
Like for mathematical research.  Experimental as of 2023-07-06.%
\begin{openproblem}{Open Problem}{}{section-open-problems-3}%
...
\typeout{************************************************}
%
\begin{sectionptx}{Section}{Poetry}{}{Poetry}{}{}{section-poetry}
...
\end{poem}
And when yours truly tried to joke about poetry on \href{https://github.com/PreTeXtBook/pretext-cli/issues/182}{GitHub CLI \#182}, back came:%
\begin{poem}\label{limerick-clontz}%
\poemTitle{}
\begin{stanza}
\poemlineleft{There once was a maintainer named Rob}
\poemlineleft{Who told bad jokes while on the job}
\poemlineleft{While they were lame}
\poemlineleft{You could say the same}
\poemlineleft{Of Steven's limericks that cause you to sob}
\end{stanza}
...
\typeout{************************************************}
%
\begin{sectionptx}{Section}{Atomic Objects}{}{Atomic Objects}{}{}{section-atomic-items}
\begin{introduction}{}%
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{\mono{<image>}}{}{\mono{<image>}}{}{}{atomic-image}
...
\tcblower
\end{figureptx}%
\begin{inlineexercise}{Checkpoint}{}{atomic-image-25}%
\begin{enumerate}[font=\bfseries,label=(\alph*),ref=\alph*]%
\item{}\begin{image}{0}{0.3}{0.7}{-1.5\baselineskip}%
\includegraphics[width=\linewidth]{external/images/nz-landscape.jpg}
\end{image}%
...
\typeout{************************************************}
%
\begin{exercises-subsubsection-numberless}{Exercises}{Exercises}{}{Exercises}{}{}{atomic-image-26}
\begin{divisionexercise}{1}{}{}{atomic-image-26-1}%
\begin{enumerate}[font=\bfseries,label=(\alph*),ref=\alph*]%
\item{}\begin{image}{0}{0.3}{0.7}{-1.5\baselineskip}%
\includegraphics[width=\linewidth]{external/images/nz-landscape.jpg}
\end{image}%
...
\begin{divisionexerciseegcol}{2}{}{}{atomic-image-26-2-1}%
\begin{image}{0}{0.3}{0.7}{-0.5\baselineskip}%
\includegraphics[width=\linewidth]{external/images/nz-landscape.jpg}
\end{image}%
\end{divisionexerciseegcol}%
\begin{divisionexerciseegcol}{3}{}{}{atomic-image-26-2-2}%
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{\mono{<video>}}{}{\mono{<video>}}{}{}{atomic-video}
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{\mono{<program>}, \mono{<console>}}{}{\mono{<program>}, \mono{<console>}}{}{}{atomic-program}
...
\item{}inside a \mono{<figure>} inside a \mono{<sidebyside>} inside a \mono{<listing>}, with size and layout configured, with a number and title, but now sub-numbered ((a), (b), (c),\textellipsis{}).%
\end{enumerate}
Examples of each, and more.%
\par
...
pi@raspberrypi ~/progs/chap02 $ (*\consoleinput{}*)
\end{console}
Two \mono{<listing>}, with \mono{<title>}, and no layout control.%
\begin{listingptx}{Listing}{\textbf{Hello, World! in C}}{atomic-program-18}{}%
\begin{program}{C}{0}{1}{0}
/* Hello World program */
...
\end{program}
\end{listingptx}%
\begin{listingptx}{Listing}{\textbf{A console session on a Raspberry Pi}}{atomic-program-19}{}%
\begin{console}{0}{1}{0}
pi@raspberrypi ~/progs/chap02 $ (*\consoleinput{gcc -Wall -o intAndFloat intAndFloat.c}*)
pi@raspberrypi ~/progs/chap02 $ (*\consoleinput{./intAndFloat}*)
The integer is 19088743 and the float is 19088.742188
...
\begin{listingptx}{Listing}{\textbf{Hello, World! in C}}{atomic-program-21}{}%
...
\end{program}
\end{listingptx}%
\begin{listingptx}{Listing}{\textbf{A console session on a Raspberry Pi}}{atomic-program-22}{}%
...
\begin{panellistingptx}{Listing}{\textbf{Hello!}}{atomic-program-28-1}{}%
\begin{program}{C}{0}{1}{0}
/* Hello World program */
...
\begin{panellistingptx}{Listing}{\textbf{Raspberry Pi}}{atomic-program-28-2}{}%
\begin{console}{0}{1}{0}
...
\end{sidebyside}%
\par
And again, the two-panel \mono{<sidebyside>} of \mono{<listing>}, but now inside a \mono{<figure>} that has a number and a title.  And then the \mono{<listing>} are sub-numbered as (a) and (b).%
\begin{figureptx}{Figure}{Two Code Listings}{atomic-program-30}{}%
\begin{sidebyside}{2}{0}{0}{0.1}%
\begin{sbspanel}{0.35}[bottom]%
\begin{sublistingptx}{Listing}{\textbf{Hello!}}{atomic-program-30-2-1}{}%
\begin{program}{C}{0}{1}{0}
/* Hello World program */
...
\end{sbspanel}%
\begin{sbspanel}{0.55}[bottom]%
\begin{sublistingptx}{Listing}{\textbf{Raspberry Pi}}{atomic-program-30-2-2}{}%
\begin{console}{0}{1}{0}
$ (*\consoleinput{gcc -Wall -o intAndFloat intAndFloat.c}*)
$ (*\consoleinput{./intAndFloat}*)
The integer is 19088743 and the float is 19088.742188
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{\mono{<tabular>}}{}{\mono{<tabular>}}{}{}{atomic-tabular}
...
\typeout{************************************************}
%
\begin{sectionptx}{Section}{Advanced Numbering}{}{Advanced Numbering}{}{}{section-advanced-numbering}
\begin{introduction}{}%
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{One}{}{One}{}{}{section-advanced-numbering-3}
A document leaf.%
\begin{theorem}{Theorem}{First Theorem.}{Cauchy}{theorem-number-01}%
No statement.%
\end{theorem}
\begin{theorem}{Theorem}{Second Theorem.}{Bunyakovsky}{theorem-number-02}%
No statement.%
\end{theorem}
\end{subsectionptx}
%
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{Two}{}{Two}{}{}{section-advanced-numbering-4}
\begin{introduction}{}%
Further subdivided.%
\end{introduction}%
%
...
\typeout{************************************************}
%
\begin{subsubsectionptx}{Subsubsection}{Uno}{}{Uno}{}{}{section-advanced-numbering-4-3}
A document leaf.%
\begin{theorem}{Theorem}{First Theorem!}{Schwarz}{theorem-number-03}%
No statement.%
\end{theorem}
\begin{theorem}{Theorem}{Second Theorem?}{Inequality}{theorem-number-04}%
No statement.%
\end{theorem}
\end{subsubsectionptx}
%
...
\typeout{************************************************}
%
\begin{subsubsectionptx}{Subsubsection}{Dos}{}{Dos}{}{}{section-advanced-numbering-4-4}
A document leaf.%
\begin{theorem}{Theorem}{First Theorem?}{}{theorem-number-05}%
No statement.%
\end{theorem}
\begin{theorem}{Theorem}{Second Theorem!}{}{theorem-number-06}%
No statement.%
\end{theorem}
\end{subsubsectionptx}
\end{subsectionptx}
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{Three}{}{Three}{}{}{section-advanced-numbering-5}
A document leaf.%
\begin{theorem}{Theorem}{First Theorem.}{}{theorem-number-07}%
No statement.%
\end{theorem}
\begin{theorem}{Theorem}{Second Theorem.}{}{theorem-number-08}%
No statement.%
\end{theorem}
\end{subsectionptx}
%
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{Four}{}{Four}{}{}{section-advanced-numbering-6}
\begin{introduction}{}%
...
\begin{theorem}{Theorem}{Good Numbered Theorem One.}{}{theorem-good-one}%
No statement.%
\end{theorem}
\begin{theorem}{Theorem}{Good Numbered Theorem Two.}{}{theorem-good-two}%
No statement.%
\end{theorem}
\end{introduction}%
%
...
\typeout{************************************************}
%
\begin{subsubsectionptx}{Subsubsection}{Uno}{}{Uno}{}{}{section-advanced-numbering-6-3}
A document leaf.%
\begin{theorem}{Theorem}{First Theorem.}{}{theorem-number-09}%
No statement.%
\end{theorem}
\begin{theorem}{Theorem}{Second Theorem.}{}{theorem-number-10}%
No statement.%
\end{theorem}
\end{subsubsectionptx}
%
...
\typeout{************************************************}
%
\begin{subsubsectionptx}{Subsubsection}{Dos}{}{Dos}{}{}{section-advanced-numbering-6-4}
A document leaf.%
\begin{theorem}{Theorem}{First Theorem.}{}{theorem-number-11}%
No statement.%
\end{theorem}
\begin{theorem}{Theorem}{Second Theorem.}{}{theorem-number-12}%
No statement.%
\end{theorem}
\end{subsubsectionptx}
\begin{conclusion}{}%
Conclusion now.  We include two theorems as numbered items in the conclusion to test their numbers, which are sometimes totally illogical and are inconsistent across output formats.  To see the effect, set the level for numbering theorems to \mono{3}.  See this GitHub \href{https://github.com/PreTeXtBook/pretext/issues/139}{Issue \#139} for details.%
\begin{theorem}{Theorem}{Bad Numbered Theorem One.}{}{theorem-bad-one}%
No statement.%
\end{theorem}
\begin{theorem}{Theorem}{Bad Numbered Theorem Two.}{}{theorem-bad-two}%
No statement.%
\end{theorem}
\end{conclusion}%
\end{subsectionptx}
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{Five}{}{Five}{}{}{section-advanced-numbering-7}
A document leaf.%
\begin{theorem}{Theorem}{First Theorem.}{}{theorem-number-13}%
No statement.%
\end{theorem}
\begin{theorem}{Theorem}{Second Theorem.}{}{theorem-number-14}%
No statement.%
\end{theorem}
\end{subsectionptx}
%
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{Theorems in This Section}{}{Theorems in This Section}{}{}{subsection-local-theorems}
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{A Title with ] a Right Bracket}{}{A Title with ] a Right Bracket}{}{}{subsection-with-an-exercise}
...
\begin{inlineexercise}{Checkpoint}{A Right Brace \textbraceright{} and a Right Bracket].}{exercise-difficult-title}%
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{A Title with \textbraceright{} a Right Brace}{}{A Title with \textbraceright{} a Right Brace}{}{}{section-advanced-numbering-10}
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{A Title with \(a]b\) a Math Right Bracket}{}{A Title with \(a]b\) a Math Right Bracket}{}{}{section-advanced-numbering-11}
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{Just an Exercise}{}{Just an Exercise}{}{}{section-advanced-numbering-12}
\begin{inlineexercise}{Checkpoint}{An Extraneous Exercise.}{section-advanced-numbering-12-2}%
...
%
\typeout{************************************************}
\typeout{Solutions 31.11 Solutions}
\typeout{************************************************}
%
\begin{solutions-subsection}{Solutions}{Solutions}{}{Solutions}{}{}{section-advanced-numbering-13}
\begin{introduction}{}%
This is a \mono{<solutions>} division, which will be a peer of the other \mono{<subsection>} in this \mono{<section>}. The default behavior is to look to the parent division (a \mono{<section>} here) and collect all the hints, answers, and solutions from every \mono{<exercise>} (and friends) inside this containing division.  (There are just two, similar inline \mono{<exercise>}.)%
\par
But instead of the default, we employ a \mono{@scope} attribute to \emph{define} the parent division of the exercises whose solutions will be shown.  In this example we specify the  \mono{<subsection>} that is two back, the one which tests brackets in titles.%
\end{introduction}%
\par\medskip
\noindent\textbf{\normalsize{}31.7\space\textperiodcentered\space{}A Title with ] a Right Bracket}
\begin{inlinesolution}{Checkpoint}{31.19}{A Right Brace \textbraceright{} and a Right Bracket].}{exercise-difficult-title}%
\par\smallskip%
\noindent\hypertarget{exercise-difficult-title-3-main}{}A faux hint to get this exercise to migrate into a \mono{<solutions>}.%
\end{inlinesolution}%
...
\typeout{************************************************}
%
\begin{sectionptx}{Section}{Customizations}{}{Customizations}{}{}{section-customizations}
%
%
\typeout{************************************************}
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{Renaming Document Parts, Plus This Is A Really Long Title So That We Can Test How Well It Reacts To The Right Margin And Wraps Around To Form A Couple Of Lines, Plus How It Sits Relative To The Number Of The Subsection}{}{Renaming Document Parts, Plus This Is A Really Long Title So That We Can Test How Well It Reacts To The Right Margin And Wraps Around To Form A Couple Of Lines, Plus How It Sits Relative To The Number Of The Subsection}{}{}{rename-facility}
...
\begin{proposition}{Conundrum}{}{Smith}{proposition-as-conundrum}%
Aah, this \emph{is} confusing!%
\end{proposition}
\begin{paragraphs}{Important Notes.}{rename-facility-5}%
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{Customizing Phrases}{}{Customizing Phrases}{}{}{section-customizations-3}
...
\typeout{************************************************}
%
\begin{sectionptx}{Section}{MyOpenMath Interactive Problems}{}{MyOpenMath Interactive Problems}{}{}{section-myopenmath}
...
\begin{inlineexercise}{Checkpoint}{Negative Numbers and Exponents.}{section-myopenmath-3}%
...
\par
Try to evaluate \(\displaystyle-{\left(-{36}\right)}^{{-{1}{/}{2}}}\) without using a calculator. Enter your answer as an integer or reduced fraction (no decimals). Enter DNE if the number is not real.%
\par
The value is   %
\par\smallskip%
...
%
\end{inlineexercise}%
\begin{inlineexercise}{Checkpoint}{A Statistical Test.}{section-myopenmath-4}%
This is an introduction, providing articulation between the MOM problem and the contents of the text.  For example, you might cross-reference a result or example given previously.%
\par
You wish to determine if there is a negative linear correlation between the two variables at a significance level of \(\displaystyle\alpha={0.05}\). You have the following bivariate data set.%
\begin{center}%
{\tabularfont%
\begin{tabular}{ll}
x&y\tabularnewline[0pt]
79.4&-186.6\tabularnewline[0pt]
92.2&-186.3\tabularnewline[0pt]
55.6&88.3\tabularnewline[0pt]
86.4&-158.5\tabularnewline[0pt]
48&85.2\tabularnewline[0pt]
63.2&-399\tabularnewline[0pt]
70.1&-367.7\tabularnewline[0pt]
58.6&48.5\tabularnewline[0pt]
63.4&276.6\tabularnewline[0pt]
42.8&488.8\tabularnewline[0pt]
67.4&-128.4\tabularnewline[0pt]
74.5&-180.3\tabularnewline[0pt]
43.6&-38.7\tabularnewline[0pt]
80.8&427.3\tabularnewline[0pt]
75.8&350.8\tabularnewline[0pt]
73.8&-242.3\tabularnewline[0pt]
75.4&-48.6\tabularnewline[0pt]
79.9&551.4\tabularnewline[0pt]
61.3&8.5\tabularnewline[0pt]
50&-133.3\tabularnewline[0pt]
73.8&204.8\tabularnewline[0pt]
54.9&-55.6\tabularnewline[0pt]
69.3&573.7\tabularnewline[0pt]
56.9&-291.6\tabularnewline[0pt]
89.5&-221\tabularnewline[0pt]
70.6&2.1\tabularnewline[0pt]
42.4&66.4\tabularnewline[0pt]
56.6&-118.3\tabularnewline[0pt]
77.3&-32.9\tabularnewline[0pt]
39.8&107.2\tabularnewline[0pt]
45&342.9\tabularnewline[0pt]
61.7&-224.3\tabularnewline[0pt]
96.4&-76.1\tabularnewline[0pt]
55.2&24.1\tabularnewline[0pt]
77.7&-326.2\tabularnewline[0pt]
57.9&137.9\tabularnewline[0pt]
74.2&4.6\tabularnewline[0pt]
63.4&-48.6\tabularnewline[0pt]
67.9&147.6
\end{tabular}
}%
\end{center}%
download link provided here:  \href{denied:data:text/csv;charset=UTF-8,\%22x\%22\%2C\%22y\%22\%0A79.4\%2C-186.6\%0A92.2\%2C-186.3\%0A55.6\%2C88.3\%0A86.4\%2C-158.5\%0A48\%2C85.2\%0A63.2\%2C-399\%0A70.1\%2C-367.7\%0A58.6\%2C48.5\%0A63.4\%2C276.6\%0A42.8\%2C488.8\%0A67.4\%2C-128.4\%0A74.5\%2C-180.3\%0A43.6\%2C-38.7\%0A80.8\%2C427.3\%0A75.8\%2C350.8\%0A73.8\%2C-242.3\%0A75.4\%2C-48.6\%0A79.9\%2C551.4\%0A61.3\%2C8.5\%0A50\%2C-133.3\%0A73.8\%2C204.8\%0A54.9\%2C-55.6\%0A69.3\%2C573.7\%0A56.9\%2C-291.6\%0A89.5\%2C-221\%0A70.6\%2C2.1\%0A42.4\%2C66.4\%0A56.6\%2C-118.3\%0A77.3\%2C-32.9\%0A39.8\%2C107.2\%0A45\%2C342.9\%0A61.7\%2C-224.3\%0A96.4\%2C-76.1\%0A55.2\%2C24.1\%0A77.7\%2C-326.2\%0A57.9\%2C137.9\%0A74.2\%2C4.6\%0A63.4\%2C-48.6\%0A67.9\%2C147.6}{Download CSV}%
\par
...
\item{}-0.183%
\item{}0.1318%
\item{}A: There is insufficient sample evidence to support the claim the there is a negative correlation between the two variables.%
\end{itemize}
%
\end{inlineexercise}%
\begin{inlineexercise}{Checkpoint}{With an image.}{section-myopenmath-5}%
This is an introduction, providing articulation between the MOM problem and the contents of the text.  For example, you might cross-reference a result or example given previously.%
\begin{image}{0.25}{0.5}{0.25}{}%
\includegraphics[width=\linewidth]{generated/problems/images/mom-2168-1.png}
\end{image}%
...
\begin{itemize}[label=\textbullet]
\item{}\(\displaystyle \displaystyle{y}={1}{x}+{0}\)%
\end{itemize}
%
\end{inlineexercise}%
\begin{inlineexercise}{Checkpoint}{Geometry of a Cone.}{section-myopenmath-6}%
...
\par
The right circular conical tank shown has height 4.00 m and top radius \(\displaystyle{1.20}\) m. It is filled with water to a height of \(\displaystyle{3.60}\) m. The cross section is a right triangle with height 4.00 m and top side \(\displaystyle{1.20}\) m. Inside is another right triangle with height \(\displaystyle{3.60}\) m.%
\begin{image}{0.3}{0.4}{0.3}{}%
\includegraphics[width=\linewidth]{generated/problems/images/mom-930582-1.pdf}
\end{image}%
\begin{image}{0.3}{0.4}{0.3}{}%
\includegraphics[width=\linewidth]{generated/problems/images/mom-930582-2.pdf}
\end{image}%
What is the volume of water?  m%
\par
How much water must be added to fill the tank?  \(\displaystyle\text{m}^{{3}}\)%
\par\smallskip%
\noindent\textbf{\blocktitlefont Solution}.\hypertarget{section-myopenmath-6-3}{}\quad{}%
\begin{itemize}[label=\textbullet]
\item{}4.4%
\item{}1.63%
\end{itemize}
...
\typeout{************************************************}
%
\begin{sectionptx}{Section}{Ancillaries}{}{Ancillaries}{}{}{section-ancillaries}
...
\begin{introduction}{About Worksheets.}%
...
%
\typeout{************************************************}
\typeout{Worksheet 35.1 A Geometric Prelude (without authored pages)}
\typeout{************************************************}
%
...
\par\smallskip%
\noindent\textbf{\blocktitlefont Hint}.\hypertarget{exercise-vector-addition-2}{}\quad{}Use \hyperlink{ex-cyclic}{Worksheet Exercise~{\xreffont 35.1.1}}.%
\end{divisionexercise}%
\end{sbspanel}%
\begin{sbspanel}{0.6}%
...
If you have time, try to devise a vector proof of Euclid's result presented at the beginning of the workshop. Recall that a \terminology{parallelogram} is a four-sided polygon whose opposite sides are parallel.%
\end{divisionexercise}%
\begin{conclusion}{Wrap-up.}%
...
%
\typeout{************************************************}
\typeout{Worksheet 35.2 A Geometric Prelude (with authored pages)}
\typeout{************************************************}
%
\newgeometry{left=0.75in, right=0.75in, top=0.75in, bottom=0.75in}
...
Show that \(\vec{M}_{1} + \vec{M}_{2} + \vec{M}_{3} = 0\).%
\par\smallskip%
\noindent\textbf{\blocktitlefont Hint}.\hypertarget{exercise-vector-addition-pages-2}{}\quad{}Use \hyperlink{ex-cyclic}{Worksheet Exercise~{\xreffont 35.1.1}}.%
\end{divisionexercise}%
\end{sbspanel}%
\begin{sbspanel}{0.6}%
...
%
\typeout{************************************************}
\typeout{Worksheet 35.3 Networks Worksheet (no authored pages)}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Worksheet 35.4 Networks Worksheet (with authored pages)}
\typeout{************************************************}
%
\newgeometry{left=0.75in, right=0.75in, top=3cm, bottom=1.2in}
...
%
\typeout{************************************************}
\typeout{Worksheet 35.5 Worksheet}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Worksheet 35.6 Dot products and projection}
\typeout{************************************************}
%
\newgeometry{left=0.75in, right=0.75in, top=0.75in, bottom=0.75in}
...
\par\rule{\workspacestrutwidth}{1.0in}%
\item{}\(\lVert{\vec v}_1\rVert = \fillinmath{XXX}\)%
\par\rule{\workspacestrutwidth}{1in}%
\item{}\(\lVert{\vec v}_4\rVert = \fillinmath{XXX}\)%
\par\rule{\workspacestrutwidth}{1in}%
\item{}Are any of these vectors perpendicular to each other? \fillintext{10}%
\par\rule{\workspacestrutwidth}{1in}%
\end{enumerate}%
\end{divisionexercise}%
\end{sbspanel}%
...
\noindent\includegraphics[width=\linewidth]{external/images/projection1.png}
\end{divisionexercise}%
\end{sbspanel}%
\end{sidebyside}%
...
%
\typeout{************************************************}
\typeout{Worksheet 35.7 Worksheet}
\typeout{************************************************}
%
\newgeometry{left=0.75in, right=0.75in, top=0.75in, bottom=0.75in}
...
%
\typeout{************************************************}
\typeout{Worksheet 35.8 Worksheet}
\typeout{************************************************}
%
\newgeometry{left=0.75in, right=0.75in, top=0.75in, bottom=0.75in}
...
%
\typeout{************************************************}
\typeout{Worksheet 35.9 Worksheet}
\typeout{************************************************}
%
\newgeometry{left=1cm, right=1cm, top=1cm, bottom=1cm}
\begin{worksheet-subsection}{Worksheet}{Worksheet}{}{Worksheet}{}{}{worksheet-exercisegroup}
\begin{introduction}{}%
This is a mock worksheet for testing the use of \mono{@workspace} for \mono{<exercise>} within an \mono{<exercisegroup>}.%
\end{introduction}%
\par\medskip\noindent%
\textbf{Exercise Group.}\space\space%
Do things to the following.%
\begin{exercisegroupcol}{2}
\begin{divisionexerciseegcol}{1}{}{1in}{worksheet-exercisegroup-2-2}%
Apple%
\end{divisionexerciseegcol}%
\begin{divisionexerciseegcol}{2}{}{1in}{worksheet-exercisegroup-2-3}%
Banana%
\end{divisionexerciseegcol}%
\begin{divisionexerciseegcol}{3}{}{1in}{worksheet-exercisegroup-2-4}%
Cherry%
\end{divisionexerciseegcol}%
\begin{divisionexerciseegcol}{4}{}{1in}{worksheet-exercisegroup-2-5}%
Durian%
\end{divisionexerciseegcol}%
\begin{divisionexerciseegcol}{5}{}{2in}{worksheet-exercisegroup-2-6}%
Elderberry (with workspace override)%
\end{divisionexerciseegcol}%
\begin{divisionexerciseegcol}{6}{}{1in}{worksheet-exercisegroup-2-7}%
Fig%
\end{divisionexerciseegcol}%
\begin{divisionexerciseegcol}{7}{}{1in}{worksheet-exercisegroup-2-8}%
Guava%
\end{divisionexerciseegcol}%
\begin{divisionexerciseegcol}{8}{}{1in}{worksheet-exercisegroup-2-9}%
Habanero%
\end{divisionexerciseegcol}%
\begin{divisionexerciseegcol}{9}{}{1in}{worksheet-exercisegroup-2-10}%
I can't think of an ``I'' fruit.%
\end{divisionexerciseegcol}%
\begin{divisionexerciseegcol}{10}{}{1in}{worksheet-exercisegroup-2-11}%
Jackfruit%
\end{divisionexerciseegcol}%
\end{exercisegroupcol}
\par\medskip\noindent
...
\begin{exercisegroup}
\begin{divisionexerciseeg}{11}{}{0.25in}{worksheet-exercisegroup-3-2}%
Apple%
\end{divisionexerciseeg}%
\begin{divisionexerciseeg}{12}{}{0.25in}{worksheet-exercisegroup-3-3}%
Banana%
\end{divisionexerciseeg}%
\begin{divisionexerciseeg}{13}{}{0.25in}{worksheet-exercisegroup-3-4}%
Cherry%
\end{divisionexerciseeg}%
\begin{divisionexerciseeg}{14}{}{0.25in}{worksheet-exercisegroup-3-5}%
Durian%
\end{divisionexerciseeg}%
\begin{divisionexerciseeg}{15}{}{2in}{worksheet-exercisegroup-3-6}%
Elderberry (with workspace override)%
\end{divisionexerciseeg}%
\begin{divisionexerciseeg}{16}{}{0.25in}{worksheet-exercisegroup-3-7}%
Fig%
\end{divisionexerciseeg}%
\begin{divisionexerciseeg}{17}{}{0.25in}{worksheet-exercisegroup-3-8}%
Guava%
\end{divisionexerciseeg}%
\begin{divisionexerciseeg}{18}{}{0.25in}{worksheet-exercisegroup-3-9}%
Habanero%
\end{divisionexerciseeg}%
\begin{divisionexerciseeg}{19}{}{0.25in}{worksheet-exercisegroup-3-10}%
I can't think of an ``I'' fruit.%
\end{divisionexerciseeg}%
\begin{divisionexerciseeg}{20}{}{0.25in}{worksheet-exercisegroup-3-11}%
Jackfruit%
\end{divisionexerciseeg}%
\end{exercisegroup}
\par\medskip\noindent
...
%
\typeout{************************************************}
\typeout{Section 36 Handouts}
\typeout{************************************************}
%
\begin{sectionptx}{Section}{Handouts}{}{Handouts}{}{}{section-handouts}
\begin{introduction}{About Handouts.}%
Like worksheets, a \terminology{handout} is a division that is inteded to be printed for use in a classroom. In HTML output, you get the same print preview and page layout as you do with worksheets; in PDF, these will start on a new page with possibly different margins than the rest of the document.%
\par
...
%
\typeout{************************************************}
\typeout{Handout 36.1 Derivative Rules}
\typeout{************************************************}
%
\newgeometry{left=0.75in, right=0.75in, top=0.75in, bottom=0.75in}
...
%
\begin{descriptionlist}
\begin{dlimedium}{Constant functions}{handout-derivative-rules-2-1-2-1}%
\(\displaystyle (k)' = 0\)%
\end{dlimedium}%
\begin{dlimedium}{Power functions}{handout-derivative-rules-2-1-2-2}%
\(\displaystyle (x^{n})' = nx^{n-1}\)%
\end{dlimedium}%
\begin{dlimedium}{Exponential functions}{handout-derivative-rules-2-1-2-3}%
\((a^{x})' = \ln(a) a^{x} \text{ (for } a>0\text{)}\)%
\par
\((e^{x})' = e^{x}\)%
\end{dlimedium}%
\begin{dlimedium}{Logarithmic functions}{handout-derivative-rules-2-1-2-4}%
\(\displaystyle (\ln(x))' = \frac{1}{x}\)%
\end{dlimedium}%
\begin{dlimedium}{Trigonometric functions}{handout-derivative-rules-2-1-2-5}%
\((\sin(x))' = \cos(x)\).%
\par
\((\cos(x))' = -\sin(x)\).%
\par
...
%
\begin{descriptionlist}
\begin{dlimedium}{Constant multiples}{handout-derivative-rules-2-2-2-1}%
\(\displaystyle (k\cdot f(x))' = k\cdot f'(x)\)%
\end{dlimedium}%
\begin{dlimedium}{Sum and difference}{handout-derivative-rules-2-2-2-2}%
\(\displaystyle (f(x) \pm g(x))' = f'(x) \pm g'(x)\)%
\end{dlimedium}%
\begin{dlimedium}{Products (the product rule)}{handout-derivative-rules-2-2-2-3}%
\(\displaystyle (f(x)\cdot g(x))' = f'(x)g(x) + f(x)g'(x)\)%
\end{dlimedium}%
\begin{dlimedium}{Quotients (the quotient rule)}{handout-derivative-rules-2-2-2-4}%
\(\displaystyle \left(\frac{f(x)}{g(x)}\right)' = \frac{f'(x)g(x) - f(x)g'(x)}{(g(x))^{2}}\)%
\end{dlimedium}%
\begin{dlimedium}{Compositions (the chain rule)}{handout-derivative-rules-2-2-2-5}%
...
%
\typeout{************************************************}
\typeout{Handout 36.2 Guided Notes: Derivatives of sums}
\typeout{************************************************}
%
\newgeometry{left=0.75in, right=0.75in, top=0.75in, bottom=0.75in}
...
\par\rule{\workspacestrutwidth}{.75in}%
\end{definition}
...
%
\typeout{************************************************}
\typeout{Section 37 Exercises, One Subsection}
\typeout{************************************************}
%
\begin{sectionptx}{Section}{Exercises, One Subsection}{}{Exercises, One Subsection}{}{}{section-exercises-single}
This \mono{<section>} of the sample article demonstrates an ``unstructured division.''  There are no \mono{<subsection>}, you are just reading the first two paragraphs, followed by some nonsense text.  Then there is a \emph{single} \mono{<exercises>} division.  Note that this division is not numbered (since it is unique within the \mono{<section>}).  And a cross-reference to one of the contained \mono{<exercise>} will be numbered as a member of the \mono{<section>}, \hyperlink{exercise-challenging-one-unstructured}{Exercise~{\xreffont 37.4}}.%
\par
If you use the unstructured form of a division, \emph{and} have both inline and divisional exercises, there is a potential to form ambiguous cross-references.  To wit, check that \hyperref[duplicate-inline]{{\xreffont\ref{duplicate-inline}}} and \hyperlink{duplicate-divisional}{{\xreffont 37.2}} are really different exercises (which you are \emph{unable to do} if you are reading this in print!).  The solution is to include the type of exercise in the reference, which will assist everybody, but especially your print readers:  \hyperref[duplicate-inline]{Checkpoint~{\xreffont\ref{duplicate-inline}}} and \hyperlink{duplicate-divisional}{Exercise~{\xreffont 37.2}}.%
\par
Compare this section with the similar \hyperref[section-exercises-multiple]{Section~{\xreffont\ref{section-exercises-multiple}}}, next.  The following text is mostly nonsense, just for testing purposes.%
...
%
\typeout{************************************************}
\typeout{Exercises 37 Exercise Collection}
\typeout{************************************************}
%
...
\begin{figureptx}{Figure}{A figure in an \mono{<exercise>} in an \emph{unstructured} division to test that it is numbered as if the containing \mono{<exercises>} is not present}{exercise-collection-2-2-2}{}%
\begin{image}{0.45}{0.1}{0.45}{}%
\includegraphics[width=\linewidth]{external/images/cross-square.png}
\end{image}%
\tcblower
\end{figureptx}%
\begin{figureptx}{Figure}{A side-by-side in a figure in an \mono{<exercise>} in an \emph{unstructured} division to test that it is numbered as if the containing \mono{<exercises>} is not present and to test the numbering of the panels in a solutions manual}{exercise-collection-2-2-3}{}%
...
\begin{figureptx}{Figure}{Testing numbering, figure in a \mono{<exercise>} in an un-numbered \mono{<exercises>}}{duplicate-divisional-2-2}{}%
\begin{image}{0.4}{0.2}{0.4}{}%
\includegraphics[width=\linewidth]{external/images/cross-square.png}
\end{image}%
\tcblower
...
\par\medskip\noindent%
\textbf{Exercise Group.}\space\space%
An introduction to an \mono{exercisegroup}.  This is here to attempt to interrupt the flow of the counting from this division to the next.%
\begin{exercisegroup}
...
%
\typeout{************************************************}
\typeout{References 37 More Reading}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Exercises 38 Exercise Section, Structured}
\typeout{************************************************}
%
\begin{exercises-section}{Exercises}{Exercise Section, Structured}{}{Exercise Section, Structured}{}{}{exercises-structured}
\begin{introduction}{}%
A collection of exercises, in a top-level \mono{<exercises>} division, structured with \mono{<subexercises>}.%
\end{introduction}%
...
%
\typeout{************************************************}
\typeout{Section 39 Exercises, Multiple Subsections}
\typeout{************************************************}
%
\begin{sectionptx}{Section}{Exercises, Multiple Subsections}{}{Exercises, Multiple Subsections}{}{}{section-exercises-multiple}
\begin{introduction}{}%
This \mono{<section>} of the sample article demonstrates a ``structured division.''  You are reading the introduction to the division, then there is a faux \mono{<subsection>}, followed by three \mono{<exercises>} divisions.  Note that the three are numbered as if they are also fellow\mono{<subsection>}.  And a cross-reference to one of the contained \mono{<exercise>} will be numbered use the number of the \mono{<subsection>}, \hyperlink{exercise-challenging-one-structured}{Exercise~{\xreffont 39.3.1}}.%
\par
Compare this section with the similar \hyperref[section-exercises-single]{Section~{\xreffont\ref{section-exercises-single}}}, previous.  The following text is mostly nonsense, just for testing purposes.%
\end{introduction}%
%
%
\typeout{************************************************}
\typeout{Subsection 39.1 Faux Subsection}
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{Faux Subsection}{}{Faux Subsection}{}{}{section-exercises-multiple-3}
\begin{inlineexercise}{Checkpoint}{Inline One.}{section-exercises-multiple-3-2}%
Aliquam vitae risus placerat, pellentesque leo vitae, iaculis ante. Praesent ac odio eget mi bibendum eleifend ac eget metus. Morbi in dolor et diam accumsan mattis. Aenean elementum pulvinar efficitur. Etiam viverra ut tellus quis consequat. Phasellus sit amet nisl a ligula pharetra tempus id in elit. Maecenas congue quam eu purus fermentum pretium. Fusce pellentesque ultricies arcu, egestas sollicitudin erat condimentum non. Integer non velit at dolor dictum aliquam et rhoncus mauris. Sed nec nibh id nunc convallis tincidunt ut at ligula. Etiam elementum nisl eu erat dapibus rhoncus.%
\end{inlineexercise}%
Pellentesque nec condimentum ligula, quis interdum mauris. Ut sed urna lacinia, aliquam arcu id, faucibus nisi. Suspendisse potenti. Curabitur in erat ultricies, condimentum mi nec, vehicula mauris. Duis faucibus risus fermentum velit hendrerit, non laoreet massa maximus. Donec bibendum elit ac lectus lobortis luctus. Ut finibus, dolor ut euismod tristique, ligula tortor tempus arcu, finibus semper purus erat ut ligula. Aenean accumsan ut ante vel euismod.%
\begin{inlineexercise}{Checkpoint}{Inline Two.}{section-exercises-multiple-3-4}%
Ut porttitor neque a pharetra euismod. Vivamus ut metus pretium, placerat massa tempor, condimentum metus. Phasellus vestibulum iaculis turpis non posuere. Vestibulum quis aliquet neque. Donec nec metus iaculis, laoreet massa vitae, suscipit tellus. Etiam et ultrices quam, quis pretium ligula. In ut cursus metus. Aenean volutpat quam odio, quis tempus dolor egestas eget. Nunc fringilla lobortis nunc, ut interdum lorem posuere sed. Sed sodales risus a laoreet venenatis. Nunc sodales tempor mollis. Nam sollicitudin velit sed ex viverra feugiat. Nunc consectetur mi vitae urna sollicitudin malesuada. Fusce eget risus lectus. Mauris augue velit, vestibulum vitae tempus sit amet, porttitor eget turpis.%
\end{inlineexercise}%
\begin{theorem}{Theorem}{Major Result.}{}{section-exercises-multiple-3-5}%
Vivamus tortor tortor, lobortis et sem vel, accumsan placerat libero. Sed eget metus non magna accumsan efficitur a non turpis. Curabitur maximus arcu ipsum, eget vestibulum nulla mollis ac. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Duis vel eleifend risus. Morbi hendrerit tellus eget nibh imperdiet, ac mollis nisl sagittis. Ut commodo pharetra leo. Suspendisse consequat velit eget velit condimentum feugiat.%
\end{theorem}
\begin{inlineexercise}{Checkpoint}{Inline Three.}{exercise-duplicate-inline}%
Suspendisse lacinia mattis risus, eget viverra urna dictum eu. Maecenas ut sem in turpis egestas varius nec at ipsum. Praesent bibendum nisi et turpis congue, a pellentesque felis tempor. Vivamus non dolor in risus interdum mattis. In tempus iaculis velit, sit amet rhoncus tellus aliquam convallis. Sed ut tellus id ipsum blandit convallis sed eget tortor. Nunc leo felis, scelerisque vel ante porta, volutpat rhoncus neque. Mauris convallis, felis at aliquam aliquet, felis ipsum semper mi, vitae auctor purus ante non erat. Ut nec felis mi.%
\end{inlineexercise}%
\end{subsectionptx}
%
%
\typeout{************************************************}
\typeout{Exercises 39.2 Drill Exercises}
\typeout{************************************************}
%
\begin{exercises-subsection}{Exercises}{Drill Exercises}{}{Drill Exercises}{}{}{exercises-drill}
\begin{divisionexercise}{1}{Drill One.}{}{exercises-drill-2}%
Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras congue urna nulla. Aliquam eget euismod tellus. Maecenas nibh libero, venenatis a laoreet in, tempor sit amet sem. Morbi sit amet justo tempor velit auctor placerat. Maecenas nec lobortis orci. Aenean dictum enim lacus, ac blandit lacus elementum nec. Mauris porttitor neque volutpat tincidunt sollicitudin. Cras porta lectus ac facilisis tempor. Suspendisse in velit nisl. Sed convallis leo at nunc aliquet fermentum. Pellentesque feugiat at ex sed elementum. In porta vulputate ipsum sit amet consectetur.%
\begin{figureptx}{Figure}{A figure in an \mono{<exercise>} in a \emph{structured} division to test that it is numbered with consideration of the containing \mono{<exercises>}}{exercises-drill-2-2-2}{}%
\begin{image}{0.45}{0.1}{0.45}{}%
\includegraphics[width=\linewidth]{external/images/cross-square.png}
\end{image}%
\tcblower
\end{figureptx}%
\end{divisionexercise}%
\begin{divisionexercise}{2}{Drill Two.}{}{exercises-drill-3}%
Aliquam sagittis ex at magna porttitor, quis scelerisque ligula malesuada. Vestibulum vitae mauris id nisi pretium ornare a id lectus. Nam suscipit magna id sem ultricies vestibulum. Nulla facilisi. Duis venenatis lectus massa, ac mollis nisi suscipit non. Sed et sapien vulputate, imperdiet nibh vel, lobortis nisl. Curabitur sagittis justo nibh. Nulla vulputate sodales justo at efficitur. Cras justo augue, mollis vitae nulla sed, vestibulum tincidunt ante. Vestibulum et lorem lectus. Maecenas accumsan lacus a nisi euismod rutrum eu dapibus justo. Etiam scelerisque a odio a euismod. Pellentesque vestibulum pellentesque nisi, a tempus erat cursus ac. Morbi ut auctor lectus.%
\end{divisionexercise}%
\begin{divisionexercise}{3}{Drill Three.}{}{exercises-drill-4}%
Nam congue ex nec justo iaculis maximus. Vestibulum lobortis magna sed urna auctor, vel dignissim massa posuere. In sed venenatis elit. Vivamus congue gravida tempus. Nunc quis fermentum nisi. Nullam hendrerit lorem et tellus semper, sit amet scelerisque purus lobortis. Quisque sollicitudin quis neque eu suscipit. Praesent volutpat justo quis magna vehicula molestie.%
\end{divisionexercise}%
\end{exercises-subsection}
%
%
\typeout{************************************************}
\typeout{Exercises 39.3 Challenging Exercises}
\typeout{************************************************}
%
\begin{exercises-subsection}{Exercises}{Challenging Exercises}{}{Challenging Exercises}{}{}{section-exercises-multiple-5}
\begin{divisionexercise}{1}{Challenging One.}{}{exercise-challenging-one-structured}%
Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras congue urna nulla. Aliquam eget euismod tellus. Maecenas nibh libero, venenatis a laoreet in, tempor sit amet sem. Morbi sit amet justo tempor velit auctor placerat. Maecenas nec lobortis orci. Aenean dictum enim lacus, ac blandit lacus elementum nec. Mauris porttitor neque volutpat tincidunt sollicitudin. Cras porta lectus ac facilisis tempor. Suspendisse in velit nisl. Sed convallis leo at nunc aliquet fermentum. Pellentesque feugiat at ex sed elementum. In porta vulputate ipsum sit amet consectetur.%
\end{divisionexercise}%
\par\medskip\noindent%
\textbf{Exercise Group.}\space\space%
An introduction to an \mono{exercisegroup}.  This is here to attempt to interrupt the flow of the counting from this division to the next.%
\begin{exercisegroup}
\begin{divisionexerciseeg}{2}{Challenging Two.}{}{section-exercises-multiple-5-3-2}%
Aliquam sagittis ex at magna porttitor, quis scelerisque ligula malesuada. Vestibulum vitae mauris id nisi pretium ornare a id lectus. Nam suscipit magna id sem ultricies vestibulum. Nulla facilisi. Duis venenatis lectus massa, ac mollis nisi suscipit non. Sed et sapien vulputate, imperdiet nibh vel, lobortis nisl. Curabitur sagittis justo nibh.%
\par
Nulla vulputate sodales justo at efficitur. Cras justo augue, mollis vitae nulla sed, vestibulum tincidunt ante. Vestibulum et lorem lectus. Maecenas accumsan lacus a nisi euismod rutrum eu dapibus justo. Etiam scelerisque a odio a euismod. Pellentesque vestibulum pellentesque nisi, a tempus erat cursus ac. Morbi ut auctor lectus.%
\end{divisionexerciseeg}%
\begin{divisionexerciseeg}{3}{Challenging Three.}{}{section-exercises-multiple-5-3-3}%
Nam congue ex nec justo iaculis maximus. Vestibulum lobortis magna sed urna auctor, vel dignissim massa posuere. In sed venenatis elit. Vivamus congue gravida tempus. Nunc quis fermentum nisi. Nullam hendrerit lorem et tellus semper, sit amet scelerisque purus lobortis. Quisque sollicitudin quis neque eu suscipit. Praesent volutpat justo quis magna vehicula molestie.%
\end{divisionexerciseeg}%
\end{exercisegroup}
\par\medskip\noindent
...
%
\typeout{************************************************}
\typeout{Exercises 39.4 Impossible Exercises}
\typeout{************************************************}
%
\begin{exercises-subsection}{Exercises}{Impossible Exercises}{}{Impossible Exercises}{}{}{section-exercises-multiple-6}
\begin{divisionexercise}{1}{Impossible One.}{}{section-exercises-multiple-6-2}%
Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras congue urna nulla. Aliquam eget euismod tellus. Maecenas nibh libero, venenatis a laoreet in, tempor sit amet sem. Morbi sit amet justo tempor velit auctor placerat. Maecenas nec lobortis orci. Aenean dictum enim lacus, ac blandit lacus elementum nec. Mauris porttitor neque volutpat tincidunt sollicitudin. Cras porta lectus ac facilisis tempor. Suspendisse in velit nisl. Sed convallis leo at nunc aliquet fermentum. Pellentesque feugiat at ex sed elementum. In porta vulputate ipsum sit amet consectetur.%
\end{divisionexercise}%
\begin{divisionexercise}{2}{Impossible Two.}{}{section-exercises-multiple-6-3}%
Aliquam sagittis ex at magna porttitor, quis scelerisque ligula malesuada. Vestibulum vitae mauris id nisi pretium ornare a id lectus. Nam suscipit magna id sem ultricies vestibulum. Nulla facilisi. Duis venenatis lectus massa, ac mollis nisi suscipit non. Sed et sapien vulputate, imperdiet nibh vel, lobortis nisl. Curabitur sagittis justo nibh. Nulla vulputate sodales justo at efficitur. Cras justo augue, mollis vitae nulla sed, vestibulum tincidunt ante. Vestibulum et lorem lectus. Maecenas accumsan lacus a nisi euismod rutrum eu dapibus justo. Etiam scelerisque a odio a euismod. Pellentesque vestibulum pellentesque nisi, a tempus erat cursus ac. Morbi ut auctor lectus.%
\end{divisionexercise}%
\begin{divisionexercise}{3}{Impossible Three.}{}{section-exercises-multiple-6-4}%
Nam congue ex nec justo iaculis maximus. Vestibulum lobortis magna sed urna auctor, vel dignissim massa posuere. In sed venenatis elit. Vivamus congue gravida tempus. Nunc quis fermentum nisi. Nullam hendrerit lorem et tellus semper, sit amet scelerisque purus lobortis. Quisque sollicitudin quis neque eu suscipit. Praesent volutpat justo quis magna vehicula molestie.%
\end{divisionexercise}%
\end{exercises-subsection}
%
%
\typeout{************************************************}
\typeout{Exercises 39.5 Layout challenge}
\typeout{************************************************}
%
\begin{exercises-subsection}{Exercises}{Layout challenge}{}{Layout challenge}{}{}{section-exercises-multiple-7}
\par\medskip\noindent%
\textbf{Exercise Group.}\space\space%
...
\begin{exercisegroupcol}{2}
\begin{divisionexerciseegcol}{1}{}{}{section-exercises-multiple-7-2-2}%
%
\begin{alignat*}{3}
2x \amp {}+{} \amp  y \amp {}={} \amp 10\\
x  \amp       \amp    \amp {}={} \amp 6\\
x  \amp {}+{} \amp 3y \amp {}={} \amp 13
\end{alignat*}
\end{divisionexerciseegcol}%
\begin{divisionexerciseegcol}{2}{}{}{section-exercises-multiple-7-2-3}%
%
\begin{alignat*}{3}
2x \amp {}+{} \amp  y \amp {}={} \amp 10\\
x  \amp       \amp    \amp {}={} \amp 6\\
...
\end{alignat*}
\end{divisionexerciseegcol}%
\begin{divisionexerciseegcol}{3}{}{}{section-exercises-multiple-7-2-4}%
%
\begin{alignat*}{3}
2x \amp {}+{} \amp  y \amp {}={} \amp 10\\
x  \amp       \amp    \amp {}={} \amp 6\\
...
\end{alignat*}
\end{divisionexerciseegcol}%
\begin{divisionexerciseegcol}{4}{}{}{section-exercises-multiple-7-2-5}%
%
\begin{alignat*}{3}
2x \amp {}+{} \amp  y \amp {}={} \amp 10\\
x  \amp       \amp    \amp {}={} \amp 6\\
...
\end{alignat*}
\par\smallskip%
\noindent\textbf{\blocktitlefont Hint} (OPEN ME!).\hypertarget{section-exercises-multiple-7-2-5-2}{}\quad{}%
\begin{alignat*}{5}
3u \amp {}+{} 1v \amp {}+{} 3w \amp {}+{} 2x \amp {}+{} \amp  y \amp {}+{} \amp 3z \amp {}={} \amp 10\\
2u \amp {}+{} 2v \amp {}-{} 2w \amp {}+{} x  \amp       \amp    \amp {}+{} \amp  z \amp {}={} \amp 6\\
1u \amp {}-{} 3v \amp {}+{} 1w \amp {}+{} x  \amp {}+{} \amp 3y \amp {}+{} \amp 2z \amp {}={} \amp 13
\end{alignat*}
\end{divisionexerciseegcol}%
\begin{divisionexerciseegcol}{5}{}{}{section-exercises-multiple-7-2-6}%
%
\begin{alignat*}{6}
200t \amp {}+{} 3u \amp {}+{} 1v \amp {}+{} 3w \amp {}+{} 2x \amp {}+{} \amp  y \amp {}+{} \amp 3z \amp {}={} \amp 10\\
\amp {}+{} 2u \amp {}+{} 2v \amp {}-{} 2w \amp {}+{} x  \amp       \amp    \amp {}+{} \amp  z \amp {}={} \amp 6\\
100t \amp {}+{} 1u \amp {}-{} 3v \amp {}+{} 1w \amp {}+{} x  \amp {}+{} \amp 3y \amp {}+{} \amp 2z \amp {}={} \amp 13
\end{alignat*}
\end{divisionexerciseegcol}%
\begin{divisionexerciseegcol}{6}{}{}{section-exercises-multiple-7-2-7}%
%
\begin{alignat*}{3}
2x \amp {}+{} \amp  y \amp {}={} \amp 10\\
x  \amp       \amp    \amp {}={} \amp 6\\
...
\end{alignat*}
\end{divisionexerciseegcol}%
\begin{divisionexerciseegcol}{7}{}{}{section-exercises-multiple-7-2-8}%
%
\begin{alignat*}{3}
2x \amp {}+{} \amp  y \amp {}={} \amp 10\\
x  \amp       \amp    \amp {}={} \amp 6\\
...
%
\typeout{************************************************}
\typeout{References 39.6 More Reading}
\typeout{************************************************}
%
\begin{references-subsection}{References}{More Reading}{}{More Reading}{}{}{section-exercises-multiple-8}
\begin{introduction}{}%
Left intentionally blank, just checking sectioning.%
\end{introduction}%
%% If this is a top-level references
...
%%   with a standard "thebibliography" environment
\begin{referencelist}
\bibitem[1]{biblio-lay-article-repeat1}\hypertarget{biblio-lay-article-repeat1}{}David C. Lay, \textit{Subspaces and Echelon Forms}. The College Mathematics Journal, January 1993, \textbf{24} no.\@\,1, 57\textendash{}62.
\end{referencelist}
\end{references-subsection}
\end{sectionptx}
%
%
\typeout{************************************************}
\typeout{Exercises 40 Exercises, Top-Level}
\typeout{************************************************}
%
\begin{exercises-section}{Exercises}{Exercises, Top-Level}{}{Exercises, Top-Level}{}{}{exercises-top-level}
\begin{introduction}{}%
%
\par
This \mono{<exercises>} of the sample article is a peer of all the preceding \mono{<section>} and is the only such \mono{<exercises>}.  As such, it is not numbered, and contains only \mono{<exercise>}, but for this \mono{<introduction>} you are reading.  The \mono{<exercises>} contained within will be numbered in cross-references according to the enclosing division, in this case the entire article and so without any qualification, to wit, \hyperlink{exercise-challenging-one-top}{Exercise~{\xreffont 40.4}}.%
\end{introduction}%
\begin{divisionexercise}{1}{Drill One.}{}{exercises-top-level-3}%
Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras congue urna nulla. Aliquam eget euismod tellus. Maecenas nibh libero, venenatis a laoreet in, tempor sit amet sem. Morbi sit amet justo tempor velit auctor placerat. Maecenas nec lobortis orci. Aenean dictum enim lacus, ac blandit lacus elementum nec. Mauris porttitor neque volutpat tincidunt sollicitudin. Cras porta lectus ac facilisis tempor. Suspendisse in velit nisl. Sed convallis leo at nunc aliquet fermentum. Pellentesque feugiat at ex sed elementum. In porta vulputate ipsum sit amet consectetur.%
\end{divisionexercise}%
\begin{divisionexercise}{2}{Drill Two.}{}{exercises-top-level-4}%
Aliquam sagittis ex at magna porttitor, quis scelerisque ligula malesuada. Vestibulum vitae mauris id nisi pretium ornare a id lectus. Nam suscipit magna id sem ultricies vestibulum. Nulla facilisi. Duis venenatis lectus massa, ac mollis nisi suscipit non. Sed et sapien vulputate, imperdiet nibh vel, lobortis nisl. Curabitur sagittis justo nibh. Nulla vulputate sodales justo at efficitur. Cras justo augue, mollis vitae nulla sed, vestibulum tincidunt ante. Vestibulum et lorem lectus. Maecenas accumsan lacus a nisi euismod rutrum eu dapibus justo. Etiam scelerisque a odio a euismod. Pellentesque vestibulum pellentesque nisi, a tempus erat cursus ac. Morbi ut auctor lectus.%
\begin{figureptx}{Figure}{Testing numbering in a \mono{<exercises>} without a number}{exercises-top-level-4-2-2}{}%
\begin{image}{0.4}{0.2}{0.4}{}%
\includegraphics[width=\linewidth]{external/images/cross-square.png}
\end{image}%
\tcblower
\end{figureptx}%
\end{divisionexercise}%
\begin{divisionexercise}{3}{Drill Three.}{}{exercises-top-level-5}%
Nam congue ex nec justo iaculis maximus. Vestibulum lobortis magna sed urna auctor, vel dignissim massa posuere. In sed venenatis elit. Vivamus congue gravida tempus. Nunc quis fermentum nisi. Nullam hendrerit lorem et tellus semper, sit amet scelerisque purus lobortis. Quisque sollicitudin quis neque eu suscipit. Praesent volutpat justo quis magna vehicula molestie.%
\end{divisionexercise}%
\begin{divisionexercise}{4}{Challenging One.}{}{exercise-challenging-one-top}%
Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras congue urna nulla. Aliquam eget euismod tellus. Maecenas nibh libero, venenatis a laoreet in, tempor sit amet sem. Morbi sit amet justo tempor velit auctor placerat. Maecenas nec lobortis orci. Aenean dictum enim lacus, ac blandit lacus elementum nec. Mauris porttitor neque volutpat tincidunt sollicitudin. Cras porta lectus ac facilisis tempor. Suspendisse in velit nisl. Sed convallis leo at nunc aliquet fermentum. Pellentesque feugiat at ex sed elementum. In porta vulputate ipsum sit amet consectetur.%
\end{divisionexercise}%
\par\medskip\noindent%
\textbf{Exercise Group.}\space\space%
An introduction to an \mono{exercisegroup}.  This is here to attempt to interrupt the flow of the counting from this division to the next.%
\begin{exercisegroup}
\begin{divisionexerciseeg}{5}{Challenging Two.}{}{exercises-top-level-7-2}%
Aliquam sagittis ex at magna porttitor, quis scelerisque ligula malesuada. Vestibulum vitae mauris id nisi pretium ornare a id lectus. Nam suscipit magna id sem ultricies vestibulum. Nulla facilisi. Duis venenatis lectus massa, ac mollis nisi suscipit non. Sed et sapien vulputate, imperdiet nibh vel, lobortis nisl. Curabitur sagittis justo nibh.%
\par
Nulla vulputate sodales justo at efficitur. Cras justo augue, mollis vitae nulla sed, vestibulum tincidunt ante. Vestibulum et lorem lectus. Maecenas accumsan lacus a nisi euismod rutrum eu dapibus justo. Etiam scelerisque a odio a euismod. Pellentesque vestibulum pellentesque nisi, a tempus erat cursus ac. Morbi ut auctor lectus.%
\end{divisionexerciseeg}%
\begin{divisionexerciseeg}{6}{Challenging Three.}{}{exercises-top-level-7-3}%
Nam congue ex nec justo iaculis maximus. Vestibulum lobortis magna sed urna auctor, vel dignissim massa posuere. In sed venenatis elit. Vivamus congue gravida tempus. Nunc quis fermentum nisi. Nullam hendrerit lorem et tellus semper, sit amet scelerisque purus lobortis. Quisque sollicitudin quis neque eu suscipit. Praesent volutpat justo quis magna vehicula molestie.%
\end{divisionexerciseeg}%
\end{exercisegroup}
\par\medskip\noindent
\begin{divisionexercise}{7}{Impossible One.}{}{exercises-top-level-8}%
Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras congue urna nulla. Aliquam eget euismod tellus. Maecenas nibh libero, venenatis a laoreet in, tempor sit amet sem. Morbi sit amet justo tempor velit auctor placerat. Maecenas nec lobortis orci. Aenean dictum enim lacus, ac blandit lacus elementum nec. Mauris porttitor neque volutpat tincidunt sollicitudin. Cras porta lectus ac facilisis tempor. Suspendisse in velit nisl. Sed convallis leo at nunc aliquet fermentum. Pellentesque feugiat at ex sed elementum. In porta vulputate ipsum sit amet consectetur.%
\end{divisionexercise}%
\begin{divisionexercise}{8}{Impossible Two.}{}{exercises-top-level-9}%
Aliquam sagittis ex at magna porttitor, quis scelerisque ligula malesuada. Vestibulum vitae mauris id nisi pretium ornare a id lectus. Nam suscipit magna id sem ultricies vestibulum. Nulla facilisi. Duis venenatis lectus massa, ac mollis nisi suscipit non. Sed et sapien vulputate, imperdiet nibh vel, lobortis nisl. Curabitur sagittis justo nibh. Nulla vulputate sodales justo at efficitur. Cras justo augue, mollis vitae nulla sed, vestibulum tincidunt ante. Vestibulum et lorem lectus. Maecenas accumsan lacus a nisi euismod rutrum eu dapibus justo. Etiam scelerisque a odio a euismod. Pellentesque vestibulum pellentesque nisi, a tempus erat cursus ac. Morbi ut auctor lectus.%
\end{divisionexercise}%
\begin{divisionexercise}{9}{Impossible Three.}{}{exercises-top-level-10}%
Nam congue ex nec justo iaculis maximus. Vestibulum lobortis magna sed urna auctor, vel dignissim massa posuere. In sed venenatis elit. Vivamus congue gravida tempus. Nunc quis fermentum nisi. Nullam hendrerit lorem et tellus semper, sit amet scelerisque purus lobortis. Quisque sollicitudin quis neque eu suscipit. Praesent volutpat justo quis magna vehicula molestie.%
\end{divisionexercise}%
\begin{divisionexercise}{10}{An Exercise in a Section.}{}{exercises-top-level-11}%
...
\par\smallskip%
\noindent\textbf{\blocktitlefont Solution}.\hypertarget{exercises-top-level-11-3}{}\quad{}Maybe a global switch should be used to suppress solutions, while a separate processing regime could use them as part of a solutions manual.%
\end{divisionexercise}%
\begin{divisionexercise}{42a}{An Exercise with a Hard-Coded Problem Number.}{}{exercise-with-hardcoded-number}%
...
\par\smallskip%
\noindent\textbf{\blocktitlefont Solution}.\hypertarget{solution-antiderivative}{}\quad{}An antiderivative of \(x^2\) is \(F(x)=x^3/3\), so by the FTC,%
\begin{equation*}
...
\end{divisionexercise}%
\begin{divisionexercise}{12}{}{}{exercises-top-level-13}%
Can you prove Corollary~\hyperref[corollary-FTC-derivative]{{\xreffont\ref{corollary-FTC-derivative}}} directly?  If not consider that a problem could have several parts, which should be formatted as a second-level list, since the problems normally get numbered at the top level.%
\begin{enumerate}[label={(\alph*)}]
\item{}Why is this result a Corollary?%
\item{}Could you interchange the Theorem and Corollary?%
\end{enumerate}
%
\par\smallskip%
\noindent\textbf{\blocktitlefont Hint 1} (MVT).\hypertarget{exercises-top-level-13-2}{}\quad{}Consider the definite integral as an area function and employ the Mean Value Theorem.%
\par\smallskip%
\noindent\textbf{\blocktitlefont Hint 2} (Motivator).\hypertarget{exercise-complicated-second-hint}{}\quad{}Think harder!%
\par\smallskip%
\noindent\textbf{\blocktitlefont Answer} (Helpful).\hypertarget{exercise-complicated-first-answer}{}\quad{}%
\begin{enumerate}[label={(\alph*)}]
\item{}It follows easily.%
\item{}Yes.%
\end{enumerate}
%
\par\smallskip%
\noindent\textbf{\blocktitlefont Solution}.\hypertarget{exercises-top-level-13-5}{}\quad{}We could prove either result first, then obtain the other as an easy consequence.%
\end{divisionexercise}%
\end{exercises-section}
%
\appendix%
...
\typeout{************************************************}
%
\begin{appendixptx}{Appendix}{Notation}{}{Notation}{}{}{appendix-notation}
...
\endfoot
\endlastfoot
\(\int_a^b\,f(x)\,dx\)&definite integral of \(f(x)\)&\pageref{section-introduction-2-4}\\
...
\typeout{************************************************}
%
\begin{solutions-section}{Appendix}{Solutions to Selected Exercises}{}{Solutions to Selected Exercises}{}{}{solutions-backmatter}
\index{solutions!as an appendix}%
\begin{introduction}{}%
This is an introduction, where you might explain that this division of the back matter contains various hints, answers, solutions of inline exercises, divisional exercises, project-like blocks, worksheet exercises, and\slash{}or reading questions.  See the source to see just how this solutions division was built.%
\end{introduction}%
\par\medskip
\noindent\textbf{\large{}4\space\textperiodcentered\space{}An Interesting Corollary\\
4.2\space\textperiodcentered\space{}A Pedagogical Note about Subsection~{\xreffont\ref*{subsection-second-FTC}}\\
4.2.1\space\textperiodcentered\space{}Symbolic and Numerical Integrals}
\begin{inlinesolution}{Checkpoint}{4.6}{Essay Question: Compare and Contrast.}{exercise-essay}%
\par\smallskip%
\noindent\textbf{\blocktitlefont Hint}.\hypertarget{exercise-essay-3-back}{}\quad{}Start writing!%
\end{inlinesolution}%
\par\medskip
\noindent\textbf{\large{}4.2.2\space\textperiodcentered\space{}Advice}
\begin{inlinesolution}{Checkpoint}{4.9}{An Inline Exercise.}{inline-exercise}%
\par\smallskip%
\noindent\textbf{\blocktitlefont Hint}.\hypertarget{inline-exercise-3-back}{}\quad{}A good hint.%
\par\smallskip%
\noindent\textbf{\blocktitlefont Answer}.\hypertarget{inline-exercise-4-back}{}\quad{}42.%
\par\smallskip%
\noindent\textbf{\blocktitlefont Solution}.\hypertarget{inline-exercise-5-back}{}\quad{}If your exercise feels like proving a theorem, then you might want to make some comments, but also clearly delineate which part of the solution is a the complete proof.%
\begin{solutionproof}{Proof}
Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin lorem diam, convallis in nulla sed, accumsan fermentum urna. Pellentesque aliquet leo elit, ut consequat nunc dapibus ac. Sed lobortis leo tincidunt, vulputate nunc at, ultricies leo. Vivamus purus diam, tristique laoreet purus eget, mollis gravida sapien. Nunc vulputate nisl ac mauris hendrerit cursus. Sed vel molestie velit. Suspendisse sem sem, elementum at vehicula id, volutpat ac mi. Nullam ullamcorper fringilla purus in accumsan. Mauris at nunc accumsan orci dictum vulputate id id augue. Suspendisse at dignissim elit, non euismod nunc. Aliquam faucibus magna ac molestie semper. Aliquam hendrerit sem sit amet metus congue tempor. Donec laoreet laoreet metus, id interdum purus mattis vulputate. Proin condimentum vitae erat varius mollis. Donec venenatis libero sed turpis pretium tempor.%
\par
Praesent rutrum scelerisque felis sit amet adipiscing. Phasellus in mollis velit. Nunc malesuada felis sit amet massa cursus, eget elementum neque viverra. Integer sagittis dictum turpis vel aliquet. Fusce ut suscipit dolor, nec tristique nisl. Aenean luctus, leo et ornare fermentum, nibh dui vulputate leo, nec tincidunt augue ipsum sed odio. Nunc non erat sollicitudin, iaculis eros consequat, dapibus eros.%
...
\begin{activitysolution}{Activity}{4.3}{Hints, Answers, Solutions.}{activity-with-hint-answer-solution}%
\par\smallskip%
\noindent\textbf{\blocktitlefont Answer}.\hypertarget{activity-with-hint-answer-solution-5-back}{}\quad{}The result, but no help in getting there.%
\end{activitysolution}%
\begin{inlinesolution}{Checkpoint}{4.12}{A very structured exercise.}{exercise-structured}%
\begin{enumerate}[font=\bfseries,label=(\alph*),ref=\alph*]%
\item[(c)]\lititle{A title of a task that has a subtask with an \mono{<answer>} for the Solutions.}\par%
...
\item[(i)]\lititle{A task with a title and an \mono{<answer>} for the Solutions.}\par%
\par\smallskip%
\noindent\textbf{\blocktitlefont Answer}.\hypertarget{exercise-structured-5-3-3-back}{}\quad{}With a proof.%
\begin{solutionproof}{Proof}
In interdum suscipit ullamcorper. Morbi sit amet malesuada augue, id vestibulum magna. Nulla blandit dui metus, malesuada mollis sapien ullamcorper sit amet. Nulla at neque nisi. Integer vel porta felis.%
\end{solutionproof}
And a bit more to say.%
\item[(ii)]\noindent\textbf{\blocktitlefont Answer}.\hypertarget{exercise-structured-5-4-2-back}{}\quad{}Right!  In interdum suscipit ullamcorper. Morbi sit amet malesuada augue, id vestibulum magna. Nulla blandit dui metus, malesuada mollis sapien ullamcorper sit amet. Nulla at neque nisi. Integer vel porta felis.%
\end{enumerate}%
\item[(d)]\noindent\textbf{\blocktitlefont Hint}.\hypertarget{exercise-structured-6-2-back}{}\quad{}One hint.  In interdum suscipit ullamcorper. Morbi sit amet malesuada augue, id vestibulum magna. Nulla blandit dui metus, malesuada mollis sapien ullamcorper sit amet. Nulla at neque nisi. Integer vel porta felis.%
\par
In interdum suscipit ullamcorper. Morbi sit amet malesuada augue, id vestibulum magna. Nulla blandit dui metus, malesuada mollis sapien ullamcorper sit amet. Nulla at neque nisi. Integer vel porta felis.%
\par\smallskip%
\noindent\textbf{\blocktitlefont Answer 1}.\hypertarget{exercise-structured-6-3-back}{}\quad{}First answer.  In interdum suscipit ullamcorper.%
\par\smallskip%
\noindent\textbf{\blocktitlefont Answer 2}.\hypertarget{exercise-structured-6-4-back}{}\quad{}Second answer.  In interdum suscipit ullamcorper. Morbi sit amet malesuada augue, id vestibulum magna. Nulla blandit dui metus, malesuada mollis sapien ullamcorper sit amet. Nulla at neque nisi. Integer vel porta felis.%
\par
In interdum suscipit ullamcorper. Morbi sit amet malesuada augue, id vestibulum magna. Nulla blandit dui metus, malesuada mollis sapien ullamcorper sit amet. Nulla at neque nisi. Integer vel porta felis.%
\par
In interdum suscipit ullamcorper. Morbi sit amet malesuada augue, id vestibulum magna. Nulla blandit dui metus, malesuada mollis sapien ullamcorper sit amet. Nulla at neque nisi. Integer vel porta felis.%
\par\smallskip%
\noindent\textbf{\blocktitlefont Solution}.\hypertarget{exercise-structured-6-5-back}{}\quad{}At last, the solution.  In interdum suscipit ullamcorper. Morbi sit amet malesuada augue, id vestibulum magna. Nulla blandit dui metus, malesuada mollis sapien ullamcorper sit amet. Nulla at neque nisi. Integer vel porta felis.%
\end{enumerate}%
\end{inlinesolution}%
\begin{projectsolution}{Project}{4.4}{A very structured project.}{project-structured}%
\begin{enumerate}[font=\bfseries,label=(\alph*),ref=\alph*]%
\item[(c)]\begin{enumerate}[font=\bfseries,label=(\roman*),ref=\theenumi.\roman*]%
\item[(i)]\noindent\textbf{\blocktitlefont Answer}.\hypertarget{project-structured-6-2-2-back}{}\quad{}With a proof.%
\begin{solutionproof}{Proof}
In interdum suscipit ullamcorper. Morbi sit amet malesuada augue, id vestibulum magna. Nulla blandit dui metus, malesuada mollis sapien ullamcorper sit amet. Nulla at neque nisi. Integer vel porta felis.%
\end{solutionproof}
And a bit more to say.%
\item[(ii)]\noindent\textbf{\blocktitlefont Answer}.\hypertarget{project-structured-6-3-2-back}{}\quad{}Right!  In interdum suscipit ullamcorper. Morbi sit amet malesuada augue, id vestibulum magna. Nulla blandit dui metus, malesuada mollis sapien ullamcorper sit amet. Nulla at neque nisi. Integer vel porta felis.%
\end{enumerate}%
\item[(d)]\noindent\textbf{\blocktitlefont Answer 1}.\hypertarget{project-structured-7-3-back}{}\quad{}First answer.  In interdum suscipit ullamcorper.%
\par\smallskip%
\noindent\textbf{\blocktitlefont Answer 2}.\hypertarget{project-structured-7-4-back}{}\quad{}Second answer.  In interdum suscipit ullamcorper. Morbi sit amet malesuada augue, id vestibulum magna. Nulla blandit dui metus, malesuada mollis sapien ullamcorper sit amet. Nulla at neque nisi. Integer vel porta felis.%
\par
In interdum suscipit ullamcorper. Morbi sit amet malesuada augue, id vestibulum magna. Nulla blandit dui metus, malesuada mollis sapien ullamcorper sit amet. Nulla at neque nisi. Integer vel porta felis.%
\par
In interdum suscipit ullamcorper. Morbi sit amet malesuada augue, id vestibulum magna. Nulla blandit dui metus, malesuada mollis sapien ullamcorper sit amet. Nulla at neque nisi. Integer vel porta felis.%
...
\end{projectsolution}%
\begin{projectsolution}{Project}{4.5}{}{section-interesting-corollary-5-3-20-3}%
\noindent\textbf{\blocktitlefont Answer}.\hypertarget{section-interesting-corollary-5-3-20-3-2-back}{}\quad{}Here's the answer we are looking for.%
\end{projectsolution}%
\par\medskip
\noindent\textbf{\large{}4.2.3\space\textperiodcentered\space{}Exercises}
\begin{divisionsolution}{Exercise}{4.2.3.1}{}{exercise-test-number}%
\noindent\textbf{\blocktitlefont Solution}.\hypertarget{exercise-test-number-2-back}{}\quad{}This solution will migrate to a list of solutions in the backmatter.  We include a \mono{sidebyside} as a test.%
\begin{sidebyside}{2}{0.1}{0.1}{0.2}%
\begin{sbspanel}{0.3}%
This is a skinny paragraph which should be just 30\% of the width.%
\end{sbspanel}%
...
\end{divisionsolution}%
\par\medskip
\noindent\textbf{\large{}4.6\space\textperiodcentered\space{}Introductions and Conclusions\\
4.6.2\space\textperiodcentered\space{}Test Two}
\begin{inlinesolution}{Checkpoint}{4.16}{}{subsection-intro-conclude-4-3}%
\noindent\textbf{\blocktitlefont Answer}.\hypertarget{subsection-intro-conclude-4-3-2-back}{}\quad{}An answer so there is something to appear in a \mono{<solutions>}.%
\end{inlinesolution}%
\par\medskip
\noindent\textbf{\normalsize{}\textperiodcentered\space{}What Did You Learn?}
\begin{divisionsolution}{Reading Question}{4.6.2.1}{}{subsection-intro-conclude-4-4-2}%
\noindent\textbf{\blocktitlefont Answer}.\hypertarget{subsection-intro-conclude-4-4-2-2-back}{}\quad{}An answer so there is something to appear in a \mono{<solutions>}.%
\end{divisionsolution}%
\par\medskip
\noindent\textbf{\normalsize{}\textperiodcentered\space{}Exercises}
\begin{divisionsolution}{Exercise}{4.6.2.1}{}{subsection-intro-conclude-4-5-1}%
\noindent\textbf{\blocktitlefont Answer}.\hypertarget{subsection-intro-conclude-4-5-1-2-back}{}\quad{}An answer so there is something to appear in a \mono{<solutions>}.%
\end{divisionsolution}%
\par\medskip
\noindent\textbf{\large{}11\space\textperiodcentered\space{}Further Reading\\
11.3\space\textperiodcentered\space{}More Exercises}
\begin{exercisegroupcol}{4}
\begin{divisionsolutionegcol}{Exercise}{11.3.6}{}{exercises-section-multiple-5-3}%
\noindent\textbf{\blocktitlefont Hint}.\hypertarget{exercises-section-multiple-5-3-2-back}{}\quad{}Addition is associative.%
\par\smallskip%
\noindent\textbf{\blocktitlefont Answer}.\hypertarget{exercises-section-multiple-5-3-3-back}{}\quad{}\(12\)%
\par\smallskip%
\noindent\textbf{\blocktitlefont Solution}.\hypertarget{exercises-section-multiple-5-3-4-back}{}\quad{}First, add \(3\) and \(4\) to get \(7\), then add \(5\) to arrive at \(12\).%
\end{divisionsolutionegcol}%
\begin{divisionsolutionegcol}{Exercise}{11.3.8}{}{exercises-section-multiple-5-5}%
\noindent\textbf{\blocktitlefont Answer}.\hypertarget{exercises-section-multiple-5-5-2-back}{}\quad{}\(15\)%
\end{divisionsolutionegcol}%
\begin{divisionsolutionegcol}{Exercise}{11.3.11}{}{exercises-section-multiple-5-8}%
\noindent\textbf{\blocktitlefont Hint}.\hypertarget{exercises-section-multiple-5-8-2-back}{}\quad{}Addition is associative.%
\par\smallskip%
\noindent\textbf{\blocktitlefont Answer}.\hypertarget{exercises-section-multiple-5-8-3-back}{}\quad{}\(12\)%
\par\smallskip%
\noindent\textbf{\blocktitlefont Solution}.\hypertarget{exercises-section-multiple-5-8-4-back}{}\quad{}First, add \(3\) and \(4\) to get \(7\), then add \(5\) to arrive at \(12\).%
\begin{solutionproof}{Proof}
A simple argument.%
\end{solutionproof}
And a bit more.%
\end{divisionsolutionegcol}%
\begin{divisionsolutionegcol}{Exercise}{11.3.13}{}{exercises-section-multiple-5-10}%
\noindent\textbf{\blocktitlefont Answer}.\hypertarget{exercises-section-multiple-5-10-2-back}{}\quad{}\(15\)%
\end{divisionsolutionegcol}%
\begin{divisionsolutionegcol}{Exercise}{11.3.16}{}{exercises-section-multiple-5-13}%
\noindent\textbf{\blocktitlefont Hint}.\hypertarget{exercises-section-multiple-5-13-2-back}{}\quad{}Addition is associative.%
\par\smallskip%
\noindent\textbf{\blocktitlefont Answer}.\hypertarget{exercises-section-multiple-5-13-3-back}{}\quad{}\(12\)%
\par\smallskip%
\noindent\textbf{\blocktitlefont Solution}.\hypertarget{exercises-section-multiple-5-13-4-back}{}\quad{}First, add \(3\) and \(4\) to get \(7\), then add \(5\) to arrive at \(12\).%
\end{divisionsolutionegcol}%
\begin{divisionsolutionegcol}{Exercise}{11.3.18}{}{exercises-section-multiple-5-15}%
\noindent\textbf{\blocktitlefont Answer}.\hypertarget{exercises-section-multiple-5-15-2-back}{}\quad{}\(15\)%
\end{divisionsolutionegcol}%
\begin{divisionsolutionegcol}{Exercise}{11.3.21}{}{exercises-section-multiple-5-18}%
\noindent\textbf{\blocktitlefont Hint}.\hypertarget{exercises-section-multiple-5-18-2-back}{}\quad{}Addition is associative.%
\par\smallskip%
\noindent\textbf{\blocktitlefont Answer}.\hypertarget{exercises-section-multiple-5-18-3-back}{}\quad{}\(12\)%
\par\smallskip%
\noindent\textbf{\blocktitlefont Solution}.\hypertarget{exercises-section-multiple-5-18-4-back}{}\quad{}First, add \(3\) and \(4\) to get \(7\), then add \(5\) to arrive at \(12\).%
\end{divisionsolutionegcol}%
\begin{divisionsolutionegcol}{Exercise}{11.3.23}{}{exercises-section-multiple-5-20}%
\noindent\textbf{\blocktitlefont Answer}.\hypertarget{exercises-section-multiple-5-20-2-back}{}\quad{}\(15\)%
\end{divisionsolutionegcol}%
\end{exercisegroupcol}
\par\medskip\noindent
\begin{divisionsolution}{Exercise}{11.3.25}{}{exercises-section-multiple-6}%
\noindent\textbf{\blocktitlefont Answer}.\hypertarget{exercises-section-multiple-6-2-back}{}\quad{}\begin{sidebyside}{2}{0}{0}{0}%
\begin{sbspanel}{0.5}%
\noindent\resizebox{\ifdim\width > \linewidth\linewidth\else\width\fi}{!}{%
{\centering%
{\tabularfont%
...
\end{divisionsolution}%
\par\medskip
\noindent\textbf{\large{}16\space\textperiodcentered\space{}Interactive Exercises\\
16.1\space\textperiodcentered\space{}True\slash{}False}
\begin{divisionsolution}{Exercise}{16.1.1}{True\slash{}False.}{vector-space-dimension}%
\par\smallskip%
...
\end{divisionsolution}%
\par\medskip
\noindent\textbf{\large{}16.2\space\textperiodcentered\space{}Multiple-Choice}
\begin{divisionsolution}{Exercise}{16.2.1}{Multiple-Choice, Not Randomized, One Answer.}{multiple-choice-not-randomized}%
\par\smallskip%
...
\end{divisionsolution}%
\par\medskip
\noindent\textbf{\large{}16.3\space\textperiodcentered\space{}Parsons Problem, Math Proof}
\begin{divisionsolution}{Exercise}{16.3.1}{Parsons Problem, Mathematical Proof.}{number-theory-proof}%
\par\smallskip%
...
\end{divisionsolution}%
\par\medskip
\noindent\textbf{\large{}16.4\space\textperiodcentered\space{}Parsons Problem, Code}
\begin{divisionsolution}{Exercise}{16.4.1}{Parsons Problem, Programming.}{prime-number-program-indent-yes}%
\par\smallskip%
...
\end{divisionsolution}%
\par\medskip
\noindent\textbf{\large{}16.5\space\textperiodcentered\space{}Matching}
\begin{divisionsolution}{Exercise}{16.5.1}{Matching Problem, Dates.}{matching-dates}%
\par\smallskip%
...
\end{divisionsolution}%
\par\medskip
\noindent\textbf{\large{}16.6\space\textperiodcentered\space{}Clickable Area}
\begin{divisionsolution}{Exercise}{16.6.1}{Clickable Areas, ``Regular'' Text.}{clickable-text}%
\par\smallskip%
...
\end{divisionsolution}%
\par\medskip
\noindent\textbf{\large{}16.7\space\textperiodcentered\space{}Old-Style Fillin-In}
\begin{divisionsolution}{Exercise}{16.7.1}{Fill-In, String and Number Answers.}{fillin-string-integer}%
\par\smallskip%
\noindent\textbf{\blocktitlefont Solution}.\hypertarget{fillin-string-integer-3-back}{}\quad{}Complete the following line of a Python program so that it will declare an integer variable \mono{age} with an initial value of \mono{5}.%
\par
\fillintext{1}int\fillintext{1} \mono{age = } \fillintext{1}\(5\)\fillintext{1}\mono{;}%
\par
A variable of type \mono{int} is appropriate for whole number ages.%
...
\end{divisionsolution}%
\par\medskip
\noindent\textbf{\large{}17\space\textperiodcentered\space{}Dynamic Exercises}
\par\medskip
\noindent\textbf{\normalsize{}\textperiodcentered\space{}Dynamic Fill-In}
\begin{divisionsolution}{Exercise}{17.1}{Fill-In, String and Number Answers.}{fillin-string-integer-new}%
\par\smallskip%
\noindent\textbf{\blocktitlefont Solution}.\hypertarget{fillin-string-integer-new-3-back}{}\quad{}Complete the following line of a Python program so that it will declare an integer variable \mono{age} with an initial value of \mono{5}.%
\par
\fillintext{1}int\fillintext{1} \mono{age = } \fillintext{1}\(5\)\fillintext{1}\mono{;}%
\end{divisionsolution}%
\begin{divisionsolution}{Exercise}{17.2}{Fill-In, Multiple Strings, Custom Checker.}{fillin-multi-answer-jscmp}%
\par\smallskip%
\noindent\textbf{\blocktitlefont Solution}.\hypertarget{fillin-multi-answer-jscmp-3-back}{}\quad{}In order to apply the Integral Test to a sequence \(\{a_n\}\), the function \(a(n) = a_n\) must be \fillintext{1}continuous\fillintext{1}, \fillintext{1}positive\fillintext{1}~and \fillintext{1}decreasing\fillintext{1}.%
\end{divisionsolution}%
\begin{divisionsolution}{Exercise}{17.3}{Fill-In Formula (Dynamic).}{dynamic-fitb-simple-formula}%
\par\smallskip%
\noindent\textbf{\blocktitlefont Solution 1}.\hypertarget{dynamic-fitb-simple-formula-3-back}{}\quad{}Find a formula for a cubic function \(f(x)\) that has roots at \(x=-5\),  \(x=-2\), and \(x=2\) and so that \(f(0)=5\).%
\par
\(f(x)=\) \fillintext{1}\(-\frac{1}{4} \left(x+5\right) \left(x+2\right) \left(x-2\right)\)\fillintext{1}%
\par\smallskip%
\noindent\textbf{\blocktitlefont Solution 2}.\hypertarget{dynamic-fitb-simple-formula-4-back}{}\quad{}Knowing the roots of a polynomial allows us to write down the formula of \(f(x)\) in factored form,%
\begin{equation*}
f(x) = A \left(x+5\right) \left(x+2\right) \left(x-2\right)
\end{equation*}
with an unknown scaling multiple \(A\).%
...
%
\end{divisionsolution}%
\begin{divisionsolution}{Exercise}{17.4}{Decompose the Function.}{function-decomposition}%
\par\smallskip%
\noindent\textbf{\blocktitlefont Solution 1}.\hypertarget{function-decomposition-3-back}{}\quad{}Consider the function%
\begin{equation*}
h(x)=4 \left(-x-3\right)^{3}+5\text{.}
\end{equation*}
Find two nontrivial functions \(f(x)\) and \(g(x)\) so that \(h(x) = f(g(x))\).%
...
\(f(x) = \) \fillintext{1}\(4 x^{3}+5\)\fillintext{1} and \(g(x)=\) \fillintext{1}\(-1 x-3\)\fillintext{1}%
\par\smallskip%
\noindent\textbf{\blocktitlefont Solution 2}.\hypertarget{function-decomposition-4-back}{}\quad{}Noticing that the expression \(-1 x-3\) appears inside parentheses with a power, it makes sense to think of that as the inner function, defining \(g(x) = -1 x-3\). The outer function describes what happens to that. If we imagined replacing the formula \(-1 x-3\) with a box and then call that box our variable \(x\), we find the outer function is given by \(f(x) = 4 x^{3}+5\).%
\par
This is not the only non-trivial composition. Can you find others?%
\end{divisionsolution}%
\par\medskip
\noindent\textbf{\large{}31\space\textperiodcentered\space{}Advanced Numbering\\
31.7\space\textperiodcentered\space{}A Title with ] a Right Bracket}
\begin{inlinesolution}{Checkpoint}{31.19}{A Right Brace \textbraceright{} and a Right Bracket].}{exercise-difficult-title}%
\par\smallskip%
\noindent\textbf{\blocktitlefont Hint}.\hypertarget{exercise-difficult-title-3-back}{}\quad{}A faux hint to get this exercise to migrate into a \mono{<solutions>}.%
\end{inlinesolution}%
\par\medskip
\noindent\textbf{\large{}31.10\space\textperiodcentered\space{}Just an Exercise}
\begin{inlinesolution}{Checkpoint}{31.20}{An Extraneous Exercise.}{section-advanced-numbering-12-2}%
\par\smallskip%
\noindent\textbf{\blocktitlefont Hint}.\hypertarget{section-advanced-numbering-12-2-3-back}{}\quad{}A hint, so this exercise looks identical in structure to the one in the previous subsection.%
\end{inlinesolution}%
\par\medskip
\noindent\textbf{\large{}33\space\textperiodcentered\space{}MyOpenMath Interactive Problems}
\begin{inlinesolution}{Checkpoint}{33.1}{Negative Numbers and Exponents.}{section-myopenmath-3}%
\par\smallskip%
\noindent\textbf{\blocktitlefont Solution}.\hypertarget{section-myopenmath-3-3-back}{}\quad{}%
\begin{itemize}[label=\textbullet]
\item{}DNE%
\end{itemize}
%
\end{inlinesolution}%
\begin{inlinesolution}{Checkpoint}{33.2}{A Statistical Test.}{section-myopenmath-4}%
\par\smallskip%
\noindent\textbf{\blocktitlefont Solution}.\hypertarget{section-myopenmath-4-3-back}{}\quad{}%
\begin{itemize}[label=\textbullet]
\item{}-0.183%
\item{}0.1318%
\item{}A: There is insufficient sample evidence to support the claim the there is a negative correlation between the two variables.%
...
%
\end{inlinesolution}%
\begin{inlinesolution}{Checkpoint}{33.3}{With an image.}{section-myopenmath-5}%
\par\smallskip%
\noindent\textbf{\blocktitlefont Solution}.\hypertarget{section-myopenmath-5-3-back}{}\quad{}%
\begin{itemize}[label=\textbullet]
\item{}\(\displaystyle \displaystyle{y}={1}{x}+{0}\)%
\end{itemize}
%
\end{inlinesolution}%
\begin{inlinesolution}{Checkpoint}{33.4}{Geometry of a Cone.}{section-myopenmath-6}%
\par\smallskip%
\noindent\textbf{\blocktitlefont Solution}.\hypertarget{section-myopenmath-6-3-back}{}\quad{}%
\begin{itemize}[label=\textbullet]
\item{}4.4%
\item{}1.63%
\end{itemize}
...
\end{inlinesolution}%
\par\medskip
\noindent\textbf{\large{}35\space\textperiodcentered\space{}Worksheets\\
35.1\space\textperiodcentered\space{}A Geometric Prelude (without authored pages)}
\begin{divisionsolution}{Worksheet Exercise}{35.1.2}{}{exercise-vector-addition}%
\noindent\textbf{\blocktitlefont Hint}.\hypertarget{exercise-vector-addition-2-back}{}\quad{}Use \hyperlink{ex-cyclic}{Worksheet Exercise~{\xreffont 35.1.1}}.%
\end{divisionsolution}%
\par\medskip
\noindent\textbf{\large{}35.2\space\textperiodcentered\space{}A Geometric Prelude (with authored pages)}
\begin{divisionsolution}{Worksheet Exercise}{35.2.2}{}{exercise-vector-addition-pages}%
\noindent\textbf{\blocktitlefont Hint}.\hypertarget{exercise-vector-addition-pages-2-back}{}\quad{}Use \hyperlink{ex-cyclic}{Worksheet Exercise~{\xreffont 35.1.1}}.%
\end{divisionsolution}%
\par\medskip
\noindent\textbf{\large{}38\space\textperiodcentered\space{}Exercise Section, Structured}
\paragraph[{Easy Exercises}]{Easy Exercises}
\begin{divisionsolution}{Exercise}{38.1}{Arithmetic.}{exercises-structured-3-2}%
\par\smallskip%
\noindent\textbf{\blocktitlefont Answer}.\hypertarget{exercises-structured-3-2-3-back}{}\quad{}\(7\)%
\end{divisionsolution}%
\par\medskip\noindent
\paragraph[{With an Exercise Group}]{With an Exercise Group}
\begin{exercisegroup}
\begin{divisionsolutioneg}{Exercise}{38.5}{One.}{exercises-structured-5-2-2}%
\par\smallskip%
\noindent\textbf{\blocktitlefont Hint}.\hypertarget{exercises-structured-5-2-2-3-back}{}\quad{}Subtract.%
\end{divisionsolutioneg}%
\end{exercisegroup}
\par\medskip\noindent
\par\medskip\noindent
\par\medskip
\noindent\textbf{\large{}39\space\textperiodcentered\space{}Exercises, Multiple Subsections\\
39.5\space\textperiodcentered\space{}Layout challenge}
\begin{exercisegroupcol}{2}
\begin{divisionsolutionegcol}{Exercise}{39.5.4}{}{section-exercises-multiple-7-2-5}%
\noindent\textbf{\blocktitlefont Hint} (OPEN ME!).\hypertarget{section-exercises-multiple-7-2-5-2-back}{}\quad{}%
\begin{alignat*}{5}
3u \amp {}+{} 1v \amp {}+{} 3w \amp {}+{} 2x \amp {}+{} \amp  y \amp {}+{} \amp 3z \amp {}={} \amp 10\\
2u \amp {}+{} 2v \amp {}-{} 2w \amp {}+{} x  \amp       \amp    \amp {}+{} \amp  z \amp {}={} \amp 6\\
1u \amp {}-{} 3v \amp {}+{} 1w \amp {}+{} x  \amp {}+{} \amp 3y \amp {}+{} \amp 2z \amp {}={} \amp 13
...
\par\medskip\noindent
\par\medskip
\noindent\textbf{\large{}40\space\textperiodcentered\space{}Exercises, Top-Level}
\begin{divisionsolution}{Exercise}{40.10}{An Exercise in a Section.}{exercises-top-level-11}%
\par\smallskip%
\noindent\textbf{\blocktitlefont Solution}.\hypertarget{exercises-top-level-11-3-back}{}\quad{}Maybe a global switch should be used to suppress solutions, while a separate processing regime could use them as part of a solutions manual.%
\end{divisionsolution}%
\begin{divisionsolution}{Exercise}{40.42a}{An Exercise with a Hard-Coded Problem Number.}{exercise-with-hardcoded-number}%
\par\smallskip%
\noindent\textbf{\blocktitlefont Solution}.\hypertarget{solution-antiderivative-back}{}\quad{}An antiderivative of \(x^2\) is \(F(x)=x^3/3\), so by the FTC,%
\begin{equation*}
\definiteintegral{2}{4}{x^2}{x}=F(4)-F(2)=\frac{1}{3}\left(4^3-2^3\right)=\frac{56}{3}\text{!?!}
\end{equation*}
This is indeed an exciting result, but we are mostly interested in seeing that the sentence-ending punctuation is absorbed properly into the displayed equation.%
\end{divisionsolution}%
\begin{divisionsolution}{Exercise}{40.12}{}{exercises-top-level-13}%
\noindent\textbf{\blocktitlefont Hint 1} (MVT).\hypertarget{exercises-top-level-13-2-back}{}\quad{}Consider the definite integral as an area function and employ the Mean Value Theorem.%
\par\smallskip%
\noindent\textbf{\blocktitlefont Hint 2} (Motivator).\hypertarget{exercise-complicated-second-hint-back}{}\quad{}Think harder!%
\par\smallskip%
\noindent\textbf{\blocktitlefont Answer} (Helpful).\hypertarget{exercise-complicated-first-answer-back}{}\quad{}%
\begin{enumerate}[label={(\alph*)}]
\item{}It follows easily.%
\item{}Yes.%
\end{enumerate}
%
\par\smallskip%
\noindent\textbf{\blocktitlefont Solution}.\hypertarget{exercises-top-level-13-5-back}{}\quad{}We could prove either result first, then obtain the other as an easy consequence.%
\end{divisionsolution}%
\begin{conclusion}{}%
And a conclusion to this solutions division, which may not be readily apparent as distinct from the final division's worth of solutions, but since it is not prefixed with a number, it may be different enough.%
\end{conclusion}%
...
%
\typeout{************************************************}
\typeout{Appendix C Solutions to a Single Exercises Division}
\typeout{************************************************}
%
\begin{solutions-section}{Appendix}{Solutions to a Single Exercises Division}{}{Solutions to a Single Exercises Division}{}{}{solutions-single-exercises}
\index{solutions!for one group of exercises}%
\begin{introduction}{}%
Sometimes you may want the solutions to exercises within a single \mono{<exercises>} division (or similar, like a \mono{<worksheet>}).  Default behavior in this situation can produce two titles, when just one would be sufficient.  Here we have used the \mono{@scope} attribute to point to a specific \mono{<exercises>}, and provided a (single) very specific \mono{<title>}.%
\end{introduction}%
\par\medskip
\noindent\textbf{\large{}11.3\space\textperiodcentered\space{}More Exercises}
\begin{exercisegroupcol}{4}
\begin{divisionsolutionegcol}{Exercise}{11.3.6}{}{exercises-section-multiple-5-3}%
\noindent\textbf{\blocktitlefont Hint}.\hypertarget{exercises-section-multiple-5-3-2-back}{}\quad{}Addition is associative.%
\par\smallskip%
...
%
\typeout{************************************************}
\typeout{Appendix D All Solutions that are Answers}
\typeout{************************************************}
%
\begin{solutions-section}{Appendix}{All Solutions that are Answers}{}{All Solutions that are Answers}{}{}{solutions-answers}
\index{solutions!all answers}%
\begin{introduction}{}%
The back matter solutions appendix requests every \mono{<answer>}, and only \mono{<answer>}, of all types of exercises: inline, divisional, worksheet, reading questions, and projects.  Now, as observed by Bruce Yoshiwara, it gets a bit tedious to see the ``Answer'' heading over and over in print, when every entry has that heading.  So we squelch it for you in print\slash{}PDF output.  (For \initialism{HTML} output we use knowls and need to have something to click on.  But perhaps for \initialism{EPUB} we should be more careful?)  Note that you might want to use a \mono{<title>}, or an \mono{<introduction>}, that explains which component of the exercises is being displayed, so there is no confusion.%
\end{introduction}%
\par\medskip
\noindent\textbf{\large{}4\space\textperiodcentered\space{}An Interesting Corollary\\
4.2\space\textperiodcentered\space{}A Pedagogical Note about Subsection~{\xreffont\ref*{subsection-second-FTC}}\\
4.2.2\space\textperiodcentered\space{}Advice}
\begin{inlinesolution}{Checkpoint}{4.9}{An Inline Exercise.}{inline-exercise}%
\par\smallskip%
\noindent\hypertarget{inline-exercise-4-back}{}42.%
\end{inlinesolution}%
\begin{activitysolution}{Activity}{4.3}{Hints, Answers, Solutions.}{activity-with-hint-answer-solution}%
\par\smallskip%
\noindent\hypertarget{activity-with-hint-answer-solution-5-back}{}The result, but no help in getting there.%
\end{activitysolution}%
\begin{inlinesolution}{Checkpoint}{4.12}{A very structured exercise.}{exercise-structured}%
\begin{enumerate}[font=\bfseries,label=(\alph*),ref=\alph*]%
\item[(c)]\lititle{A title of a task that has a subtask with an \mono{<answer>} for the Solutions.}\par%
...
\item[(i)]\lititle{A task with a title and an \mono{<answer>} for the Solutions.}\par%
\par\smallskip%
\noindent\hypertarget{exercise-structured-5-3-3-back}{}With a proof.%
\begin{solutionproof}{Proof}
In interdum suscipit ullamcorper. Morbi sit amet malesuada augue, id vestibulum magna. Nulla blandit dui metus, malesuada mollis sapien ullamcorper sit amet. Nulla at neque nisi. Integer vel porta felis.%
\end{solutionproof}
And a bit more to say.%
\item[(ii)]\noindent\hypertarget{exercise-structured-5-4-2-back}{}Right!  In interdum suscipit ullamcorper. Morbi sit amet malesuada augue, id vestibulum magna. Nulla blandit dui metus, malesuada mollis sapien ullamcorper sit amet. Nulla at neque nisi. Integer vel porta felis.%
\end{enumerate}%
\item[(d)]\noindent\textbf{\blocktitlefont 1.}\hypertarget{exercise-structured-6-3-back}{}\quad{}First answer.  In interdum suscipit ullamcorper.%
\par\smallskip%
\noindent\textbf{\blocktitlefont 2.}\hypertarget{exercise-structured-6-4-back}{}\quad{}Second answer.  In interdum suscipit ullamcorper. Morbi sit amet malesuada augue, id vestibulum magna. Nulla blandit dui metus, malesuada mollis sapien ullamcorper sit amet. Nulla at neque nisi. Integer vel porta felis.%
\par
In interdum suscipit ullamcorper. Morbi sit amet malesuada augue, id vestibulum magna. Nulla blandit dui metus, malesuada mollis sapien ullamcorper sit amet. Nulla at neque nisi. Integer vel porta felis.%
\par
In interdum suscipit ullamcorper. Morbi sit amet malesuada augue, id vestibulum magna. Nulla blandit dui metus, malesuada mollis sapien ullamcorper sit amet. Nulla at neque nisi. Integer vel porta felis.%
...
\begin{enumerate}[font=\bfseries,label=(\alph*),ref=\alph*]%
\item[(c)]\begin{enumerate}[font=\bfseries,label=(\roman*),ref=\theenumi.\roman*]%
\item[(i)]\noindent\hypertarget{project-structured-6-2-2-back}{}With a proof.%
\begin{solutionproof}{Proof}
In interdum suscipit ullamcorper. Morbi sit amet malesuada augue, id vestibulum magna. Nulla blandit dui metus, malesuada mollis sapien ullamcorper sit amet. Nulla at neque nisi. Integer vel porta felis.%
\end{solutionproof}
And a bit more to say.%
\item[(ii)]\noindent\hypertarget{project-structured-6-3-2-back}{}Right!  In interdum suscipit ullamcorper. Morbi sit amet malesuada augue, id vestibulum magna. Nulla blandit dui metus, malesuada mollis sapien ullamcorper sit amet. Nulla at neque nisi. Integer vel porta felis.%
\end{enumerate}%
\item[(d)]\noindent\textbf{\blocktitlefont 1.}\hypertarget{project-structured-7-3-back}{}\quad{}First answer.  In interdum suscipit ullamcorper.%
\par\smallskip%
\noindent\textbf{\blocktitlefont 2.}\hypertarget{project-structured-7-4-back}{}\quad{}Second answer.  In interdum suscipit ullamcorper. Morbi sit amet malesuada augue, id vestibulum magna. Nulla blandit dui metus, malesuada mollis sapien ullamcorper sit amet. Nulla at neque nisi. Integer vel porta felis.%
\par
In interdum suscipit ullamcorper. Morbi sit amet malesuada augue, id vestibulum magna. Nulla blandit dui metus, malesuada mollis sapien ullamcorper sit amet. Nulla at neque nisi. Integer vel porta felis.%
\par
In interdum suscipit ullamcorper. Morbi sit amet malesuada augue, id vestibulum magna. Nulla blandit dui metus, malesuada mollis sapien ullamcorper sit amet. Nulla at neque nisi. Integer vel porta felis.%
...
\end{projectsolution}%
\begin{projectsolution}{Project}{4.5}{}{section-interesting-corollary-5-3-20-3}%
\noindent\hypertarget{section-interesting-corollary-5-3-20-3-2-back}{}Here's the answer we are looking for.%
\end{projectsolution}%
\par\medskip
\noindent\textbf{\large{}4.6\space\textperiodcentered\space{}Introductions and Conclusions\\
4.6.2\space\textperiodcentered\space{}Test Two}
\begin{inlinesolution}{Checkpoint}{4.16}{}{subsection-intro-conclude-4-3}%
\noindent\hypertarget{subsection-intro-conclude-4-3-2-back}{}An answer so there is something to appear in a \mono{<solutions>}.%
\end{inlinesolution}%
\par\medskip
\noindent\textbf{\normalsize{}\textperiodcentered\space{}What Did You Learn?}
\begin{divisionsolution}{Reading Question}{4.6.2.1}{}{subsection-intro-conclude-4-4-2}%
\noindent\hypertarget{subsection-intro-conclude-4-4-2-2-back}{}An answer so there is something to appear in a \mono{<solutions>}.%
\end{divisionsolution}%
\par\medskip
\noindent\textbf{\normalsize{}\textperiodcentered\space{}Exercises}
\begin{divisionsolution}{Exercise}{4.6.2.1}{}{subsection-intro-conclude-4-5-1}%
\noindent\hypertarget{subsection-intro-conclude-4-5-1-2-back}{}An answer so there is something to appear in a \mono{<solutions>}.%
\end{divisionsolution}%
\par\medskip
\noindent\textbf{\large{}11\space\textperiodcentered\space{}Further Reading\\
11.3\space\textperiodcentered\space{}More Exercises}
\begin{exercisegroupcol}{4}
\begin{divisionsolutionegcol}{Exercise}{11.3.6}{}{exercises-section-multiple-5-3}%
\noindent\hypertarget{exercises-section-multiple-5-3-3-back}{}\(12\)%
\end{divisionsolutionegcol}%
\begin{divisionsolutionegcol}{Exercise}{11.3.8}{}{exercises-section-multiple-5-5}%
\noindent\hypertarget{exercises-section-multiple-5-5-2-back}{}\(15\)%
\end{divisionsolutionegcol}%
\begin{divisionsolutionegcol}{Exercise}{11.3.11}{}{exercises-section-multiple-5-8}%
\noindent\hypertarget{exercises-section-multiple-5-8-3-back}{}\(12\)%
\end{divisionsolutionegcol}%
\begin{divisionsolutionegcol}{Exercise}{11.3.13}{}{exercises-section-multiple-5-10}%
\noindent\hypertarget{exercises-section-multiple-5-10-2-back}{}\(15\)%
\end{divisionsolutionegcol}%
\begin{divisionsolutionegcol}{Exercise}{11.3.16}{}{exercises-section-multiple-5-13}%
\noindent\hypertarget{exercises-section-multiple-5-13-3-back}{}\(12\)%
\end{divisionsolutionegcol}%
\begin{divisionsolutionegcol}{Exercise}{11.3.18}{}{exercises-section-multiple-5-15}%
\noindent\hypertarget{exercises-section-multiple-5-15-2-back}{}\(15\)%
\end{divisionsolutionegcol}%
\begin{divisionsolutionegcol}{Exercise}{11.3.21}{}{exercises-section-multiple-5-18}%
\noindent\hypertarget{exercises-section-multiple-5-18-3-back}{}\(12\)%
\end{divisionsolutionegcol}%
\begin{divisionsolutionegcol}{Exercise}{11.3.23}{}{exercises-section-multiple-5-20}%
\noindent\hypertarget{exercises-section-multiple-5-20-2-back}{}\(15\)%
\end{divisionsolutionegcol}%
\end{exercisegroupcol}
\par\medskip\noindent
\begin{divisionsolution}{Exercise}{11.3.25}{}{exercises-section-multiple-6}%
\noindent\hypertarget{exercises-section-multiple-6-2-back}{}\begin{sidebyside}{2}{0}{0}{0}%
\begin{sbspanel}{0.5}%
\noindent\resizebox{\ifdim\width > \linewidth\linewidth\else\width\fi}{!}{%
{\centering%
{\tabularfont%
...
\begin{divisionsolution}{Exercise}{16.1.1}{True\slash{}False.}{vector-space-dimension}%
\par\smallskip%
\noindent\hypertarget{vector-space-dimension-5-back}{}False.%
\end{divisionsolution}%
\par\medskip
\noindent\textbf{\large{}16.2\space\textperiodcentered\space{}Multiple-Choice}
\begin{divisionsolution}{Exercise}{16.2.1}{Multiple-Choice, Not Randomized, One Answer.}{multiple-choice-not-randomized}%
\par\smallskip%
\noindent\hypertarget{multiple-choice-not-randomized-6-back}{}B.%
\end{divisionsolution}%
\par\medskip
\noindent\textbf{\large{}16.6\space\textperiodcentered\space{}Clickable Area}
\begin{divisionsolution}{Exercise}{16.6.1}{Clickable Areas, ``Regular'' Text.}{clickable-text}%
\par\smallskip%
\noindent\hypertarget{clickable-text-3-back}{}Correct: \emph{future}; \emph{beauty}; \emph{dreams}. Incorrect: \deleted{those}; \deleted{their}.%
\par
The incorrect words are pronouns.%
\end{divisionsolution}%
\par\medskip
...
\begin{divisionsolution}{Exercise}{38.1}{Arithmetic.}{exercises-structured-3-2}%
\par\smallskip%
\noindent\hypertarget{exercises-structured-3-2-3-back}{}\(7\)%
\end{divisionsolution}%
\par\medskip\noindent
\par\medskip
\noindent\textbf{\large{}40\space\textperiodcentered\space{}Exercises, Top-Level}
\begin{divisionsolution}{Exercise}{40.12}{}{exercises-top-level-13}%
\noindent\textbf{\blocktitlefont  Helpful.}\hypertarget{exercise-complicated-first-answer-back}{}\quad{}%
\begin{enumerate}[label={(\alph*)}]
\item{}It follows easily.%
\item{}Yes.%
\end{enumerate}
...
%
\typeout{************************************************}
\typeout{Appendix E All Solutions that are Answers to Odd Exercises}
\typeout{************************************************}
%
\begin{solutions-section}{Appendix}{All Solutions that are Answers to Odd Exercises}{}{All Solutions that are Answers to Odd Exercises}{}{}{solutions-odd-answers}
\index{solutions!all even answers}%
\begin{introduction}{}%
This should be identical to the previous collection of answers, \emph{except} only exercises with an even number are reported (via the \mono{@admit} attribute).%
\end{introduction}%
\par\medskip
\noindent\textbf{\large{}4\space\textperiodcentered\space{}An Interesting Corollary\\
4.2\space\textperiodcentered\space{}A Pedagogical Note about Subsection~{\xreffont\ref*{subsection-second-FTC}}\\
...
\typeout{************************************************}
%
\begin{appendixptx}{Appendix}{List of Results}{}{List of Results}{}{}{appendix-results}
\renewcommand*{\appendixname}{Appendix}
...
\hyperref[worksheet-networks-2-3]{Theorem 35.9}& Ohms Law\\
\hyperref[worksheet-networks-2-4]{Theorem 35.10}& Kirchoffs Current Law\\
\hyperref[worksheet-networks-2-6]{Theorem 35.12}& Kirchoffs Voltage Law\\
\hyperref[worksheet-networks-pages-2-3]{Theorem 35.14}& Ohms Law\\
\hyperref[worksheet-networks-pages-2-4]{Theorem 35.15}& Kirchoffs Current Law\\
\hyperref[worksheet-networks-pages-2-6]{Theorem 35.17}& Kirchoffs Voltage Law\\
\multicolumn{2}{l}{\null}\\[1.5ex] \multicolumn{2}{l}{\large Section 36 Handouts}\\[0.5ex]
\hyperref[section-handouts-4-3-1]{Theorem 36.2}& \\
\multicolumn{2}{l}{\null}\\[1.5ex] \multicolumn{2}{l}{\large Section 37 Exercises, One Subsection}\\[0.5ex]
\hyperref[section-exercises-single-8]{Theorem 37.3}& Major Result\\
\multicolumn{2}{l}{\null}\\[1.5ex] \multicolumn{2}{l}{\large Section 39 Exercises, Multiple Subsections}\\[0.5ex]
\multicolumn{2}{l}{\null}\\[1.5ex] \multicolumn{2}{l}{\large Subsection 39.1 Faux Subsection}\\[0.5ex]
\hyperref[section-exercises-multiple-3-5]{Theorem 39.3}& Major Result\\
\end{longtable}
\end{appendixptx}
%
%
...
\typeout{************************************************}
%
\begin{appendixptx}{Appendix}{Lists of Exercises}{}{Lists of Exercises}{}{}{appendix-exercise-lists}
\renewcommand*{\appendixname}{Appendix}
...
\hyperref[section-myopenmath-6]{Checkpoint 33.4}& Geometry of a Cone\\
\multicolumn{2}{l}{\null}\\[1.5ex] \multicolumn{2}{l}{\large Section 34 Ancillaries}\\[0.5ex]
\multicolumn{2}{l}{\null}\\[1.5ex] \multicolumn{2}{l}{\large Section 35 Worksheets}\\[0.5ex]
\multicolumn{2}{l}{\null}\\[1.5ex] \multicolumn{2}{l}{\large Section 36 Handouts}\\[0.5ex]
\multicolumn{2}{l}{\null}\\[1.5ex] \multicolumn{2}{l}{\large Section 37 Exercises, One Subsection}\\[0.5ex]
\hyperref[section-exercises-single-5]{Checkpoint 37.1}& Inline One\\
\hyperref[duplicate-inline]{Checkpoint 37.2}& Inline Two\\
\hyperref[section-exercises-single-9]{Checkpoint 37.4}& Inline Three\\
\multicolumn{2}{l}{\null}\\[1.5ex] \multicolumn{2}{l}{\large Section 39 Exercises, Multiple Subsections}\\[0.5ex]
\hyperref[section-exercises-multiple-3-2]{Checkpoint 39.1}& Inline One\\
\hyperref[section-exercises-multiple-3-4]{Checkpoint 39.2}& Inline Two\\
\hyperref[exercise-duplicate-inline]{Checkpoint 39.4}& Inline Three\\
\end{longtable}
\end{appendixptx}
%
%
...
\typeout{************************************************}
%
\begin{appendixptx}{Appendix}{A Structured Appendix}{}{A Structured Appendix}{}{}{appendix-structured}
\renewcommand*{\appendixname}{Appendix}
\begin{introduction}{}%
...
\typeout{************************************************}
%
\begin{subsectionptx}{Subsection}{A Subsection in an Appendix}{}{A Subsection in an Appendix}{}{}{appendix-structured-3}
\begin{introduction}{}%
Inside a subsection.%
\end{introduction}%
%
...
\typeout{************************************************}
%
\begin{subsubsectionptx}{Subsubsection}{A Subsubsection in a Subsection in an Appendix}{}{A Subsubsection in a Subsection in an Appendix}{}{}{appendix-structured-3-3}
Nearly terminal.%
\begin{paragraphs}{Paragraphs in a Subsubsection in a Subsection in an Appendix.}{appendix-structured-3-3-3}%
...
\typeout{************************************************}
%
\begin{appendixptx}{Appendix}{Index}{}{Index}{}{}{appendix-index}
\renewcommand*{\appendixname}{Appendix}
...
\begin{paragraphs}{Bully Pulpit: Index Headings.}{appendix-index-5}%
...
\end{paragraphs}%
\begin{paragraphs}{Note.}{appendix-index-6}%
...
\begin{itemize}[label=\textbullet]
\item{}Judson: \hyperlink{biblio-judson-aata}{[{\xreffont 1}]}%
\item{}Lay: \hyperlink{biblio-lay-article}{[{\xreffont 2}]}%
\item{}Doe: \hyperlink{citeproc-py-item-3}{[{\xreffont 4}]}%
\item{}Doe, later: \hyperlink{citeproc-py-item-3-later}{[{\xreffont 3}]}%
\item{}Conrey\slash{}Farmer: \hyperlink{conrey-farmer}{[{\xreffont 5}]}%
\item{}D'Arcus: \hyperlink{citeproc-py-item-5}{[{\xreffont 6}]}%
\item{}Two, authored in-order: [\hyperlink{conrey-farmer}{{\xreffont 5}}, \hyperlink{citeproc-py-item-5}{{\xreffont 6}}]%
\item{}Two, authored out-of-order: [\hyperlink{citeproc-py-item-5}{{\xreffont 6}}, \hyperlink{conrey-farmer}{{\xreffont 5}}]%
\item{}Three, authored reverse-order: [\hyperlink{biblio-lay-article}{{\xreffont 2}}, \hyperlink{biblio-judson-aata}{{\xreffont 1}}, \hyperlink{citeproc-py-item-3}{{\xreffont 4}}]%
\end{itemize}
%
\end{subsectionptx}
%
...
%
\typeout{************************************************}
\typeout{Glossary  Glossary}
\typeout{************************************************}
%
\begin{glossary-section-numberless}{Glossary}{Glossary}{}{Glossary}{}{}{glossary-backmatter}
\index{glossary}%
%% this should be a new (isomorphic) "headnote" environment
\begin{introduction}{}%
A glossary may have a \mono{<headnote>}, perhaps with some explanation.  This glossary is placed in the back matter.  Placement as a specialized division is another option, see \hyperref[glossary-specialized]{Glossary~{\xreffont\ref{glossary-specialized}}}.%
\end{introduction}%
\begin{glossaryitem}{bar.}{glossary-backmatter-3}
A part of \terminology{foobar}.  See \hyperref[foobar-defined-two]{foobar}.%
\end{glossaryitem}
\begin{glossaryitem}{foobar.}{foobar-defined-two}
A synonym for the acronym \acronym{FUBAR}.%
\end{glossaryitem}
\end{glossary-section-numberless}
%
%
\typeout{************************************************}
...
%%   with a standard "thebibliography" environment
\begin{referencelist}
\bibitem[1]{biblio-judson-aata}\hypertarget{biblio-judson-aata}{}Judson, Thomas, \textit{Abstract Algebra: Theory and Applications}\par%
Another online, open-source offering.%

\bibitem[2]{biblio-lay-article}\hypertarget{biblio-lay-article}{}Lay, David C., \textit{Subspaces and Echelon Forms}, The College Mathematics Journal (1993) \textbf{24} no. 1 57-62.
\bibitem[3]{citeproc-py-item-3-later}\hypertarget{citeproc-py-item-3-later}{}Doe, John (1970), \textit{Still Anonymous, But now Ibid}.
\bibitem[4]{citeproc-py-item-3}\hypertarget{citeproc-py-item-3}{}Doe, John (1965), \textit{His Anonymous Life}.
\bibitem[5]{conrey-farmer}\hypertarget{conrey-farmer}{}Conrey, J. B. and D. W. Farmer, \textit{Mean values of \(L\)-functions and symmetry}, Internat. Math. Res. Notices (2000) \textbf{17} 883-908.
\bibitem[6]{citeproc-py-item-5}\hypertarget{citeproc-py-item-5}{}D'Arcus, Bruce, \textit{Boundaries of Dissent: Protest and State Power in the Media Age}, Routledge, New York (2006) \mono{http:\slash{}\slash{}www.test01.com}.
\end{referencelist}
