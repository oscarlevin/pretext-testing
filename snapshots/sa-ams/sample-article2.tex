...
%*                                          *%
%********************************************%
% This document was created with the texstyle file "ams-general.xml" to satisfy the requirements of the journal "General - All other AMS journals."
%
%
...
\par
Generated: March 17, 2025, 21:13:40 (-06:00)%
...
%
\typeout{************************************************}
\typeout{Subsection 1 Second Version of \acronymintitle{FTC}}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 2 A Pedagogical Note about Subsection~{\xreffont\ref*{subsection-second-FTC}}}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsubsection 1 Symbolic and Numerical Integrals}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 3 Theorem-Like Environments}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 4 Linking Sage Cells}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 6 Introductions and Conclusions}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsubsection 1 Test One}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsubsection 2 Test Two}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsubsection 3 Test Three}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 7 Some Paragraph-Level Markup}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 1 Basic Mathematics}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 2 Displayed Mathematics}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 3 \LaTeX{} Packages and MathJax Extensions}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 4 Advanced Mathematics}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 5 Local Tags on Equations}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 6 Commutative Diagrams}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 7 Line-Breaking after Mathematics}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 8 Fonts and Mathematics}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 9 Miscellaneous}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 1 Remark-like Blocks}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 2 Example-like Blocks}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 3 Theorem-like Blocks}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 4 Axiom-like Blocks}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 5 Definition-like Blocks}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 6 Aside-like Blocks}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 7 Computation-like Blocks}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 8 Project-like Blocks}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 1 Special \initialismintitle{XML} characters}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 2 Quotations}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 4 Characters, Symbols, and Constructions}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 6 Icons in Text}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 7 Keyboard Keys}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 8 URLs, such as \mono{http://example.com}}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 9 Biological Names}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 10 Verbatim in titles, \mono{\textbackslash{}a\&b\#c\%d\textasciitilde{}e\{f\}g\$h\_i\textasciicircum{}j}, OK}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 11 Special Situations}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 12 Jupyter Notebook, Markdown, MathJax, Delimiters}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 13 \LaTeX{} Characters, Ligatures, and More}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 14 \initialismintitle{HTML} and accidental mathematics}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 1 Images from External Sources}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 3 \LaTeX{} images}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 4 Asymptote, 2D}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 5 Asymptote, 3D via WebGL}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 6 Mermaid Diagrams}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 7 Sage Plots}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 8 Inkscape Images}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 9 Copies of Images}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 10 Caption Testing}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 11 Captionless Images}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 12 Technical Details}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 13 Accessibility}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 1 HTML5 Canvas}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 5 JessieCode}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 6 Sage Interacts}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 9 IFrames from Files}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 2 Desmos Graphs}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 3 CalcPlot3D}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 4 IFrames from Servers}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 1 Faux Subsection}
\typeout{************************************************}
%
...
% Introduction
First, a gratuitous reference to Exercise~\hyperlink{exercises-cosine-derivative}{{\xreffont 2}} about the derivative of a cosine.%
\par
...
%
\typeout{************************************************}
\typeout{Subsection 1 Video Files}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 4 Captions and Subtitles}
\typeout{************************************************}
%
...
\par
Cross-references to exercises with hard-coded numbers should respect the supplied number.  Exercise~\hyperlink{exercise-with-hardcoded-number}{{\xreffont 9}} should reference problem 42a.%
\par
...
\begin{itemize}[label=\textbullet]
\item{}Footnotes: Fermat allusion at \hyperref[footnote-fermat]{{\xreffont 1}}.%
...
\item{}Citations: In a \mono{<references>} division inside an appendix \hyperlink{biblio-strang-article-uno}{[{\xreffont 1}]}%
\item{}Note: just the annotation of previous citation at \hyperlink{note-judson-AATA}{{\xreffont 1}}%
...
\item{}Proof: of second version of FTC at \hyperlink{proof-FTC-corollary}{{\xreffont 1}}%
...
\item{}Exercises (divisional), a range, with plural form provided to override autonaming: \hyperlink{exercises-null-problem}{Exercises~{\xreffont 1}\textendash{}{\xreffont 2}}.%
\item{}Exercise (inline): with enclosed hint at \hyperref[exercise-essay]{{\xreffont\ref{exercise-essay}}}%
\item{}A group of two exercises, with introduction, conclusion: \hyperlink{exercisegroup-two-problems}{Exercise Group~{\xreffont 1}}%
\item{}Solution: An autonamed portion of an exercise: \hyperlink{solution-antiderivative}{Solution~{\xreffont 1}}%
\item{}Parts of a complicated exercise: \hyperlink{exercise-complicated-second-hint}{Hint~{\xreffont 2}} \hyperlink{exercise-complicated-first-answer}{Answer~{\xreffont 1}}%
\item{}A subsidary part of an exercise: \hyperlink{exercise-one-two-one}{{\xreffont 1}}%
\item{}\index{knowl!nested} Three cross-references to individual exercises, but due to their location, they should have different ``type names'' in the cross-reference: in an \mono{<exercises>} division, \hyperlink{duplicate-divisional}{Exercise~{\xreffont 2}}; in the narrative, \hyperref[exercise-essay]{Checkpoint~{\xreffont\ref{exercise-essay}}}; and in a \mono{<worksheet>}, \hyperlink{exercise-vector-addition}{Worksheet Exercise~{\xreffont 1}}.%
\item{}An item buried in nested ordered lists: \hyperlink{list-two-two-two-three}{Item~{\xreffont 3}}%
\item{}List item as knowls in HTML, including nested lists: \hyperlink{list-two}{{\xreffont 2}}, \hyperlink{list-two-two-two}{Item~{\xreffont 2}}%
\item{}A titled list: \hyperref[list-colors-rainbow]{{\xreffont\ref{list-colors-rainbow}}}%
\item{}List item inside a named list, second color in rainbow list: \hyperlink{rainbow-orange}{Item~{\xreffont 2}}%
...
\item{}A cross-reference to an individual objective.  This is authored as a list item, but displayed as an objective (singular) via an autoname: \hyperlink{objective-structure}{Objective~{\xreffont 1}}%
...
\begin{itemize}[label=\textbullet]
\item{}A range of exercises, autonamed (this range appears ``out-of-order'' since the two \mono{exercise} are numbered under two different schemes): \hyperref[exercise-essay]{Checkpoint~{\xreffont\ref{exercise-essay}}\textendash{}{\xreffont 1}}%
...
%
\typeout{************************************************}
\typeout{Subsection 1 Figures with Numbers Side-By-Side}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 3 Common Side-By-Side Constructions}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 4 Vertical Alignment}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 5 Text Next to Text and Images}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 6 Image Formats, Side-by-Sides}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 7 Tables Side-By-Side}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 8 Tables Next to Figures}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 9 Tables Next to Text}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 10 Tabular Next to Each Other}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 11 Lists in Side-by-Sides}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 12 Stacking: Back to Vertical Flow}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 13 Other Panels}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 14 Poems as Side-By-Side Panels}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 15 Side-By-Side Groups}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 16 Testing a Side-By-Side First}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 17 Testing Styling of Related Elements}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 1 \mono{<image>}}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 2 \mono{<video>}}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 3 \mono{<program>}, \mono{<console>}}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 4 \mono{<tabular>}}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 6 Theorems in This Section}
\typeout{************************************************}
%
...
\endfoot
\endlastfoot
\hyperref[theorem-number-01]{Theorem 1}& First Theorem\\
\hyperref[theorem-number-02]{Theorem 2}& Second Theorem\\
\hyperref[theorem-number-03]{Theorem 1}& First Theorem!\\
\hyperref[theorem-number-04]{Theorem 2}& Second Theorem?\\
\hyperref[theorem-number-05]{Theorem 1}& First Theorem?\\
\hyperref[theorem-number-06]{Theorem 2}& Second Theorem!\\
\hyperref[theorem-number-07]{Theorem 1}& First Theorem\\
\hyperref[theorem-number-08]{Theorem 2}& Second Theorem\\
\hyperref[theorem-good-one]{Theorem 1}& Good Numbered Theorem One\\
\hyperref[theorem-good-two]{Theorem 2}& Good Numbered Theorem Two\\
\hyperref[theorem-number-09]{Theorem 1}& First Theorem\\
\hyperref[theorem-number-10]{Theorem 2}& Second Theorem\\
\hyperref[theorem-number-11]{Theorem 1}& First Theorem\\
\hyperref[theorem-number-12]{Theorem 2}& Second Theorem\\
\hyperref[theorem-bad-one]{Theorem 1}& Bad Numbered Theorem One\\
\hyperref[theorem-bad-two]{Theorem 2}& Bad Numbered Theorem Two\\
\hyperref[theorem-number-13]{Theorem 1}& First Theorem\\
\hyperref[theorem-number-14]{Theorem 2}& Second Theorem\\
\end{longtable}
% end of subsection: Theorems in This Section
%
%
\typeout{************************************************}
\typeout{Subsection 7 A Title with ] a Right Bracket}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 8 A Title with \textbraceright{} a Right Brace}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 9 A Title with \(a]b\) a Math Right Bracket}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 10 Just an Exercise}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 1 Renaming Document Parts, Plus This Is A Really Long Title So That We Can Test How Well It Reacts To The Right Margin And Wraps Around To Form A Couple Of Lines, Plus How It Sits Relative To The Number Of The Subsection}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 2 Customizing Phrases}
\typeout{************************************************}
%
...
\par
Try to evaluate \(\displaystyle-{\left(-{36}\right)}^{{-{3}{/}{2}}}\) without using a calculator. Enter your answer as an integer or reduced fraction (no decimals). Enter DNE if the number is not real.%
\par
...
This is an introduction, providing articulation between the MOM problem and the contents of the text.  For example, you might cross-reference a result or example given previously.%
\par
You wish to determine if there is a positive linear correlation between the two variables at a significance level of \(\displaystyle\alpha={0.01}\). You have the following bivariate data set.%
\begin{center}%
{\tabularfont%
\begin{tabular}{ll}
x&y\tabularnewline[0pt]
59.1&91.5\tabularnewline[0pt]
44.3&6.6\tabularnewline[0pt]
73.2&128.1\tabularnewline[0pt]
41&43.9\tabularnewline[0pt]
50.1&99.8\tabularnewline[0pt]
81.9&124\tabularnewline[0pt]
58.4&18.6\tabularnewline[0pt]
36.6&-0.5\tabularnewline[0pt]
89.3&63.1\tabularnewline[0pt]
42&85.2\tabularnewline[0pt]
60.1&-21.9\tabularnewline[0pt]
63.8&43.8\tabularnewline[0pt]
69.1&132.8\tabularnewline[0pt]
41.2&27.1\tabularnewline[0pt]
50.4&72.4\tabularnewline[0pt]
67.7&44.2\tabularnewline[0pt]
67&104.3\tabularnewline[0pt]
75.7&129.1\tabularnewline[0pt]
72.3&148.2\tabularnewline[0pt]
57.3&57.5\tabularnewline[0pt]
60.1&143.7\tabularnewline[0pt]
30.8&24.5\tabularnewline[0pt]
79.1&74.6\tabularnewline[0pt]
84&125.9\tabularnewline[0pt]
73&145.3\tabularnewline[0pt]
53.5&135.4
\end{tabular}
}%
\end{center}%
download link provided here:  \href{denied:data:text/csv;charset=UTF-8,\%22x\%22\%2C\%22y\%22\%0A59.1\%2C91.5\%0A44.3\%2C6.6\%0A73.2\%2C128.1\%0A41\%2C43.9\%0A50.1\%2C99.8\%0A81.9\%2C124\%0A58.4\%2C18.6\%0A36.6\%2C-0.5\%0A89.3\%2C63.1\%0A42\%2C85.2\%0A60.1\%2C-21.9\%0A63.8\%2C43.8\%0A69.1\%2C132.8\%0A41.2\%2C27.1\%0A50.4\%2C72.4\%0A67.7\%2C44.2\%0A67\%2C104.3\%0A75.7\%2C129.1\%0A72.3\%2C148.2\%0A57.3\%2C57.5\%0A60.1\%2C143.7\%0A30.8\%2C24.5\%0A79.1\%2C74.6\%0A84\%2C125.9\%0A73\%2C145.3\%0A53.5\%2C135.4}{Download CSV}\footnotemark{}%
\par
...
%
\end{inlineexercise}%
\footnotetext[1]{\nolinkurl{denied:data:text/csv;charset=UTF-8,\%22x\%22\%2C\%22y\%22\%0A59.1\%2C91.5\%0A44.3\%2C6.6\%0A73.2\%2C128.1\%0A41\%2C43.9\%0A50.1\%2C99.8\%0A81.9\%2C124\%0A58.4\%2C18.6\%0A36.6\%2C-0.5\%0A89.3\%2C63.1\%0A42\%2C85.2\%0A60.1\%2C-21.9\%0A63.8\%2C43.8\%0A69.1\%2C132.8\%0A41.2\%2C27.1\%0A50.4\%2C72.4\%0A67.7\%2C44.2\%0A67\%2C104.3\%0A75.7\%2C129.1\%0A72.3\%2C148.2\%0A57.3\%2C57.5\%0A60.1\%2C143.7\%0A30.8\%2C24.5\%0A79.1\%2C74.6\%0A84\%2C125.9\%0A73\%2C145.3\%0A53.5\%2C135.4}\label{section-myopenmath-4-2-4-2}}%
\begin{inlineexercise}[With an image]\label{section-myopenmath-5}%
%
This is an introduction, providing articulation between the MOM problem and the contents of the text.  For example, you might cross-reference a result or example given previously.%
\begin{image}{0.25}{0.5}{0.25}{}%
\includegraphics[width=\linewidth]{generated/problems/images/f4d6b252cef8b4715d2df2985ed76204.png}
\end{image}%
...
%
\typeout{************************************************}
\typeout{Appendix 2 List of Results}
\typeout{************************************************}
%
...
\hyperref[theorem-FTC]{Theorem 1}& The Fundamental Theorem of Calculus\\
\multicolumn{2}{l}{\null}\\[1.5ex] \multicolumn{2}{l}{\large Section 4 An Interesting Corollary}\\[0.5ex]
\multicolumn{2}{l}{\null}\\[1.5ex] \multicolumn{2}{l}{\large Subsection 1 Second Version of \acronymintitle{FTC}}\\[0.5ex]
\hyperref[corollary-FTC-derivative]{Corollary 1}& \\
\multicolumn{2}{l}{\null}\\[1.5ex] \multicolumn{2}{l}{\large Section 8 Grouping Samples}\\[0.5ex]
\multicolumn{2}{l}{\null}\\[1.5ex] \multicolumn{2}{l}{\large Subsection 3 Theorem-like Blocks}\\[0.5ex]
\hyperref[block-samples-theorem-like-2]{Theorem 1}& A title\\
\hyperref[block-samples-theorem-like-3]{Theorem 2}& A title\\
\hyperref[block-samples-theorem-like-4]{Corollary 1}& A title\\
\multicolumn{2}{l}{\null}\\[1.5ex] \multicolumn{2}{l}{\large Section 24 Program Listings (with \mono{code} in the title)}\\[0.5ex]
\hyperref[theorem-detached]{Theorem 1}& \\
\multicolumn{2}{l}{\null}\\[1.5ex] \multicolumn{2}{l}{\large Section 31 Advanced Numbering}\\[0.5ex]
\multicolumn{2}{l}{\null}\\[1.5ex] \multicolumn{2}{l}{\large Subsection 1 One}\\[0.5ex]
\hyperref[theorem-number-01]{Theorem 1}& First Theorem\\
\hyperref[theorem-number-02]{Theorem 2}& Second Theorem\\
\multicolumn{2}{l}{\null}\\[1.5ex] \multicolumn{2}{l}{\large Subsection 2 Two}\\[0.5ex]
\hyperref[theorem-number-03]{Theorem 1}& First Theorem!\\
\hyperref[theorem-number-04]{Theorem 2}& Second Theorem?\\
\hyperref[theorem-number-05]{Theorem 1}& First Theorem?\\
\hyperref[theorem-number-06]{Theorem 2}& Second Theorem!\\
\multicolumn{2}{l}{\null}\\[1.5ex] \multicolumn{2}{l}{\large Subsection 3 Three}\\[0.5ex]
\hyperref[theorem-number-07]{Theorem 1}& First Theorem\\
\hyperref[theorem-number-08]{Theorem 2}& Second Theorem\\
\multicolumn{2}{l}{\null}\\[1.5ex] \multicolumn{2}{l}{\large Subsection 4 Four}\\[0.5ex]
\hyperref[theorem-good-one]{Theorem 1}& Good Numbered Theorem One\\
\hyperref[theorem-good-two]{Theorem 2}& Good Numbered Theorem Two\\
\hyperref[theorem-number-09]{Theorem 1}& First Theorem\\
\hyperref[theorem-number-10]{Theorem 2}& Second Theorem\\
...
\hyperref[theorem-bad-one]{Theorem 1}& Bad Numbered Theorem One\\
\hyperref[theorem-bad-two]{Theorem 2}& Bad Numbered Theorem Two\\
\multicolumn{2}{l}{\null}\\[1.5ex] \multicolumn{2}{l}{\large Subsection 5 Five}\\[0.5ex]
\hyperref[theorem-number-13]{Theorem 1}& First Theorem\\
\hyperref[theorem-number-14]{Theorem 2}& Second Theorem\\
\multicolumn{2}{l}{\null}\\[1.5ex] \multicolumn{2}{l}{\large Section 35 Worksheets}\\[0.5ex]
\hyperref[worksheet-networks-2-3]{Theorem 1}& Ohms Law\\
\hyperref[worksheet-networks-2-4]{Theorem 2}& Kirchoffs Current Law\\
\hyperref[worksheet-networks-2-6]{Theorem 3}& Kirchoffs Voltage Law\\
\multicolumn{2}{l}{\null}\\[1.5ex] \multicolumn{2}{l}{\large Section 36 Exercises, One Subsection}\\[0.5ex]
\hyperref[section-exercises-single-8]{Theorem 1}& Major Result\\
\multicolumn{2}{l}{\null}\\[1.5ex] \multicolumn{2}{l}{\large Section 37 Exercises, Multiple Subsections}\\[0.5ex]
\multicolumn{2}{l}{\null}\\[1.5ex] \multicolumn{2}{l}{\large Subsection 1 Faux Subsection}\\[0.5ex]
\hyperref[section-exercises-multiple-3-5]{Theorem 1}& Major Result\\
\end{longtable}
% end of appendix: List of Results
%
%
\typeout{************************************************}
\typeout{Appendix 3 Lists of Exercises}
\typeout{************************************************}
%
...
\endlastfoot
\multicolumn{2}{l}{\null}\\[1.5ex] \multicolumn{2}{l}{\large Section 4 An Interesting Corollary}\\[0.5ex]
\hyperlink{first-reading}{Reading Question 1}& \\
\hyperlink{section-interesting-corollary-5-5-3}{Reading Question 2}& \\
\hyperlink{subsection-intro-conclude-4-4-2}{Reading Question 1}& \\
\hyperlink{subsection-intro-conclude-4-4-3}{Reading Question 2}& \\
\multicolumn{2}{l}{\null}\\[1.5ex] \multicolumn{2}{l}{\large Section 16 Interactive Exercises}\\[0.5ex]
\hyperlink{short-answer-question}{Reading Question 1}& Short Answer\\
\end{longtable}
...
\multicolumn{2}{l}{\null}\\[1.5ex] \multicolumn{2}{l}{\large Section 4 An Interesting Corollary}\\[0.5ex]
\hyperref[exercise-essay]{Checkpoint 1}& Essay Question: Compare and Contrast\\
\hyperref[inline-exercise]{Checkpoint 1}& An Inline Exercise\\
\hyperref[exercise-structured]{Checkpoint 2}& A very structured exercise\\
\hyperref[subsection-intro-conclude-4-3]{Checkpoint 1}& \\
...
\hyperref[subsection-xml-escape-7]{Checkpoint 1}& \\
...
\hyperref[interactive-html5-canvas-5]{Checkpoint 1}& \\
\hyperref[section-interactive-authored-8-10]{Checkpoint 1}& Graph Planarity\\
\hyperref[svg-interactives-5]{Checkpoint 1}& Changing Secant Lines\\
...
\hyperref[atomic-image-25]{Checkpoint 1}& \\
\multicolumn{2}{l}{\null}\\[1.5ex] \multicolumn{2}{l}{\large Section 31 Advanced Numbering}\\[0.5ex]
\hyperref[exercise-difficult-title]{Checkpoint 1}& A Right Brace \textbraceright{} and a Right Bracket]\\
\hyperref[section-advanced-numbering-12-2]{Checkpoint 1}& An Extraneous Exercise\\
...
\hyperref[section-myopenmath-3]{Checkpoint 1}& Negative Numbers and Exponents\\
\hyperref[section-myopenmath-4]{Checkpoint 2}& A Statistical Test\\
\hyperref[section-myopenmath-5]{Checkpoint 3}& With an image\\
\multicolumn{2}{l}{\null}\\[1.5ex] \multicolumn{2}{l}{\large Section 34 Ancillaries}\\[0.5ex]
\multicolumn{2}{l}{\null}\\[1.5ex] \multicolumn{2}{l}{\large Section 35 Worksheets}\\[0.5ex]
\multicolumn{2}{l}{\null}\\[1.5ex] \multicolumn{2}{l}{\large Section 36 Exercises, One Subsection}\\[0.5ex]
\hyperref[section-exercises-single-5]{Checkpoint 1}& Inline One\\
\hyperref[duplicate-inline]{Checkpoint 2}& Inline Two\\
\hyperref[section-exercises-single-9]{Checkpoint 3}& Inline Three\\
\multicolumn{2}{l}{\null}\\[1.5ex] \multicolumn{2}{l}{\large Section 37 Exercises, Multiple Subsections}\\[0.5ex]
\hyperref[section-exercises-multiple-3-2]{Checkpoint 1}& Inline One\\
\hyperref[section-exercises-multiple-3-4]{Checkpoint 2}& Inline Two\\
\hyperref[exercise-duplicate-inline]{Checkpoint 3}& Inline Three\\
\end{longtable}
% end of appendix: Lists of Exercises
%
%
\typeout{************************************************}
\typeout{Appendix 4 A Structured Appendix}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 1 A Subsection in an Appendix}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsubsection 1 A Subsubsection in a Subsection in an Appendix}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Appendix 6 Multiple References}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{References 2 Specialized References}
\typeout{************************************************}
%
\bibliographystyle{amsplain}
\begin{thebibliography}{99}
