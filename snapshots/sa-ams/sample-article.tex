...
\par
Generated: August 3, 2025, 20:57:56 (-06:00)%
...
\end{alignat*}
Beautiful.%
\begin{aside}[Overlap Test.]\label{section-mathematics-4-8}%
%
...
\end{equation}
%
\begin{example}[Excessive Display Mathematics]\label{section-mathematics-4-10}%
%
...
\typeout{************************************************}
%
\section{Further Reading}\label{section-further-reading}%
%
%
\typeout{************************************************}
...
\typeout{************************************************}
%
\subsection{Specialized Subdivisions}\label{section-further-reading-2}%
...
% end of subsection: Specialized Subdivisions
% end of section: Further Reading
%
%
\typeout{************************************************}
...
\typeout{************************************************}
%
\section{List Calisthenics}\label{section-lists}%
%
%
\typeout{************************************************}
...
\typeout{************************************************}
%
\subsection{Lists, Generally}\label{section-lists-2}%
\index{ordered list}%
\index{list!ordered}%
...
\begin{definition}[Group]\label{section-lists-2-18}%
%
\index{Group}%
...
% end of subsection: Lists, Generally
%
%
\typeout{************************************************}
...
\typeout{************************************************}
%
\subsection{List Spacing, I}\label{section-lists-3}%
...
\end{multicols}
%
% end of subsection: List Spacing, I
%
%
\typeout{************************************************}
...
\typeout{************************************************}
%
\subsection{List Spacing, II}\label{section-lists-4}%
...
% end of subsection: List Spacing, II
%
%
\typeout{************************************************}
...
\typeout{************************************************}
%
\subsection{List items containing only inline math}\label{test-second}%
\begin{assemblage}[Testing list items containing only math.]\label{math-list-test}%
%
...
\end{itemize}
%
% end of subsection: List items containing only inline math
%
%
\typeout{************************************************}
...
\typeout{************************************************}
%
\subsection{Difficult List Items}\label{section-lists-6}%
...
\end{enumerate}
%
% end of subsection: Difficult List Items
%
%
\typeout{************************************************}
...
\typeout{************************************************}
%
\subsection{Description Lists}\label{section-lists-7}%
...
\end{descriptionlist}
%
% end of subsection: Description Lists
%
%
\typeout{************************************************}
...
\typeout{************************************************}
%
\subsection{Named Lists}\label{section-lists-8}%
\index{named list}%
\index{list!named}%
...
\typeout{************************************************}
%
\subsection{Testing List Decompositions}\label{section-lists-9}%
...
% end of subsection: Testing List Decompositions
%
%
\typeout{************************************************}
...
\typeout{************************************************}
%
\subsection{List Column Testing}\label{section-lists-10}%
...
\end{multicols}
%
% end of subsection: List Column Testing
% end of section: List Calisthenics
%
%
\typeout{************************************************}
...
\begin{proof}\label{section-programs-27}%
...
\par
Try to evaluate \(\displaystyle-{\left(-{25}\right)}^{{-{1}{/}{2}}}\) without using a calculator. Enter your answer as an integer or reduced fraction (no decimals). Enter DNE if the number is not real.%
\par
The value is   %
\par\smallskip%
...
This is an introduction, providing articulation between the MOM problem and the contents of the text.  For example, you might cross-reference a result or example given previously.%
\par
You wish to determine if there is a positive linear correlation between the two variables at a significance level of \(\displaystyle\alpha={0.02}\). You have the following bivariate data set.%
\begin{center}%
{\tabularfont%
\begin{tabular}{ll}
x&y\tabularnewline[0pt]
40&113.5\tabularnewline[0pt]
30.3&80\tabularnewline[0pt]
15.4&60.7\tabularnewline[0pt]
19.2&51.2\tabularnewline[0pt]
16.4&100.4\tabularnewline[0pt]
42.7&116.3\tabularnewline[0pt]
24.1&83.8\tabularnewline[0pt]
24.7&71.9\tabularnewline[0pt]
21.9&65.2\tabularnewline[0pt]
25.2&99.2\tabularnewline[0pt]
33.4&124.9\tabularnewline[0pt]
33.7&114\tabularnewline[0pt]
29.4&90.2\tabularnewline[0pt]
25.9&82.7\tabularnewline[0pt]
20&47.9\tabularnewline[0pt]
13.7&48.9\tabularnewline[0pt]
18.9&46.9\tabularnewline[0pt]
20&51.8\tabularnewline[0pt]
30.9&100.9\tabularnewline[0pt]
15.6&56.4\tabularnewline[0pt]
26&89.1\tabularnewline[0pt]
21.1&59.9\tabularnewline[0pt]
31.5&71\tabularnewline[0pt]
33.2&101.9\tabularnewline[0pt]
21.3&76.2\tabularnewline[0pt]
18.8&72.1\tabularnewline[0pt]
34.4&86\tabularnewline[0pt]
23.3&59.4\tabularnewline[0pt]
15.5&72.7\tabularnewline[0pt]
13.8&39.6\tabularnewline[0pt]
25.6&76.4\tabularnewline[0pt]
4&28.3\tabularnewline[0pt]
28.7&81\tabularnewline[0pt]
3.8&27.2\tabularnewline[0pt]
1.1&21.9
\end{tabular}
}%
\end{center}%
download link provided here:  \href{denied:data:text/csv;charset=UTF-8,\%22x\%22\%2C\%22y\%22\%0A40\%2C113.5\%0A30.3\%2C80\%0A15.4\%2C60.7\%0A19.2\%2C51.2\%0A16.4\%2C100.4\%0A42.7\%2C116.3\%0A24.1\%2C83.8\%0A24.7\%2C71.9\%0A21.9\%2C65.2\%0A25.2\%2C99.2\%0A33.4\%2C124.9\%0A33.7\%2C114\%0A29.4\%2C90.2\%0A25.9\%2C82.7\%0A20\%2C47.9\%0A13.7\%2C48.9\%0A18.9\%2C46.9\%0A20\%2C51.8\%0A30.9\%2C100.9\%0A15.6\%2C56.4\%0A26\%2C89.1\%0A21.1\%2C59.9\%0A31.5\%2C71\%0A33.2\%2C101.9\%0A21.3\%2C76.2\%0A18.8\%2C72.1\%0A34.4\%2C86\%0A23.3\%2C59.4\%0A15.5\%2C72.7\%0A13.8\%2C39.6\%0A25.6\%2C76.4\%0A4\%2C28.3\%0A28.7\%2C81\%0A3.8\%2C27.2\%0A1.1\%2C21.9}{Download CSV}\footnotemark{}%
\par
...
%
\begin{enumerate}
\item{}There is insufficient sample evidence to support the claim the there is a positive correlation between the two variables.%
\item{}There is sufficient sample evidence to support the claim that there is a statistically significant positive correlation between the two variables.%
\end{enumerate}
%
\par\smallskip%
...
\item{}0.856%
\item{}0%
\item{}B: There is sufficient sample evidence to support the claim that there is a statistically significant positive correlation between the two variables.%
\end{itemize}
%
\end{inlineexercise}%
\footnotetext[1]{\nolinkurl{denied:data:text/csv;charset=UTF-8,\%22x\%22\%2C\%22y\%22\%0A40\%2C113.5\%0A30.3\%2C80\%0A15.4\%2C60.7\%0A19.2\%2C51.2\%0A16.4\%2C100.4\%0A42.7\%2C116.3\%0A24.1\%2C83.8\%0A24.7\%2C71.9\%0A21.9\%2C65.2\%0A25.2\%2C99.2\%0A33.4\%2C124.9\%0A33.7\%2C114\%0A29.4\%2C90.2\%0A25.9\%2C82.7\%0A20\%2C47.9\%0A13.7\%2C48.9\%0A18.9\%2C46.9\%0A20\%2C51.8\%0A30.9\%2C100.9\%0A15.6\%2C56.4\%0A26\%2C89.1\%0A21.1\%2C59.9\%0A31.5\%2C71\%0A33.2\%2C101.9\%0A21.3\%2C76.2\%0A18.8\%2C72.1\%0A34.4\%2C86\%0A23.3\%2C59.4\%0A15.5\%2C72.7\%0A13.8\%2C39.6\%0A25.6\%2C76.4\%0A4\%2C28.3\%0A28.7\%2C81\%0A3.8\%2C27.2\%0A1.1\%2C21.9}\label{section-myopenmath-4-2-4-2}}%
...
\begin{itemize}[label=\textbullet]
\item{}\(\displaystyle \displaystyle{y}=-{2}{x}+{2}\)%
\end{itemize}
%
\end{inlineexercise}%
\begin{inlineexercise}[Geometry of a Cone]\label{section-myopenmath-6}%
%
...
\par
The right circular conical tank shown has height 4.00 m and top radius \(\displaystyle{1.30}\) m. It is filled with water to a height of \(\displaystyle{3.40}\) m. The cross section is a right triangle with height 4.00 m and top side \(\displaystyle{1.30}\) m. Inside is another right triangle with height \(\displaystyle{3.40}\) m.%
\begin{image}{0.3}{0.4}{0.3}{}%
...
\typeout{************************************************}
%
\section{Exercises, One Subsection}\label{section-exercises-single}%
...
\begin{inlineexercise}[Inline One]\label{section-exercises-single-5}%
%
...
\begin{inlineexercise}[Inline Two]\label{duplicate-inline}%
%
...
\end{inlineexercise}%
\begin{theorem}[Major Result]\label{section-exercises-single-8}%
%
...
\end{theorem}
\begin{inlineexercise}[Inline Three]\label{section-exercises-single-9}%
%
...
\end{inlineexercise}%
% end of section: Exercises, One Subsection
%
%
\typeout{************************************************}
...
\typeout{************************************************}
%
\section{Exercises, Multiple Subsections}\label{section-exercises-multiple}%
% Introduction
...
\typeout{************************************************}
%
\subsection{Faux Subsection}\label{section-exercises-multiple-3}%
\begin{inlineexercise}[Inline One]\label{section-exercises-multiple-3-2}%
%
Aliquam vitae risus placerat, pellentesque leo vitae, iaculis ante. Praesent ac odio eget mi bibendum eleifend ac eget metus. Morbi in dolor et diam accumsan mattis. Aenean elementum pulvinar efficitur. Etiam viverra ut tellus quis consequat. Phasellus sit amet nisl a ligula pharetra tempus id in elit. Maecenas congue quam eu purus fermentum pretium. Fusce pellentesque ultricies arcu, egestas sollicitudin erat condimentum non. Integer non velit at dolor dictum aliquam et rhoncus mauris. Sed nec nibh id nunc convallis tincidunt ut at ligula. Etiam elementum nisl eu erat dapibus rhoncus.%
\end{inlineexercise}%
Pellentesque nec condimentum ligula, quis interdum mauris. Ut sed urna lacinia, aliquam arcu id, faucibus nisi. Suspendisse potenti. Curabitur in erat ultricies, condimentum mi nec, vehicula mauris. Duis faucibus risus fermentum velit hendrerit, non laoreet massa maximus. Donec bibendum elit ac lectus lobortis luctus. Ut finibus, dolor ut euismod tristique, ligula tortor tempus arcu, finibus semper purus erat ut ligula. Aenean accumsan ut ante vel euismod.%
\begin{inlineexercise}[Inline Two]\label{section-exercises-multiple-3-4}%
%
Ut porttitor neque a pharetra euismod. Vivamus ut metus pretium, placerat massa tempor, condimentum metus. Phasellus vestibulum iaculis turpis non posuere. Vestibulum quis aliquet neque. Donec nec metus iaculis, laoreet massa vitae, suscipit tellus. Etiam et ultrices quam, quis pretium ligula. In ut cursus metus. Aenean volutpat quam odio, quis tempus dolor egestas eget. Nunc fringilla lobortis nunc, ut interdum lorem posuere sed. Sed sodales risus a laoreet venenatis. Nunc sodales tempor mollis. Nam sollicitudin velit sed ex viverra feugiat. Nunc consectetur mi vitae urna sollicitudin malesuada. Fusce eget risus lectus. Mauris augue velit, vestibulum vitae tempus sit amet, porttitor eget turpis.%
\end{inlineexercise}%
\begin{theorem}[Major Result]\label{section-exercises-multiple-3-5}%
%
Vivamus tortor tortor, lobortis et sem vel, accumsan placerat libero. Sed eget metus non magna accumsan efficitur a non turpis. Curabitur maximus arcu ipsum, eget vestibulum nulla mollis ac. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Duis vel eleifend risus. Morbi hendrerit tellus eget nibh imperdiet, ac mollis nisl sagittis. Ut commodo pharetra leo. Suspendisse consequat velit eget velit condimentum feugiat.%
\end{theorem}
\begin{inlineexercise}[Inline Three]\label{exercise-duplicate-inline}%
%
Suspendisse lacinia mattis risus, eget viverra urna dictum eu. Maecenas ut sem in turpis egestas varius nec at ipsum. Praesent bibendum nisi et turpis congue, a pellentesque felis tempor. Vivamus non dolor in risus interdum mattis. In tempus iaculis velit, sit amet rhoncus tellus aliquam convallis. Sed ut tellus id ipsum blandit convallis sed eget tortor. Nunc leo felis, scelerisque vel ante porta, volutpat rhoncus neque. Mauris convallis, felis at aliquam aliquet, felis ipsum semper mi, vitae auctor purus ante non erat. Ut nec felis mi.%
\end{inlineexercise}%
% end of subsection: Faux Subsection
% end of section: Exercises, Multiple Subsections
%
% Appendices
%
%
