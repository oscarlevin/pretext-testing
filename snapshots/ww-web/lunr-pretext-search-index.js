...
},
{
  "id": "local-pg",
  "level": "2",
  "url": "sample-ww-chapter-4-2.html#local-pg",
  "type": "Checkpoint",
  "number": "1.1.7",
  "title": "Local PG.",
  "body": " Local PG   The complete text of a .pg file can be used as the content of a <webwork> . Attention should be given to newlines and white space within the <webwork> , as they will be included in the PG problem that is rendered.     Compute the sum of and              "
},
{
  "id": "local-pg-file",
  "level": "2",
  "url": "sample-ww-chapter-4-2.html#local-pg-file",
  "type": "Checkpoint",
  "number": "1.1.8",
  "title": "Local PG File.",
  "body": " Local PG File   It is convenient to get the text of a .pg file using xi:include . This may help with file management and management of to not have to manage whitespace.     Compute the sum of and              "
},
{
  ...
  "body": " Inside a <project>   If you like, you can have a WeBWorK inside a <project> . Just like with an <exercise> , it can be preceded with an optional <introduction> and followed by an optional <conclusion> .     Compute the sum of and                "
},
{
  "id": "copy-webwork-add-numbers-exploration",
  "level": "2",
  "url": "sample-ww-chapter-4-2.html#copy-webwork-add-numbers-exploration",
  "type": "Exploration",
  "number": "1.1.2",
  "title": "Inside an <code class=\"code-inline tex2jax_ignore\">&lt;exploration&gt;<\/code>.",
  "body": " Inside an <exploration>   There are other project-like tags besides <project> . Here, we use an <exploration> .     Compute the sum of and                "
},
{
...
{
  "id": "antiderivative-sin",
  "level": "2",
  "url": "sample-ww-chapter-4-5.html#antiderivative-sin",
  "type": "Exercise",
  "number": "1.4.2.4",
  "title": "",
  "body": "              "
...
{
  "id": "antiderivative-exp",
  "level": "2",
  "url": "sample-ww-chapter-4-5.html#antiderivative-exp",
  "type": "Exercise",
  "number": "1.4.2.5",
  "title": "",
  "body": "              "
...
},
{
  ...
  "body": " Math Elements and Alignment   In this exercise we demonstrate the allowed math elements: <m> and <md> . The latter may have attribute alignment with options gather , align , or alignat .     If and then   Here, we solve an equation.   Here we have a three-way inequality to solve.   And here, we see a system of equations.        "
},
{
  "id": "intertext",
  "level": "2",
...
},
{
  ...
  "body": " Multiple Choice  While free-response questions are generally preferred, sometimes the nature of a question lends itself to multiple choice.   Drop-down\/Popup   Note also that the solution to this problem uses an external link.     The number   is   is not  rational.        If were rational, then with and coprime. But then By the Fundamental Theorem of Arithmetic , the power of dividing the left side is odd, while the power of dividing the right side is even. This is a contradiction, so is not rational.         Choose one    Which of the following suggest that differentiation and integration are inverse processes?    The Quadratic Formula    The Fundamental Theorem of Calculus    The Fundamental Theorem of Arithmetic    None of these          The correct answer is The Fundamental ... of Calculus.         Choose a Subset of Options    Select all expressions that are equivalent to There may be more than one correct answer.                   None of the above          The correct answer is Choice 1, Choice 3, Choice 5.         Choose a Subset of Options with Automated Labeling    Select all expressions that are equivalent to There may be more than one correct answer.                   None of the above          The correct answer is A, B, D.         Choose a Subset of Options with Explicit Labeling    Select all expressions that are equivalent to There may be more than one correct answer.    SUSHI     BURRITO     BURGER     TACO     PIZZA     HUNGRY  None of the above          The correct answer is SUSHI, TACO, PIZZA.        "
},
{
  "id": "multiple-choice",
  "level": "2",
...
},
{
  ...
  "body": " Choose a Subset of Options    Select all expressions that are equivalent to There may be more than one correct answer.                   None of the above          The correct answer is Choice 1, Choice 3, Choice 5.       "
},
{
  ...
  "body": " Choose a Subset of Options with Automated Labeling    Select all expressions that are equivalent to There may be more than one correct answer.                   None of the above          The correct answer is A, B, D.       "
},
{
  ...
  "body": " Choose a Subset of Options with Explicit Labeling    Select all expressions that are equivalent to There may be more than one correct answer.    SUSHI     BURRITO     BURGER     TACO     PIZZA     HUNGRY  None of the above          The correct answer is SUSHI, TACO, PIZZA.       "
},
{
...
},
{
  ...
  "body": " A randomized <latex-image> graph   These images may depend on the random seed. In this problem, the height and width of the rectangle are randomized.     Find the area of the rectangle.    a rectangle whose width is labeled 6 cm and height is labeled 4 cm             "
},
{
  ...
  "body": " A <latex-image> graph affected by <latex-image-preamble>   This sample chapter's <docinfo> has a <latex-image-preamble> . This exercise has graph styling that is affected by that.     What are the roots of this polynomial?    the graph of a polynomial that crosses the x-axis at -1, 1, and 2.             "
},
{
...
{
  "id": "box-diagonal-five",
  "level": "2",
  "url": "sample-ww-chapter-4-9.html#box-diagonal-five",
  "type": "Exercise",
  "number": "1.8.1",
  "title": "",
  "body": "   Find when and               "
...
{
  "id": "box-diagonal-thirteen",
  "level": "2",
  "url": "sample-ww-chapter-4-9.html#box-diagonal-thirteen",
  "type": "Exercise",
  "number": "1.8.2",
  "title": "",
  "body": "   Find when and               "
...
{
  "id": "mathobject-string-answers",
  "level": "2",
  "url": "sample-ww-chapter-5-2.html#mathobject-string-answers",
  "type": "Checkpoint",
  "number": "2.1.2",
  "title": "",
...
{
  "id": "pgml-data-attribute",
  "level": "2",
  "url": "sample-ww-chapter-5-2.html#pgml-data-attribute",
  "type": "Checkpoint",
  "number": "2.1.3",
  "title": "",
...
{
  "id": "radio-buttons-with-math",
  "level": "2",
  "url": "sample-ww-chapter-5-3.html#radio-buttons-with-math",
  "type": "Checkpoint",
  "number": "2.2.4",
  "title": "",
...
},
{
  "id": "answer-arrays",
  "level": "2",
  "url": "sample-ww-chapter-5-3.html#answer-arrays",
  "type": "Checkpoint",
  "number": "2.2.6",
  "title": "Answer Arrays.",
...
{
  "id": "ptx-source-with-server-images",
  "level": "2",
  "url": "sample-ww-chapter-5-4.html#ptx-source-with-server-images",
  "type": "Checkpoint",
  "number": "2.3.1",
...
},
{
  "id": "list-indentation",
  "level": "2",
  "url": "sample-ww-chapter-5-4.html#list-indentation",
  "type": "Checkpoint",
  "number": "2.3.2",
...
{
  "id": "list-indentation-with-images-and-tables",
  "level": "2",
  "url": "sample-ww-chapter-5-4.html#list-indentation-with-images-and-tables",
  "type": "Checkpoint",
  "number": "2.3.3",
...
{
  "id": "deep-nested-lists",
  "level": "2",
  "url": "sample-ww-chapter-5-4.html#deep-nested-lists",
  "type": "Checkpoint",
  "number": "2.3.4",
...
},
{
  "id": "empty-statement",
  "level": "2",
  "url": "sample-ww-chapter-5-4.html#empty-statement",
  "type": "Checkpoint",
  "number": "2.3.5",
  "title": "",
...
{
  "id": "single-quote-in-table-cell",
  "level": "2",
  "url": "sample-ww-chapter-5-4.html#single-quote-in-table-cell",
  "type": "Checkpoint",
  "number": "2.3.6",
  "title": "",
...
},
{
  "id": "inline-bare",
  "level": "2",
  "url": "sample-ww-chapter-5-5.html#inline-bare",
  "type": "Checkpoint",
  "number": "2.4.1",
  "title": "",
  "body": "         "
},
{
  "id": "inline-title",
  "level": "2",
  "url": "sample-ww-chapter-5-5.html#inline-title",
  "type": "Checkpoint",
  "number": "2.4.2",
  "title": "Has a Title.",
  "body": " Has a Title          "
...
{
  "id": "inline-introduction",
  "level": "2",
  "url": "sample-ww-chapter-5-5.html#inline-introduction",
  "type": "Checkpoint",
  "number": "2.4.3",
  "title": "",
...
{
  "id": "inline-title-introduction",
  "level": "2",
  "url": "sample-ww-chapter-5-5.html#inline-title-introduction",
  "type": "Checkpoint",
  "number": "2.4.4",
  "title": "Has a Title.",
...
{
  "id": "inline-conclusion",
  "level": "2",
  "url": "sample-ww-chapter-5-5.html#inline-conclusion",
  "type": "Checkpoint",
  "number": "2.4.5",
  "title": "",
...
{
  "id": "inline-title-conclusion",
  "level": "2",
  "url": "sample-ww-chapter-5-5.html#inline-title-conclusion",
  "type": "Checkpoint",
  "number": "2.4.6",
  "title": "Has a Title.",
...
{
  "id": "inline-introduction-conclusion",
  "level": "2",
  "url": "sample-ww-chapter-5-5.html#inline-introduction-conclusion",
  "type": "Checkpoint",
  "number": "2.4.7",
  "title": "",
...
{
  "id": "inline-title-introduction-conclusion",
  "level": "2",
  "url": "sample-ww-chapter-5-5.html#inline-title-introduction-conclusion",
  "type": "Checkpoint",
  "number": "2.4.8",
  "title": "Has a Title.",
...
},
{
  "id": "divisional-bare",
  "level": "2",
  "url": "sample-ww-chapter-5-5.html#divisional-bare",
  "type": "Exercise",
  "number": "2.4.2.1",
  "title": "",
  "body": "         "
},
{
  "id": "divisional-title",
  "level": "2",
  "url": "sample-ww-chapter-5-5.html#divisional-title",
  "type": "Exercise",
  "number": "2.4.2.2",
  "title": "Has a Title.",
  "body": " Has a Title          "
...
{
  "id": "divisional-introduction",
  "level": "2",
  "url": "sample-ww-chapter-5-5.html#divisional-introduction",
  "type": "Exercise",
  "number": "2.4.2.3",
  "title": "",
  "body": "  Has an introduction.           "
...
{
  "id": "divisional-title-introduction",
  "level": "2",
  "url": "sample-ww-chapter-5-5.html#divisional-title-introduction",
  "type": "Exercise",
  "number": "2.4.2.4",
  "title": "Has a Title.",
  "body": " Has a Title   Has an introduction.           "
...
{
  "id": "divisional-conclusion",
  "level": "2",
  "url": "sample-ww-chapter-5-5.html#divisional-conclusion",
  "type": "Exercise",
  "number": "2.4.2.5",
  "title": "",
  "body": "          Has a conclusion.   "
...
{
  "id": "divisional-title-conclusion",
  "level": "2",
  "url": "sample-ww-chapter-5-5.html#divisional-title-conclusion",
  "type": "Exercise",
  "number": "2.4.2.6",
  "title": "Has a Title.",
  "body": " Has a Title           Has a conclusion.   "
...
{
  "id": "divisional-introduction-conclusion",
  "level": "2",
  "url": "sample-ww-chapter-5-5.html#divisional-introduction-conclusion",
  "type": "Exercise",
  "number": "2.4.2.7",
  "title": "",
  "body": "  Has an introduction.            Has a conclusion.   "
...
{
  "id": "divisional-title-introduction-conclusion",
  "level": "2",
  "url": "sample-ww-chapter-5-5.html#divisional-title-introduction-conclusion",
  "type": "Exercise",
  "number": "2.4.2.8",
  "title": "Has a Title.",
  "body": " Has a Title   Has an introduction.            Has a conclusion.   "
...
{
  "id": "exercisegroup-bare",
  "level": "2",
  "url": "sample-ww-chapter-5-5.html#exercisegroup-bare",
  "type": "Exercise",
  "number": "2.4.2.9",
  "title": "",
  "body": "         "
...
{
  "id": "exercisegroup-title",
  "level": "2",
  "url": "sample-ww-chapter-5-5.html#exercisegroup-title",
  "type": "Exercise",
  "number": "2.4.2.10",
  "title": "Has a Title.",
  "body": " Has a Title          "
...
{
  "id": "exercisegroup-introduction",
  "level": "2",
  "url": "sample-ww-chapter-5-5.html#exercisegroup-introduction",
  "type": "Exercise",
  "number": "2.4.2.11",
  "title": "",
  "body": "  Has an introduction.           "
...
{
  "id": "exercisegroup-title-introduction",
  "level": "2",
  "url": "sample-ww-chapter-5-5.html#exercisegroup-title-introduction",
  "type": "Exercise",
  "number": "2.4.2.12",
  "title": "Has a Title.",
  "body": " Has a Title   Has an introduction.           "
...
{
  "id": "exercisegroup-conclusion",
  "level": "2",
  "url": "sample-ww-chapter-5-5.html#exercisegroup-conclusion",
  "type": "Exercise",
  "number": "2.4.2.13",
  "title": "",
  "body": "          Has a conclusion.   "
...
{
  "id": "exercisegroup-title-conclusion",
  "level": "2",
  "url": "sample-ww-chapter-5-5.html#exercisegroup-title-conclusion",
  "type": "Exercise",
  "number": "2.4.2.14",
  "title": "Has a Title.",
  "body": " Has a Title           Has a conclusion.   "
...
{
  "id": "exercisegroup-introduction-conclusion",
  "level": "2",
  "url": "sample-ww-chapter-5-5.html#exercisegroup-introduction-conclusion",
  "type": "Exercise",
  "number": "2.4.2.15",
  "title": "",
  "body": "  Has an introduction.            Has a conclusion.   "
...
{
  "id": "exercisegroup-title-introduction-conclusion",
  "level": "2",
  "url": "sample-ww-chapter-5-5.html#exercisegroup-title-introduction-conclusion",
  "type": "Exercise",
  "number": "2.4.2.16",
  "title": "Has a Title.",
  "body": " Has a Title   Has an introduction.            Has a conclusion.   "
