...
%*                                          *%
%********************************************%
% This document was created with the texstyle file "springer-nature.xml" to satisfy the requirements of the journal "Springer Nature journals."
%
%
...
% End TexStyle preamble addioions.%
%
%*********************************%
%*      Begin Main Document      *%
%*********************************%
...
\abstract{This is a sample of many of the things you can do with PreTeXt.  Sometimes the math makes sense, sometimes it seems to be written in the first person, sort of like this Abstract.%
}
\keywords{samples, PreTeXt, testing document}
\pacs[2010]{Primary 00-01, 00-02; Secondary 00A99}
\maketitle
%
%
\typeout{************************************************}
...
\par
Generated: August 3, 2025, 21:10:55 (-06:00)%
...
\par
Try to evaluate \(\displaystyle-{\left(-{25}\right)}^{{-{3}{/}{2}}}\) without using a calculator. Enter your answer as an integer or reduced fraction (no decimals). Enter DNE if the number is not real.%
\par
The value is   %
\par\smallskip%
...
This is an introduction, providing articulation between the MOM problem and the contents of the text.  For example, you might cross-reference a result or example given previously.%
\par
You wish to determine if there is a  linear correlation between the two variables at a significance level of \(\displaystyle\alpha={0.005}\). You have the following bivariate data set.%
\begin{center}%
{\tabularfont%
\begin{tabular}{ll}
x&y\tabularnewline[0pt]
72.4&59.7\tabularnewline[0pt]
73.8&71.2\tabularnewline[0pt]
73.9&75.4\tabularnewline[0pt]
78.1&61.5\tabularnewline[0pt]
80.2&75.5\tabularnewline[0pt]
74.9&66.9\tabularnewline[0pt]
77.1&75.3\tabularnewline[0pt]
77.7&84.5\tabularnewline[0pt]
73.5&73.3\tabularnewline[0pt]
80&77.4\tabularnewline[0pt]
76.2&73.1\tabularnewline[0pt]
71.3&78.1\tabularnewline[0pt]
73.5&67.8\tabularnewline[0pt]
75.4&66.6
\end{tabular}
}%
\end{center}%
download link provided here:  \href{denied:data:text/csv;charset=UTF-8,\%22x\%22\%2C\%22y\%22\%0A72.4\%2C59.7\%0A73.8\%2C71.2\%0A73.9\%2C75.4\%0A78.1\%2C61.5\%0A80.2\%2C75.5\%0A74.9\%2C66.9\%0A77.1\%2C75.3\%0A77.7\%2C84.5\%0A73.5\%2C73.3\%0A80\%2C77.4\%0A76.2\%2C73.1\%0A71.3\%2C78.1\%0A73.5\%2C67.8\%0A75.4\%2C66.6}{Download CSV}\footnotemark{}%
\par
...
\item{}0.269%
\item{}0.3524%
\item{}B: There is insufficient sample evidence to support the claim the there is a  correlation between the two variables.%
\end{itemize}
%
\end{inlineexercise}%
\footnotetext[1]{\nolinkurl{denied:data:text/csv;charset=UTF-8,\%22x\%22\%2C\%22y\%22\%0A72.4\%2C59.7\%0A73.8\%2C71.2\%0A73.9\%2C75.4\%0A78.1\%2C61.5\%0A80.2\%2C75.5\%0A74.9\%2C66.9\%0A77.1\%2C75.3\%0A77.7\%2C84.5\%0A73.5\%2C73.3\%0A80\%2C77.4\%0A76.2\%2C73.1\%0A71.3\%2C78.1\%0A73.5\%2C67.8\%0A75.4\%2C66.6}\label{section-myopenmath-4-2-4-2}}%
...
\par
The right circular conical tank shown has height 4.00 m and top radius \(\displaystyle{1.50}\) m. It is filled with water to a height of \(\displaystyle{3.70}\) m. The cross section is a right triangle with height 4.00 m and top side \(\displaystyle{1.50}\) m. Inside is another right triangle with height \(\displaystyle{3.70}\) m.%
\begin{image}{0.3}{0.4}{0.3}{}%
